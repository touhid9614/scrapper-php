...
header("Content-Disposition: attachment; filename=\"Dealerships with Chevrolet or GMC.csv\"");
...
$query = "SELECT distinct `host` FROM all_imported_scrapped_data WHERE stock_type = 'new' AND (make = 'Chevrolet' OR make = 'GMC')";
