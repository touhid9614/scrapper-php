...
$dealerGroup = array(
	"adventurervctrcom" => array(
		"group_name" => "Adventure RV Centre",
		"dealership" => array(
			"adventurervctrcom"
		),
	),
	"evomotorsusacom" => array(
		"group_name" => "evomotorsusacom",
		"dealership" => array(
			"evomotorsusacom"
		),
	),
	"niagaramotorscom" => array(
		"group_name" => "Niagara Motors",
		"dealership" => array(
			"niagaramotorscom"
		),
	),
	"tetonhondacom" => array(
		"group_name" => "Teton Honda of Pocatello",
		"dealership" => array(
			"tetonhondacom"
		),
	),
...
$post_url = (isset($_GET['api']) && $_GET['api'] == 'api') ? 'https://api.smedia.ca/v1' : 'https://api-qa.smedia.ca/v1';
...
foreach ($dealerGroup as $dealers) {
    $dealer_group_name       = $dealers['group_name'];
