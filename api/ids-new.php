...
<div class="card" style="margin: 10px 20px;">
	...
	<div class="card-body">
		<table id="myTable" class="table table-striped table-bordered cell-border display nowrap" style="width:100%">
			...
			?>
					<tr scope="row">
						<td rowspan="<?= $rowspan ?>"><?= $co++ ?></td>

						<td rowspan="<?= $rowspan ?>"><?= $dealer->dealershipId ?></td>
						<td rowspan="<?= $rowspan ?>"><?= isset($dealer->guid) ? $dealer->guid : "" ?></td>
						<td rowspan="<?= $rowspan ?>"><?= $dealer->dealerName ?></td>
						<td rowspan="<?= $rowspan ?>"><?= $dealer->cron ?></td>
						<td rowspan="<?= $rowspan ?>"><?= $dealer->domain ?></td>
						<td rowspan="<?= $rowspan ?>"><?= $dealer->status ? $active : $deactive ?></td>

						<td rowspan="<?= $rowspan ?>"><?= isset($dealer->groupId) ?></td>
						<td rowspan="<?= $rowspan ?>"><?= isset($dealer->group) ?></td>
						<td rowspan="<?= $rowspan ?>"><?= isset($dealer->groupStatus) ? $active : $deactive ?></td>
