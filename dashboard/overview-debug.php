...
$start_time_total = microtime(true);
    ...
    echo " Execution time of config.php script = ".$execution_time." sec<br>";

$start_time = microtime(true);
require_once 'includes/loader.php';
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of includes/loader.php script = ".$execution_time." sec<br>";
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of includes/crm-defaults.php script = ".$execution_time." sec<br>";
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of ADSYNCPATH config.php script = ".$execution_time." sec<br>";
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of ADSYNCPATH Google/Util.php script = ".$execution_time." sec<br>";

$start_time = microtime(true);
require_once ADSYNCPATH . 'utils.php';
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of ADSYNCPATH utils.php script = ".$execution_time." sec<br>";
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of ADSYNCPATH db_connect.php script = ".$execution_time." sec<br>";
    ...
    $cron_name = filter_input(INPUT_GET, 'dealership') ? filter_input(INPUT_GET, 'dealership', FILTER_SANITIZE_STRING) : $cron_names[0];
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of SELECT DISTINCT(state) AS state FROM dealerships script = ".$execution_time." sec<br>";
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of get_all_dealers script = ".$execution_time." sec<br>";
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of Select From users script = ".$execution_time." sec<br>";
$start_time = microtime(true);
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of Process users script = ".$execution_time." sec<br>";
$start_time = microtime(true);
    #Manual Filters
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of Manual Filters script = ".$execution_time." sec<br>";
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of get_meta script = ".$execution_time." sec<br>";
$start_time = microtime(true);
    ...
    if ($export) 
    {
        ...
        foreach ($cron_names as $cron_name)
        {
            ...
            $vc_state_file = $tag_state_dir . $cron_name . '.vc';
...
$end_time = microtime(true);
$execution_time = ($end_time - $start_time);
echo " Execution time of export script = ".$execution_time." sec<br>";

$start_time_header = microtime(true);
include 'bolts/header-debug.php';
$end_time_header = microtime(true);
$execution_time_header = ($end_time_header - $start_time_header);
echo " Execution time of bolts/header.php script = ".$execution_time_header." sec<br>";

$end_time_total = microtime(true);
$execution_time_total = ($end_time_total  - $start_time_total);
echo "<b>Execution time of Total script = ".$execution_time_total." sec<br></b>";
exit();
?>
                                ...
                                <div class="row mb-md">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea id="brands" name="brands" style="" rows="1"></textarea>
                                        ...
                                        <table class="table table-bordered table-striped mb-none" id="datatable-default">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="export">Dealership Name</th>
                                                    <th class="export">Group</th>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><a href="details.php?dealership=<?= $cron_name ?>"><?= $dealership['company_name'] ?></a></td>
                                                        <td><?= $dealership['dealership'] ?></td>
                                                        <td><?= $dealership['group_name'] ?></td>
                                            <?php
