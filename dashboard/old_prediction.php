...
while($row_data = mysqli_fetch_assoc($vehicle_features_result)) {
    ...
    $prediction[$url] = [
        ...
        'is_sold'           => $row_data['deleted'] ? '<span class="label label-danger">Sold Out</span>' : '<span class="label label-success">Available</span>',
        'chance'            => $chance,
        'days'              => $required_days
    ];
}
            ...
            <div class="col-lg-12">
               <section class="panel panel-info">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Old Sales Prediction for :: <?= $cron_name ?></h2>
                    </header>
