...
add_script('closer', 'app/js/closer.js');
        ...
        <div class="panel-body">
            <table class="dealerships-container todo-container">
                ...
                <tr id="dealer-<?= $dealer['id'] ?>">
                    ...
                    <td><?= $dealer['status'] ?></td>
                    <td>
                        <a id="edit-<?= $dealer['id'] ?>" class="button edit-lead-button" href="#" lead-id="<?= $dealer['id'] ?>">Edit</a>
                        <a id="push-<?= $dealer['id'] ?>" class="button push-lead-button" href="#" lead-id="<?= $dealer['id'] ?>">Push</a>
                        <a id="notes-<?= $dealer['id'] ?>" class="button notes-lead-button" href="#" lead-id="<?= $dealer['id'] ?>">Notes</a>
                    </td>
                </tr>
                <?php
                }
