...
// collapsed ranges (see markText) that might hide parts-new, and join
// other lines onto it.
...
function endOfLine(visually, cm, lineObj, lineNo, dir) {
  if (visually) {
    ...
    if (order) {
      ...
      var ch
      // With a wrapped rtl chunk (possibly spanning multiple bidi parts-new),
...
function moveVisually(cm, line, start, dir) {
  ...
  // Case 3a: Look for other bidi parts-new on the same visual line
  var res = searchInVisualLine(partPos + dir, dir, wrappedLineExtent)
  if (res) { return res }

  // Case 3b: Look for other bidi parts-new on the next visual line
