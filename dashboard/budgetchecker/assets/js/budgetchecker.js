...
(function ($) {
    ...
    function eval_dealer()
    {
        ...
        var request = $.ajax({
            cache: false,
            url: 'budgetchecker/get_file_data.php'
        });
    ...
    function update_budget(sender)
    {
        ...
        url = 'budgetchecker/ajax.php?act=update-budget';
    ...
    function eval2html(data, iseven)
    {
        ...
        html += '<td>\n';
        if (typeof data.yesterday_spent !== 'undefined')
            html += round(data.yesterday_spent);
        html += '</td>\n';
        html += '<td>\n';
        if (typeof data.today_spent !== 'undefined')
            html += round(data.today_spent);
        html += '</td>\n';
        
        if (data.advert_type === 'regular')
        {
            html += '<td>' + data.fb_budget + '</td>\n';
            html += '<td>' + data.fb_projected + '</td>\n';
            html += '<td>' + data.fb_spent + '</td>\n';
        }
