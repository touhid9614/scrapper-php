...
$default = array(
    'bg_color'              => "#162433",
    'text_color'            => "#ffffff",
    'button_color'          => array("#AE2419", "#AE2419"),
    'button_color_hover'    => array("#950B00", "#950B00"),
    'button_color_active'   => array("#950B00", "#950B00"),
...
if(
    !isset($lead_config['border_color']) ||
    (isset($lead_config['border_color']) && empty($lead_config['border_color']))
) {
    $lead_config['border_color'] = $lead_config['button_color'][0];
}
...
.sm-lead-collect-form-body form input::placeholder {
  color: #9DA0AC;
}
.sm-lead-collect-form-body form button{
...
.sm-lead-collect-form-body form button:hover{
...
.sm-lead-collect-form-body form button:active{
...
.sm-lead-collect-form-body form button:disabled{
    background: <?php echo $lead_config['button_color_hover'][0] ?>;
<?php if(count($lead_config['button_color_hover']) > 1): ?>
    background-image: -webkit-linear-gradient(top, <?php echo $lead_config['button_color_hover'][0] ?>, <?php echo $lead_config['button_color_hover'][1] ?>);
    background-image: -moz-linear-gradient(top, <?php echo $lead_config['button_color_hover'][0] ?>, <?php echo $lead_config['button_color_hover'][1] ?>);
...
@media (orientation: portrait) and (max-width: 400px) {
    .sm-lead-collect-form-body form input, .sm-lead-collect-form-body form button, .sm-lead-collect-form-body form select {
        line-height: 30px;
    }
    .sm-row .sm-col {
        margin: 10px 0;
