...
try
{
    ...
    $pageVisitorsRuleItemGroups      = [];
    $pageVisitorsRuleItemGroupA      = new RuleItemGroup();
    $pageVisitorsRuleItemsA          = [];
    ...
    $pageVisitorsWhoDidNotVisitAnotherPageExcludeRuleItemGroups      = [];
    $pageVisitorsWhoDidNotVisitAnotherPageExcludeRuleItemGroupA      = new RuleItemGroup();
    $pageVisitorsWhoDidNotVisitAnotherPageExcludeRuleItemsA          = [];
    ...
    $pageVisitorsWhoDidNotVisitAnotherPageExcludeRuleItemsB            = [];
    ...
    $pageVisitorsWhoDidNotVisitAnotherPageIncludeRuleItemGroups        = [];
    $pageVisitorsWhoDidNotVisitAnotherPageIncludeRuleItemGroupA        = new RuleItemGroup();
    $pageVisitorsWhoDidNotVisitAnotherPageIncludeRuleItemsA            = [];
    ...
    $pageVisitorsWhoDidNotVisitAnotherPageIncludeRuleItemsB            = [];
    ...
    $pageVisitorsWhoDidNotVisitAnotherPageIncludeRuleItemsC            = [];
    ...
    $pageVisitorsWhoVisitedAnotherPageAnotherRuleItemGroups      = [];
    $pageVisitorsWhoVisitedAnotherPageAnotherRuleItemGroupA      = new RuleItemGroup();
    $pageVisitorsWhoVisitedAnotherPageAnotherRuleItemsA          = [];
    ...
    $pageVisitorsWhoVisitedAnotherPageAnotherRuleItemsB            = [];
    ...
    $pageVisitorsWhoVisitedAnotherPageRuleItemGroups               = [];
    $pageVisitorsWhoVisitedAnotherPageRuleItemGroupA               = new RuleItemGroup();
    $pageVisitorsWhoVisitedAnotherPageRuleItemsA                   = [];
    ...
    $pageVisitorsWhoVisitedAnotherPageRuleItemsB            = [];
    ...
    $pageVisitorsWhoVisitedAnotherPageRuleItemsC            = [];
