<?php
    ...
    $scrapper_configs['canandaiguacdjr'] = array(
        'entry_points' => array(
            'new'  => 'https://www.canandaiguacdjr.com/new-inventory/index.htm',
            'used' => 'https://www.canandaiguacdjr.com/used-inventory/index.htm',
          //  'certified' => 'http://www.canandaiguacdjr.com/certified-inventory/index.htm'
        ),
    ...
    add_filter("filter_canandaiguacdjr_field_price", "filter_canandaiguacdjr_field_price", 10, 3);
    add_filter("filter_canandaiguacdjr_field_images", "filter_canandaiguacdjr_field_images");
    
    
    function filter_canandaiguacdjr_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_canandaiguacdjr_field_images($im_urls)
    {
