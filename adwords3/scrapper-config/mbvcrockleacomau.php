...
$scrapper_configs["mbvcrockleacomau"] = array( 
	'entry_points' => array(
            'used'  => 'https://www.mbvcrocklea.com.au/stock/used-mercedes-benz-van-for-sale-rocklea/',
            'new'   => 'https://www.mbvcrocklea.com.au/stock/new-mercedes-benz-van-for-sale-rocklea/',
           
          
        ),
        'vdp_url_regex'     => '/\/(?:new|used)-vans\//i',
        'use-proxy' => true,
...
add_filter('filter_mbvcrockleacomau_car_data', 'filter_mbvcrockleacomau_car_data');

function filter_mbvcrockleacomau_car_data($car_data) {
