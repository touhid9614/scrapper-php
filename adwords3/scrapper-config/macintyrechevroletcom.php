...
$scrapper_configs["macintyrechevroletcom"] = array( 
	'entry_points' => array(
...
add_filter("filter_macintyrechevroletcom_field_images", "filter_macintyrechevroletcom_field_images",10,2);
function filter_macintyrechevroletcom_field_images($im_urls, $car_data) {
    $retval = array();
