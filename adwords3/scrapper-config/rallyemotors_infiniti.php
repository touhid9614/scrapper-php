...
$scrapper_configs['rallyemotors_infiniti'] = array(
    'entry_points' => array(
        'new' => 'https://www.rallyemotors-infiniti.ca/imglib/Inventory/shared-cache/8525/NVehInv.js?v=8888838',
        'used' => 'https://www.rallyemotors-infiniti.ca/imglib/Inventory/shared-cache/8525/UVehInv.js?v=2332884',
    ),
    ...
    'custom_data_capture' => function($url, $resp) {
        ...
        foreach ($inventory as $obj) {
            if ($obj->type == 'U') {
                $url = "https://www.rallyemotors-infiniti.ca/default.asp?page=xPreOwnedInventoryDetail";
            } else {
                $url = "https://www.rallyemotors-infiniti.ca/default.asp?page=xNewInventoryDetail";
            }
            $car_data = array(
