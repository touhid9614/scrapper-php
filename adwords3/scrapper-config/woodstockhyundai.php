...
global $scrapper_configs;
 $scrapper_configs["woodstockhyundai"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.woodstockhyundai.com/new/',
            'used'  => 'https://www.woodstockhyundai.com/used/',
        ),
    ...
    add_filter("filter_woodstockhyundai_field_price", "filter_woodstockhyundai_field_price", 10, 3);
    add_filter("filter_woodstockhyundai_field_images", "filter_woodstockhyundai_field_images");
    function filter_woodstockhyundai_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("woodstockhyundai Price: $price");
        }
    ...
    function filter_woodstockhyundai_field_images($im_urls)
    {
