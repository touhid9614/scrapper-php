<?php
    ...
    $scrapper_configs['jenkinskiaofgainesville'] = array(
        'entry_points' => array(
            'new'  => 'http://www.jenkinskiaofgainesville.com/new-inventory/index.htm',
            'used' => 'http://www.jenkinskiaofgainesville.com/used-inventory/index.htm',
          //  'certified' => 'http://www.jenkinskiaofgainesville.com/certified-inventory/index.htm'
        ),
    ...
    add_filter("filter_jenkinskiaofgainesville_field_price", "filter_jenkinskiaofgainesville_field_price", 10, 3);
    add_filter("filter_jenkinskiaofgainesville_field_images", "filter_jenkinskiaofgainesville_field_images");
    
    
    function filter_jenkinskiaofgainesville_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_jenkinskiaofgainesville_field_images($im_urls)
    {
