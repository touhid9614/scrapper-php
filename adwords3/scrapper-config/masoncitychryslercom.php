...
$scrapper_configs["masoncitychryslercom"] = array(
    "entry_points" => array(
        'new' => 'https://www.masoncitychrysler.com/new-inventory/index.htm',
        'used' => 'https://www.masoncitychrysler.com/used-inventory/index.htm'
    ),
