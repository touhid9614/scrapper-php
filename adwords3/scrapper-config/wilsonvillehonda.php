...
global $scrapper_configs;
 $scrapper_configs["wilsonvillehonda"] = array( 
	 'entry_points' => array(
...
function filter_wilsonvillehonda_field_images($im_urls) {
    if (count($im_urls) < 3) {
        return array();
    }
    return $im_urls;
