<?php
    ...
    $scrapper_configs['brucesrv'] = array(
        'entry_points' => array(
            'new'   => 'http://www.brucesrv.ca/imglib/Inventory/cache/535/NVehInv.js',
            'used'  => 'http://www.brucesrv.ca/imglib/Inventory/cache/535/UVehInv.js'
        ),
        'vdp_url_regex'         => '/http:\/\/www.brucesrv.ca\/default.asp\?page=x(?:PreOwned|New)InventoryDetail/',
        'ajax_url_match'        => '/ajax/xxSubmitForm.asp',
        'vdp_page_regex'        => '/http:\/\/www.brucesrv.ca\/default.asp\?page=x(?:PreOwned|New)InventoryDetail/',
        ...
        'custom_data_capture'   => function($url, $data){
            ...
            foreach($objects as $obj)
            {
                ...
                $car_data = array(
                    ...
                    'url'               => "http://www.brucesrv.ca/default.asp?page=xNewInventoryDetail&id={$obj->id}",
