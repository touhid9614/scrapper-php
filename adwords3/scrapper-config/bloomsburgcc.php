...
$scrapper_configs['bloomsburgcc'] = array(
    'entry_points' => array(
        'new'  => 'http://www.bloomsburgcc.com/VehicleSearchResults?search=new',
        'used' => 'http://www.bloomsburgcc.com/VehicleSearchResults?search=preowned',
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_bloomsburgcc_next_page", "filter_bloomsburgcc_next_page",10,2);
     
     
    function filter_bloomsburgcc_next_page($next,$current_page) {
