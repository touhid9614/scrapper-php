...
$scrapper_configs['south20dodge'] = array(
    'entry_points' => array(
        'used' => 'https://www.south20dodge.com/used/city/Humboldt',
        'new'  => 'https://www.south20dodge.com/new/city/Humboldt',
...
add_filter("filter_south20dodge_field_price", "filter_south20dodge_field_price", 10, 3);
add_filter("filter_south20dodge_field_images", "filter_south20dodge_field_images");

function filter_south20dodge_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    if ($price && numarifyPrice($price) > 0) {
        ...
        slecho("south20dodge Price: $price");
    }
...
function filter_south20dodge_field_images($im_urls) {
