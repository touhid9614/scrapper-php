...
$scrapper_configs["perryford"] = array(
    'entry_points' => array(
        'new' => 'https://www.perryford.net/new-inventory/index.htm',
        'used' => 'https://www.perryford.net/used-inventory/index.htm',
    ),
...
add_filter("filter_perryford_field_price", "filter_perryford_field_price", 10, 3);
add_filter("filter_perryford_field_images", "filter_perryford_field_images");

function filter_perryford_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
function filter_perryford_field_images($im_urls) {
