...
$scrapper_configs["johnsonmaseratiofcarycom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.johnsonmaseratiofcary.com/used-inventory/index.htm',
        'new' => 'https://www.johnsonmaseratiofcary.com/new-inventory/index.htm',
       ...
       'vdp_url_regex'     => '/\/(?:new|used|certified)\/[^\/]+\/[0-9]{4}-/i',
        ...
        'data_capture_regx' => array(
            ...
            'trim'          => '/data-trim="(?<trim>[^"]+)/',
            'price'         => '/(?:Sale Price|Original Price)[^>]+>:<\/span><\/span>[^>]+>(?<price>\$[0-9,]+)/',
    ...
    add_filter("filter_johnsonmaseratiofcarycom_field_price", "filter_johnsonmaseratiofcarycom_field_price", 10, 3);
    add_filter("filter_johnsonmaseratiofcarycom_field_images", "filter_johnsonmaseratiofcarycom_field_images");
    function filter_johnsonmaseratiofcarycom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
       ...
       $conditional_regex       =  '/Johnson\'s Internet Price[^>]+>:<\/span><\/span>[^>]+>(?<price>\$[0-9,]+)/';
    ...
    function filter_johnsonmaseratiofcarycom_field_images($im_urls)
    {
           $retval = [];
