...
global $scrapper_configs;
 $scrapper_configs["menzieschryslerdealer"] = array( 
	  'entry_points' => array(
            'new'   => 'https://www.menzieschryslerdealer.com/new-inventory/index.htm',
            'used'  => 'https://www.menzieschryslerdealer.com/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_menzieschryslerdealer_field_price", "filter_menzieschryslerdealer_field_price", 10, 3);
  
    
    function filter_menzieschryslerdealer_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
