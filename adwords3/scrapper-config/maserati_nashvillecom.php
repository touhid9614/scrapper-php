...
$scrapper_configs["maserati_nashvillecom"] = array( 
	'entry_points' => array(
...
add_filter('filter_maserati_nashvillecom_post_data', 'filter_maserati_nashvillecom_post_data', 10, 2);
 add_filter("filter_maserati_nashvillecom_field_images", "filter_maserati_nashvillecom_field_images");
 function filter_maserati_nashvillecom_field_images($im_urls)
    {
