...
$scrapper_configs['goldenvalley_cadillac'] = array(
   'entry_points' => array(
...
function filter_goldenvalley_cadillac_post_data($post_data, $stock_type) {
 ...
 add_filter("filter_goldenvalley_cadillac_field_images", "filter_goldenvalley_cadillac_field_images");
    
     function filter_goldenvalley_cadillac_field_images($im_urls)
     {
        if(count($im_urls)<3)
             {
             return [];
