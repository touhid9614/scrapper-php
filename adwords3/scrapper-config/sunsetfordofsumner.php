...
global $scrapper_configs;
 $scrapper_configs["sunsetfordofsumner"] = array( 
	 'entry_points' => array(
                'new' => 'https://www.sunsetfordofsumner.com/searchnew.aspx',
                'used'=> 'https://www.sunsetfordofsumner.com/searchused.aspx'
        ),
        'vdp_url_regex'       => '/\/(?:new|used)-Sumner-[0-9]{4}-/i',
        ...
        'details_start_tag'   => 'class="row srpSort"',
     ...
     add_filter("filter_sunsetfordofsumner_field_images", "filter_sunsetfordofsumner_field_images");
     add_filter('filter_sunsetfordofsumner_field_price', 'filter_sunsetfordofsumner_field_price',10,3);

        function filter_sunsetfordofsumner_field_images($im_urls)
        {
    ...
    function filter_sunsetfordofsumner_field_price($price,$car_data,$spltd_data)
    {
        $prices = [];
