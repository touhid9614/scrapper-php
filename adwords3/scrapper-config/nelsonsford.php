<?php
    ...
    $scrapper_configs['nelsonsford'] = array(
      'entry_points'    => array(
...
function filter_nelsonsford_post_data($post_data, $stock_type)
{
 ...
 add_filter("filter_nelsonsford_field_images", "filter_nelsonsford_field_images", 10, 2);
function filter_nelsonsford_field_images($im_urls, $car_data)
{
