...
$scrapper_configs["northyorkkia"] = array(
    'entry_points' => array(
        'used' => 'https://www.northyorkkia.ca/used/',
        'new' => 'https://www.northyorkkia.ca/new/',
...
add_filter("filter_northyorkkia_field_price", "filter_northyorkkia_field_price", 10, 3);

function filter_northyorkkia_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $internet_regex = '/Our Price:<\/span>\s*<[^>]+><[^>]+><[^>]+><[^>]+>(?<price>[^\<]+)/';
