<?php
    ...
    $scrapper_configs['bobrohrmanschaumburgford'] = array(
        'entry_points' => array(
              'new' => 'https://www.bobrohrmanschaumburgford.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1',
              
            'used' => 'https://www.bobrohrmanschaumburgford.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        ...
        'custom_data_capture' => function($url, $data) {
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                   ...
                   //'url' => "https://www.bobrohrmanschaumburgford.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
                    'url' 		 => "https://www.bobrohrmanschaumburgford.com{$obj->link}",
 ...
 add_filter("filter_bobrohrmanschaumburgford_next_page", "filter_bobrohrmanschaumburgford_next_page", 10, 2);       
 function filter_bobrohrmanschaumburgford_next_page($next, $current_page) {
...
add_filter("filter_bobrohrmanschaumburgford_field_images", "filter_bobrohrmanschaumburgford_field_images");

function filter_bobrohrmanschaumburgford_field_images($im_urls)
    {
        $retval = [];
