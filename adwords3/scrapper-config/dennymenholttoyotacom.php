...
global $scrapper_configs;
 $scrapper_configs["dennymenholttoyotacom"] = array( 
	 'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/DennyMenholtToyotaSM.csv'
        ),
        'vdp_url_regex'     => '/.com\/(?:auto|search)\/(?:new|used|New|Used|Pre-Owned)-/i',
        ...
        'custom_data_capture' => function($url,$data) {
            ...
            $db_connect = DbConnect::get_instance('dennymenholttoyotacom');
            
            #Update
            $query = "SELECT * FROM dennymenholttoyotacom_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                $car_data = [
                    ...
                    'url'           => "https://www.dennymenholttoyota.com/auto/*/" . $vehicle['vin'],
