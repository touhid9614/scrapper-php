...
$scrapper_configs["buyholidayfordnet"] = array( 
	  'entry_points' => array(
        'new' => 'https://www.buyholidayford.net/searchnew.aspx',
        'used' => 'https://www.buyholidayford.net/searchused.aspx',
    ),
...
add_filter("filter_buyholidayfordnet_field_price", "filter_buyholidayfordnet_field_price", 10, 3);

function filter_buyholidayfordnet_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $msrp_regex = '/(?:Internet|Final) Price.\s*<\/span><span[^>]+>(?<price>\$[0-9,]+)/';
