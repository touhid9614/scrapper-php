...
$scrapper_configs["juliojonesmazda"] = array(
    'entry_points'        => array(
    ...
    'picture_selectors'   => ['.vehicle-image-bg'], //['.owl-item'],
    'picture_nexts'       => ['.swiper-button-next'], //['.owl-next'],
    'picture_prevs'       => ['.swiper-button-prev'], //['owl-prev'],
