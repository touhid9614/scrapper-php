<?php
    ...
    $scrapper_configs['jenkinsmazda'] = array(
        'entry_points' => array(
            'new'  => 'http://www.jenkinsmazda.com/new-inventory/index.htm',
            'used' => 'http://www.jenkinsmazda.com/used-inventory/index.htm',
            //'certified' => 'http://www.jenkinsmazda.com/certified-inventory/index.htm'
        ),
    ...
    add_filter("filter_jenkinsmazda_field_price", "filter_jenkinsmazda_field_price", 10, 3);
    function filter_jenkinsmazda_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
