...
global $scrapper_configs;
 $scrapper_configs["tillemanmotorcom"] = array( 
	'entry_points' => array(
...
add_filter("filter_tillemanmotorcom_field_images", "filter_tillemanmotorcom_field_images",10,2);
function filter_tillemanmotorcom_field_images($im_urls, $car_data) {
    $retval = array();
       if(count($im_urls)<3)
            {
            return [];
