...
$scrapper_configs['autopricecanada'] = array(
    'entry_points' => array(
        'used' => 'https://www.autopricecanada.com/used/',
    ),
    'vdp_url_regex' => '/\/(?:new|used|all)\/vehicle\/[0-9]{4}-/i',
    'use-proxy' => true,
    'picture_selectors' => ['ul.thumb li img'],
    'picture_nexts' => ['li.next'],
    'picture_prevs' => ['li.prev'],
    'details_start_tag' => '<div class="instock-inventory-content',
    'details_end_tag' => '<footer class="footer option-two wp"',
