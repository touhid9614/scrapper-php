...
global $scrapper_configs;
 $scrapper_configs["brucewalterskiacom"] = array( 
	'entry_points' => array(
        'new' => 'https://www.brucewalterskia.com/new-inventory/index.htm',
        'used' => 'https://www.brucewalterskia.com/used-inventory/index.htm'
    ),
    ...
    'images_regx' => '/"id":[^"]+"src":"(?<img_url>[^"]+)","thu/',
    'images_fallback_regx' => '/<meta name="og:image" content="(?<img_url>[^"]+)"/'
);
add_filter("filter_brucewalterskiacom_field_price", "filter_brucewalterskiacom_field_price", 10, 3);

function filter_brucewalterskiacom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
