...
global $scrapper_configs;
 $scrapper_configs["cartownsanangelo"] = array( 
	'entry_points' => array(
        'new'       => 'https://www.cartownsanangelo.com/new-inventory/index.htm',
        'used'      => 'https://www.cartownsanangelo.com/used-inventory/index.htm',
       // 'certified' => 'http://www.cartownsanangelo.com/certified-inventory/index.htm'
    ),
...
add_filter("filter_cartownsanangelo_field_price", "filter_cartownsanangelo_field_price", 10, 3);
    function filter_cartownsanangelo_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
