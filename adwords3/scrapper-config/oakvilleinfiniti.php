...
$scrapper_configs['oakvilleinfiniti'] = array(
    'entry_points' => array(
        'new' => 'https://www.oakvilleinfiniti.com/new-inventory/index.htm',
        'used' => 'https://www.oakvilleinfiniti.com/used-inventory/index.htm'
    ),
...
add_filter("filter_oakvilleinfiniti_field_price", "filter_oakvilleinfiniti_field_price", 10, 3);

function filter_oakvilleinfiniti_field_price($price, $car_data, $spltd_data) {
    $prices = [];
