...
global $scrapper_configs;
 $scrapper_configs["markhaminfiniti"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.markhaminfiniti.com/new/',
            'used'  => 'https://www.markhaminfiniti.com/used/',
        ),
    ...
    add_filter("filter_markhaminfiniti_field_price", "filter_markhaminfiniti_field_price", 10, 3);
 
    function filter_markhaminfiniti_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("markhaminfiniti Price: $price");
        }
