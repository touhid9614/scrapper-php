...
$scrapper_configs["pennautogroupcom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.pennautogroup.com/newandusedcars?pagesize=1000&page=1',
    ),
...
add_filter('filter_pennautogroupcom_field_url', 'filter_pennautogroupcom_field_url');
function filter_pennautogroupcom_field_url($url) {
    return trim($url);
}
