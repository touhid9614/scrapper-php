...
$scrapper_configs["indyhyundai"] = array(
    'entry_points' => array(
          'used' => 'https://www.indyhyundai.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
         'new' => 'https://www.indyhyundai.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1',
        ...
        'custom_data_capture' => function($url, $data) {
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                    ...
                    'price' => $obj->salePrice  ? $obj->salePrice : $obj->msrp,
                    'trim' => $obj->trim,
                   ...
                   // 'images'            => array_merge($obj->photos->user, $obj->photos->stock),    
                    'url' => "https://www.indyhyundai.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_indyhyundai_next_page", "filter_indyhyundai_next_page", 10, 2);       
 function filter_indyhyundai_next_page($next, $current_page) {
...
add_filter("filter_indyhyundai_field_images", "filter_indyhyundai_field_images");
    
    function filter_indyhyundai_field_images($im_urls)
    {
       if(count($im_urls)<2)
            {
            return [];
