...
$scrapper_configs["beavertonmotorcyclescom"] = array( 
	 'entry_points' => array(
        'new'   => 'https://www.beavertonmotorcycles.com/imglib/Inventory/cache/2953/NVehInv.js?v=8241194',
        'used'  => 'https://www.beavertonmotorcycles.com/imglib/Inventory/cache/2953/UVehInv.js?v=4128599',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory as $obj)
           {
               if($obj->type == 'U')   
               {
                   $url="https://www.beavertonmotorcycles.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.beavertonmotorcycles.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
    ...
    add_filter('filter_beavertonmotorcyclescom_field_make', 'unicodify');
    add_filter('filter_beavertonmotorcyclescom_field_model', 'unicodify');

    function beavertonmotorcyclescom_images_proc($image_url)
    {
