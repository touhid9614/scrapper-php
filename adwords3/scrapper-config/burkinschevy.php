...
$scrapper_configs['burkinschevy'] = array(
    'entry_points' => array(
        'new'  => 'http://www.burkinschevy.com/VehicleSearchResults?search=new',
        'used' => 'http://www.burkinschevy.com/VehicleSearchResults?search=preowned'
...
//        'stock_type'     => '/<a itemprop="url" .*\/VehicleDetails\/(?<stock_type>[^\-]+)/',
    ...
    add_filter("filter_burkinschevy_next_page", "filter_burkinschevy_next_page",10,2);
    
    function filter_burkinschevy_next_page($next,$current_page) {
