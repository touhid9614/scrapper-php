...
global $scrapper_configs;
 $scrapper_configs["schalleracura"] = array( 
	  'entry_points' => array(
            'new'  => 'https://www.schalleracura.com/new-inventory/index.htm',
            'used' => 'https://www.schalleracura.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_schalleracura_field_price", "filter_schalleracura_field_price", 10, 3);
    add_filter("filter_schalleracura_field_images", "filter_schalleracura_field_images");
    
    
    function filter_schalleracura_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_schalleracura_field_images($im_urls)
    {
