...
$scrapper_configs['prousechev'] = array(
    'entry_points' => array(
        'new'  => 'http://www.prousechev.com/VehicleSearchResults?search=new',
        'used' => 'http://www.prousechev.com/VehicleSearchResults?search=preowned',
        'certified' => 'http://www.prousechev.com/VehicleSearchResults?search=certified'
    ...
    add_filter("filter_prousechev_next_page", "filter_prousechev_next_page",10,2);
    
    function filter_prousechev_next_page($next,$current_page) {
