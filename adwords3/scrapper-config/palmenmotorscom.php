...
$scrapper_configs["palmenmotorscom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.palmenmotors.com/new-vehicles-kenosha-wi?limit=300',
        'used' => 'https://www.palmenmotors.com/used-vehicles-kenosha-wi?limit=300',
    ),
...
add_filter("filter_palmenmotorscom_field_price", "filter_palmenmotorscom_field_price", 10, 3);

function filter_palmenmotorscom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
