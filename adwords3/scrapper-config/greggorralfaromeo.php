...
global $scrapper_configs;
 $scrapper_configs["greggorralfaromeo"] = array( 
	'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/GreggOrrAlfaRomeoSM.csv'
        ),
        'vdp_url_regex'     => '/com\/auto\/(?:new|used|certified|--)/i',
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('greggorralfaromeo');
            
            #Update
            $query = "SELECT * FROM greggorralfaromeo_scrapped_data WHERE url NOT LIKE '%/--/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                ...
                $car_data = [
                    ...
                    'url'           => "https://www.greggorralfaromeo.com/auto/--/" . $vehicle['vin'],
