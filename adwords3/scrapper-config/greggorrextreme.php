...
global $scrapper_configs;
 $scrapper_configs["greggorrextreme"] = array( 
	'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/GreggOrrExtremeSM.csv'
        ),
        'vdp_url_regex'     => '/\.com\/auto\//i',
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('greggorrextreme');
            
            #Update
            $query = "SELECT * FROM greggorrextreme_scrapped_data WHERE url NOT LIKE '%/--/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                ...
                $car_data = [
                    ...
                    'url'           => "https://www.greggorrextreme.com/auto/--/" . $vehicle['vin'],
