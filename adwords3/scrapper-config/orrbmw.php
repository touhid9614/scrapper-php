...
global $scrapper_configs;
 $scrapper_configs["orrbmw"] = array( 
	'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/OrrBMWSM.csv'
        ),
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('orrbmw');
            
            #Update
            $query = "SELECT * FROM orrbmw_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                $car_data = [
                   ...
                   // 'fuel_type'     => $vehicle['Fuel_Type'],
                    ...
                    'url'           => "https://www.orrbmw.com/auto/*/" . $vehicle['vin'],
