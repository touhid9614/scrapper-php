...
$scrapper_configs["mapleacuracom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.mapleacura.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new' => 'https://www.mapleacura.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                   ...
                   // 'url' => "https://www.brownssl.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
                    'url' => "https://www.mapleacura.com/" . $obj->link,        
 ...
 add_filter("filter_mapleacuracom_next_page", "filter_mapleacuracom_next_page", 10, 2);       
 function filter_mapleacuracom_next_page($next, $current_page) {
