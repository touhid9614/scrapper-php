...
$scrapper_configs["toyotaofcorvalliscom"] = array( 
	"entry_points" => array(
	    'used' => 'https://www.toyotaofcorvallis.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new' => 'https://www.toyotaofcorvallis.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
                ...
                $car_data = array(
                  ...
                  //  'price' => $obj->internetPrice,
                   ...
                   // 'images'            => array_merge($obj->photos->user, $obj->photos->stock),    
                    'url' => "https://www.toyotaofcorvallis.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_toyotaofcorvalliscom_next_page", "filter_toyotaofcorvalliscom_next_page", 10, 2);       
 function filter_toyotaofcorvalliscom_next_page($next, $current_page) {
