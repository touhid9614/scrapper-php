<?php
    ...
    $scrapper_configs['cooksvilledodgechrysler'] = array(
        'entry_points' => array(
            'new'   => 'https://www.cooksvilledodgechrysler.com/new/',
            'used'  => 'https://www.cooksvilledodgechrysler.com/used/',
        ),
        ...
        'data_capture_regx' => array(
            ...
            'price'               => '/Our Price:<\/span>\s*<span[^>]+><meta[^>]+><span[^>]+>(?<price>\$[0-9,]+)/',
    ...
    add_filter("filter_cooksvilledodgechrysler_field_price", "filter_cooksvilledodgechrysler_field_price", 10, 3);
    add_filter("filter_cooksvilledodgechrysler_field_images", "filter_cooksvilledodgechrysler_field_images");
    function filter_cooksvilledodgechrysler_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("cooksvilledodgechrysler Price: $price");
        }
    ...
    function filter_cooksvilledodgechrysler_field_images($im_urls)
    {
