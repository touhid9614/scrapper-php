...
$scrapper_configs["marlowmotorcom"] = array( 
	"entry_points" => array(
        'new' => 'https://www.marlowmotor.com/new-inventory/index.htm',
        'used' => 'https://www.marlowmotor.com/used-inventory/index.htm'
    ),
...
add_filter("filter_marlowmotorcom_field_price", "filter_marlowmotorcom_field_price", 10, 3);

function filter_marlowmotorcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $msrp_regex = '/Marlow Final Price<[^>]+>[^>]+><\/span>[^>]+>(?<price>[^\<]+)/';
    $matches = [];
