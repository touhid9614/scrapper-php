...
$scrapper_configs['arlingtonacura'] = array(
//    'entry_points' => array(
//        'used'  => 'https://www.arlingtonacura.com/used-inventory/index.htm',
//       ),
...
//          $site                 = "https://www.arlingtonacura.com/sitemap.xml";
//          $vdp_url_regex        = '/\/(?:new|used)\/[^\/]+\/[0-9]{4}-/i';
...
// );
    'entry_points' => array(
        'used' => 'https://www.arlingtonacura.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new' => 'https://www.arlingtonacura.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
                ...
                $car_data = array(
                  ...
                  //  'price' => $obj->internetPrice,
                   ...
                   // 'images'            => array_merge($obj->photos->user, $obj->photos->stock),    
                    'url' => "https://www.arlingtonacura.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_arlingtonacura_next_page", "filter_arlingtonacura_next_page", 10, 2);       
 function filter_arlingtonacura_next_page($next, $current_page) {
...
//add_filter("filter_arlingtonacura_field_images", "filter_arlingtonacura_field_images");
//    
//    function filter_arlingtonacura_field_images($im_urls)
//    {
//       if(count($im_urls)<2)
//            {
//            return [];
