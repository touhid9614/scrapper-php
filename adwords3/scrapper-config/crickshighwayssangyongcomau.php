...
$scrapper_configs["crickshighwayssangyongcomau"] = array( 
	'entry_points' => array(
            'used'  => 'https://crickshighwayssangyong.com.au/stock/used',
            // 'demo'  => 'https://crickshighwayssangyong.com.au/stock/demo',
            //removed new and demo because they dont have any new cars. broken scrapers mail are comming for this
            // 'new'   => 'https://crickshighwayssangyong.com.au/stock/new',
        ),
    ...
    add_filter("filter_crickshighwayssangyongcomau_field_price", "filter_crickshighwayssangyongcomau_field_price", 10, 3);
    add_filter("filter_crickshighwayssangyongcomau_field_description", "filter_crickshighwayssangyongcomau_field_description");

function filter_crickshighwayssangyongcomau_field_description($description) {
    return strip_tags($description);
}
    function filter_crickshighwayssangyongcomau_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
add_filter("filter_crickshighwayssangyongcomau_field_images", "filter_crickshighwayssangyongcomau_field_images");
function filter_crickshighwayssangyongcomau_field_images($im_urls) {
    if(count($im_urls)<2)
            {
            return [];
...
add_filter('filter_crickshighwayssangyongcomau_car_data', 'filter_crickshighwayssangyongcomau_car_data');

function filter_crickshighwayssangyongcomau_car_data($car_data) {
