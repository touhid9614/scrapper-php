...
global $scrapper_configs;
 $scrapper_configs["georgetowntoyota"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.georgetowntoyota.com/new/',
            'used'  => 'https://www.georgetowntoyota.com/used/',
        ),
    ...
    add_filter("filter_georgetowntoyota_field_price", "filter_georgetowntoyota_field_price", 10, 3);
    add_filter("filter_georgetowntoyota_field_images", "filter_georgetowntoyota_field_images");
    function filter_georgetowntoyota_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("georgetowntoyota Price: $price");
        }
    ...
    function filter_georgetowntoyota_field_images($im_urls)
    {
