...
$scrapper_configs["murraycadillacca"] = array(
    "entry_points"        => array(
        'new' => 'https://www.murraycadillac.ca/inventory/new',
    ),
    ...
    "custom_data_capture" => function ($url, $data) {
        $site                 = "https://www.murraycadillac.ca/sitemap_index.xml";
        $vdp_url_regex        = '/\/inventory\/(?:New|certified|Used)-[0-9]{4}-[^-]+-/i';
        ...
        $annoy_func = function ($car_data) {
            $api_base = "https://www.murraycadillac.ca/api/ajax_requests/?currentQuery=";
