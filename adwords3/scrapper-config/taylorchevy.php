<?php
    ...
    $scrapper_configs['taylorchevy'] = array(
        'entry_points' => array(
            'new'   => 'http://www.taylorchevy.com/VehicleSearchResults?search=new',
            'used'  => 'http://www.taylorchevy.com/VehicleSearchResults?search=preowned',
           // 'certified'  => 'http://www.taylorchevy.com/VehicleSearchResults?search=certified',
       ),
    ...
    add_filter("filter_taylorchevy_next_page", "filter_taylorchevy_next_page",10,2);
    
    function filter_taylorchevy_next_page($next,$current_page) {
