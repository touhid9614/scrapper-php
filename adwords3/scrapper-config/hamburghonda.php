...
global $scrapper_configs;
 $scrapper_configs["hamburghonda"] = array( 
	 'entry_points' => array(
             'used'  => 'https://www.hamburghonda.ca/used/',
            'new'   => 'https://www.hamburghonda.ca/new/',
    ...
    add_filter("filter_hamburghonda_field_images", "filter_hamburghonda_field_images");
    
    function filter_hamburghonda_field_images($im_urls)
    {
