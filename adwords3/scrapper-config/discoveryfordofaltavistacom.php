...
$scrapper_configs["discoveryfordofaltavistacom"] = array( 
	 'entry_points' => array(
                'new' => 'https://www.discoveryfordofaltavista.com/searchnew.aspx',
                'used'=> 'https://www.discoveryfordofaltavista.com/searchused.aspx'
        ),
       ...
       'refine' => false,
        ...
        'price' => '/DISCOVERY EASY PRICE:\s*<\/span><span[^>]+>(?<price>\$[0-9,]+)/',
    ...
    'images_regx' => '/zoom feature element -->\s*<img src="(?<img_url>[^\?]+)/',
     ...
     add_filter("filter_discoveryfordofaltavistacom_field_images", "filter_discoveryfordofaltavistacom_field_images");
     add_filter('filter_discoveryfordofaltavistacom_field_price', 'filter_discoveryfordofaltavistacom_field_price',10,3);

        function filter_discoveryfordofaltavistacom_field_images($im_urls)
        {
    ...
    function filter_discoveryfordofaltavistacom_field_price($price,$car_data,$spltd_data)
    {
        $prices = [];
        ...
        $market_regex     =  '/Internet Price <\/span>[^>]+>(?<price>[^<]+)/';
