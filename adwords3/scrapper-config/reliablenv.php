...
global $scrapper_configs;
 $scrapper_configs["reliablenv"] = array( 
	'entry_points' => array(
            'used'   => 'https://www.reliablenv.com/Inventory/Search?BodyType=&Year=&Make=&Model=&PriceRange=&PriceStart=&PriceEnd=&Condition=pre-owned-cars&Color=&InteriorColor=&CityMpg=&HighwayMpg=&Transmission=&DriveTrain=&Fuel=&SearchExpression=&SortCriteria=&SortDirection=&LocationId=&IsCertified=-1&IsSold=&IsFuzzySearch=false&startIndex=1&Results=1000',
         ),
           ...
           if (stripos($data, $start_tag)) {
            ...
            foreach($objects->vehicles as $obj)
            {
                ...
                $car_data = array(
                    ...
                    'url'               => "http://www.reliablenv.com/pre-owned-cars/detail/{$obj->Year}-{$obj->Make}-{$obj->Model}/{$obj->VehicleId}",
                    'exterior_color'    => $obj->FactoryColorText,
