...
$scrapper_configs["adventureharleycom"] = array( 
	'entry_points' => array(
        'used' => 'https://adventureharley.com/pre-owned-inventory',
        'new'  => 'https://adventureharley.com/new-inventory',  
    ),
...
add_filter('filter_adventureharleycom_car_data', 'filter_adventureharleycom_car_data');

function filter_adventureharleycom_car_data($car_data) {
