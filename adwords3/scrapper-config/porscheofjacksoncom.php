...
global $scrapper_configs;
 $scrapper_configs["porscheofjacksoncom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.porscheofjackson.com/new-inventory/index.htm',
            'used' => 'https://www.porscheofjackson.com/used-inventory/index.htm',
      ...
      'images_regx' => '/id"[^"]+"src"[^"]+"(?<img_url>[^"]+)"/',
       ...
       add_filter("filter_porscheofjacksoncom_field_images", "filter_porscheofjacksoncom_field_images");
    function filter_porscheofjacksoncom_field_images($im_urls)
    {
      $retval = [];
 ...
 add_filter("filter_porscheofjacksoncom_field_price", "filter_porscheofjacksoncom_field_price", 10, 3);
        function filter_porscheofjacksoncom_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
            ...
            if($price && numarifyPrice($price) > 0) {
                ...
                slecho("porscheofjacksoncom Price: $price");
            }
