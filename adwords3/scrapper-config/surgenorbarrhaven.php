...
$scrapper_configs["surgenorbarrhaven"] = array(
    'entry_points' => array(
        'new' => 'https://www.surgenorbarrhaven.com/en/new-inventory?limit=75&page=1',
        'used' => 'https://www.surgenorbarrhaven.com/en/used-inventory?limit=27&page=1'
    ),
...
add_filter("filter_surgenorbarrhaven_field_price", "filter_surgenorbarrhaven_field_price", 10, 3);

function filter_surgenorbarrhaven_field_price($price, $car_data, $spltd_data) {
    $prices = [];
