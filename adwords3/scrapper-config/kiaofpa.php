<?php
    ...
    $scrapper_configs['kiaofpa'] = array(
        'entry_points' => array(
            'new'   => 'https://www.kiaofpa.com/new/',
            'used'  => 'https://www.kiaofpa.com/used/'
        ),
    ...
    add_filter("filter_kiaofpa_field_price", "filter_kiaofpa_field_price", 10, 3);
    add_filter("filter_kiaofpa_field_images", "filter_kiaofpa_field_images");
    function filter_kiaofpa_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
        ...
        function filter_kiaofpa_field_images($im_urls)
    {
