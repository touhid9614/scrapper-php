<?php
    ...
    $scrapper_configs['mmautogroup'] = array(
        'entry_points' => array(
            'new'  => 'http://www.mmautogroup.com/new-inventory/index.htm',
            'used' => 'http://www.mmautogroup.com/used-inventory/index.htm',   
        ),
    ...
    add_filter("filter_mmautogroup_field_price", "filter_mmautogroup_field_price", 10, 3);
    add_filter("filter_mmautogroup_field_images", "filter_mmautogroup_field_images");
    
   
    function filter_mmautogroup_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
     ...
     function filter_mmautogroup_field_images($im_urls)
    {
