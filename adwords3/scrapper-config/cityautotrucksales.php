<?php
    ...
    $scrapper_configs['cityautotrucksales'] = array (
        'entry_points'  => array(
            'used' => 'https://www.cityautotrucksales.com/used-inventory/index.htm',
        ),
    ...
    add_filter("filter_cityautotrucksales_field_price", "filter_cityautotrucksales_field_price", 10, 3);
    function filter_cityautotrucksales_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
