<?php
    ...
    $scrapper_configs['almachryslerjeepdodgeram'] = array(
        'entry_points' => array(
            'new'  => 'https://www.almachryslerjeepdodgeram.com/new-inventory/index.htm',
            'used' => 'https://www.almachryslerjeepdodgeram.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_almachryslerjeepdodgeram_field_price", "filter_almachryslerjeepdodgeram_field_price", 10, 3);
    add_filter("filter_almachryslerjeepdodgeram_field_images", "filter_almachryslerjeepdodgeram_field_images");
    
    
    function filter_almachryslerjeepdodgeram_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_almachryslerjeepdodgeram_field_images($im_urls)
    {
