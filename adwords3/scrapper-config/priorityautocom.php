...
$scrapper_configs["priorityautocom"] = array( 
	 'entry_points' => array(
        'new' => 'https://www.priorityauto.com/searchnew.aspx',
        'used' => 'https://www.priorityauto.com/searchused.aspx',
    ),
...
add_filter("filter_priorityautocom_field_images", "filter_priorityautocom_field_images");
add_filter('filter_priorityautocom_field_price', 'filter_priorityautocom_field_price', 10, 3);

function filter_priorityautocom_field_images($im_urls) {
...
function filter_priorityautocom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
