...
$scrapper_configs["bannistergmcom"] = array( 
	 'entry_points' => array(
            'used'  => 'https://www.bannistergm.com/used/',
            'new'   => 'https://www.bannistergm.com/new/',
        ),
    ...
    add_filter("filter_bannistergmcom_field_price", "filter_bannistergmcom_field_price", 10, 3);
    add_filter("filter_bannistergmcom_field_images", "filter_bannistergmcom_field_images");
    function filter_bannistergmcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("bannistergmcom Price: $price");
        }
    ...
    function filter_bannistergmcom_field_images($im_urls)
    {
