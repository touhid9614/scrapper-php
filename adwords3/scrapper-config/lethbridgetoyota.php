...
$scrapper_configs['lethbridgetoyota'] = array(
    'entry_points' => array(
         'new' => 'https://www.lethbridgetoyota.com/new/',
        'used' => 'https://www.lethbridgetoyota.com/used/',
       
    ),
       'vdp_url_regex' => '/\/(?:new|used)\/vehicle\//i',
       'refine' => false,
    ...
    add_filter("filter_lethbridgetoyota_field_price", "filter_lethbridgetoyota_field_price", 10, 3);
   
    function filter_lethbridgetoyota_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
