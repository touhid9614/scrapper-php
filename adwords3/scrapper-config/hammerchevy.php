...
$scrapper_configs['hammerchevy'] = array(
      'entry_points' => array(
...
function filter_hammerchevy_post_data($post_data, $stock_type)
{
  ...
  add_filter("filter_hammerchevy_field_images", "filter_hammerchevy_field_images");
function filter_hammerchevy_field_images($im_urls) {
