<?php
    ...
    $scrapper_configs['lexusonthepark'] = array(
        'entry_points' => array(
            'new'   => 'https://www.lexusonthepark.ca/new-inventory/index.htm',
            'used'  => 'https://www.lexusonthepark.ca/used-inventory/index.htm',
        ...
        'data_capture_regx' => array(
            ...
            'trim'          => '/data-trim="(?<trim>[^"]+)/',
            'price'         => '/(?:internetPrice final-price|stackedFinal final-price|final final-price)"><span[^>]+.*<span class=\'value\'\s*>(?<price>\$[0-9,]+)/',
    ...
    add_filter("filter_lexusonthepark_field_price", "filter_lexusonthepark_field_price", 10, 3);
    add_filter("filter_lexusonthepark_field_images", "filter_lexusonthepark_field_images");
    
    
    function filter_lexusonthepark_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_lexusonthepark_field_images($im_urls)
    {
       $retval = array();
