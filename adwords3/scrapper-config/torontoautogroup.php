<?php
    ...
    $scrapper_configs['torontoautogroup'] = array(
        'entry_points' => array(
            'certified'   =>'http://www.torontoautogroup.ca/featured-vehicles/index.htm',
            'used'        => 'http://www.torontoautogroup.ca/toronto-used-cars-dealer.htm'
        ),
    ...
    'certified'   => array(
        ...
        'details_end_tag'   => '<footer class="ddc-footer" >',
...
add_filter('filter_for_fb_torontoautogroup', 'filter_for_fb_torontoautogroup');

function filter_for_fb_torontoautogroup($car) {
    $car['url'] = 'https://form.jotform.com/63266452516962';
    return $car;
}