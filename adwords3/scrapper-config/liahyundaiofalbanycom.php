...
$scrapper_configs["liahyundaiofalbanycom"] = array( 
	   'entry_points' => array(
            'new'   => 'https://www.liahyundaiofalbany.com/searchnew.aspx?Dealership=Lia%20Hyundai%20of%20Albany',
            'used'  => 'https://www.liahyundaiofalbany.com/searchused.aspx?Dealership=Lia%20Hyundai%20of%20Albany',
        ),
        'use-proxy' => true,
     ...
     add_filter("filter_liahyundaiofalbanycom_field_price", "filter_liahyundaiofalbanycom_field_price", 10, 3);
    
    function filter_liahyundaiofalbanycom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $our_price		 =  '/Our Price:\s*[^>]+>[^>]+>(?<price>[$0-9,]+)/';
        ...
        if(preg_match($our_price, $spltd_data, $matches) && numarifyPrice($matches['price']) > 0) {
            $prices[] = numarifyPrice($matches['price']);
            slecho("Regex Our Price: {$matches['price']}");
        }
