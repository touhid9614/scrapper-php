...
$scrapper_configs["mercedesbloomingtoncom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.mercedesbloomington.com/new-inventory/index.htm',
            'used' => 'https://www.mercedesbloomington.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_mercedesbloomingtoncom_field_price", "filter_mercedesbloomingtoncom_field_price", 10, 3);
    add_filter("filter_mercedesbloomingtoncom_field_images", "filter_mercedesbloomingtoncom_field_images");
    
    
    function filter_mercedesbloomingtoncom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_mercedesbloomingtoncom_field_images($im_urls)
    {
