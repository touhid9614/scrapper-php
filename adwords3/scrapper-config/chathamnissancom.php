...
$scrapper_configs["chathamnissancom"] = array( 
	 'entry_points' => array(
            'new'   => 'https://www.chathamnissan.com/new/',
            'used'  => 'https://www.chathamnissan.com/used/'
        ),
        ...
        'data_capture_regx' => array(
            'url'                 => '/href="(?<url>[^"]+)"><span/',
            'year'                => '/temprop=\'releaseDate[^>]+>(?<year>[0-9]{4})/',
    ...
    add_filter("filter_chathamnissancom_field_images", "filter_chathamnissancom_field_images");
    
    function filter_chathamnissancom_field_images($im_urls)
    {
