...
$scrapper_configs["johnsonlexusraleighcom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.johnsonlexusraleigh.com/used-inventory/index.htm',
        'new' => 'https://www.johnsonlexusraleigh.com/new-inventory/index.htm',
    ...
    add_filter("filter_johnsonlexusraleighcom_field_price", "filter_johnsonlexusraleighcom_field_price", 10, 3);
    add_filter("filter_johnsonlexusraleighcom_field_images", "filter_johnsonlexusraleighcom_field_images");
    function filter_johnsonlexusraleighcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_johnsonlexusraleighcom_field_images($im_urls)
    {
           $retval = [];
