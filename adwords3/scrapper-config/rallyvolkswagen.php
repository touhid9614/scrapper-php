...
$scrapper_configs['rallyvolkswagen'] = array(
    'entry_points' => array(
        'new'   => 'http://www.rallyvolkswagen.com/search/new/tp/',
        'used'  => 'http://www.rallyvolkswagen.com/search/used/tp/'
    ),
    'use-proxy' => true,
    ...
    'next_page_regx'   => '/<li class="next">\s*<a class="thm-lighter_text_color" href="(?<next>[^"]+)"/',
    'images_regx'       => '/<meta itemprop="image" content="(?<img_url>http:\/\/[^"]+\.jpg)"/'
);

function rallyvolkswagen_images_proc($image_url)
{
