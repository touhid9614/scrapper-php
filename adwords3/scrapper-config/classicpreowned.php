...
global $scrapper_configs;
 $scrapper_configs["classicpreowned"] = array(
     'entry_points' => array(
         'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/classicpreowned.csv'
     ),
     ...
     'custom_data_capture' => function($url, $resp) {
         ...
         $db_connect = DbConnect::get_instance('classicpreowned');

         #Update
         $query = "SELECT * FROM classicpreowned_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
         ...
         foreach($vehicles as $vehicle) {
             $car_data = [
                 ...
                 'price'         => $vehicle['internetPrice']>0?$vehicle['internetPrice']:$vehicle['MSRP'],
                 'url'           => "https://www.greggorrauto.com/auto/*/" . $vehicle['VIN'],
