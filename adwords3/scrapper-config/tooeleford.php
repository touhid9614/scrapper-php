...
global $scrapper_configs;
 $scrapper_configs["tooeleford"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.tooeleford.net/new-inventory/index.htm',
            'used' => 'https://www.tooeleford.net/used-inventory/index.htm'
        ),
        ...
        'data_capture_regx' => array(
            ...
            'trim'          => '/data-trim="(?<trim>[^"]+)/',
            'price'         => '/final-price"><span class=\'label\'\s*>(?:Price|Sale Price)[^:]+:[^>]+>[^>]+>[^>]+>(?<price>[^<]+)/',
