...
$scrapper_configs['murraycadillacbrandoncom'] = array(
    'entry_points'        => array(
        'new' => 'https://www.murraycadillacbrandon.com/inventory/new/',
    ),
    ...
    "custom_data_capture" => function ($url, $data) {
        $site                 = "https://www.murraycadillacbrandon.com/sitemap_index.xml";
        $vdp_url_regex        = '/\/inventory\/(?:New|certified|Used)-[0-9]{4}-/i';
        ...
        $annoy_func = function ($car_data) {
            $api_base = "https://www.murraycadillacbrandon.com/api/ajax_requests/?currentQuery=";
