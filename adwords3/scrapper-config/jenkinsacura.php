...
$scrapper_configs['jenkinsacura'] = array(
    'entry_points' => array(
        'new' => 'https://www.jenkinsacura.com/new-inventory/index.htm',
        'used' => 'https://www.jenkinsacura.com/used-inventory/index.htm',
    //'certified' => 'http://www.jenkinsacura.com/certified-inventory/index.htm'
    ),
...
add_filter('filter_jenkinsacura_field_images', 'filter_jenkinsacura_field_images');
add_filter('filter_jenkinsacura_field_model', 'filter_jenkinsacura_field_model');

//  add_filter("filter_jenkinsacura_field_price", "filter_jenkinsacura_field_price", 10, 3);

function filter_jenkinsacura_field_images($im_urls) {
    return array_filter($im_urls, function($im_url) {
        return !endsWith($im_url, 'unavailable_stockphoto.png');
    });
}

function filter_jenkinsacura_field_model($model) {
    return str_replace('\x20', ' ', $model);
}

//    function filter_jenkinsacura_field_price($price,$car_data, $spltd_data)
//    {
//        $prices = [];
//        
//        slecho('');
