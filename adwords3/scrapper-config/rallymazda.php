...
$scrapper_configs['rallymazda'] = array(
    'entry_points' => array(
        'new'   => 'http://www.rallymazda.com/search/new/tp/',
        'used'  => 'http://www.rallymazda.com/search/used/tp/'
    ),
    'use-proxy' => true,
...
function rallymazda_images_proc($image_url)
{
