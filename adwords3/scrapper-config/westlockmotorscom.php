...
$scrapper_configs["westlockmotorscom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.westlockmotors.com/new/',
            'used'  => 'https://www.westlockmotors.com/used/'
        ),
    ...
    add_filter("filter_westlockmotorscom_field_images", "filter_westlockmotorscom_field_images");
   
    function filter_westlockmotorscom_field_images($im_urls)
    {
        return array_filter($im_urls, function($im_url){
            return !endsWith($im_url, 'no_image-640x480.jpg');
        });
    }
   add_filter("filter_westlockmotorscom_field_price", "filter_westlockmotorscom_field_price", 10, 3);

    function filter_westlockmotorscom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("westlockmotorscom Price: $price");
        }
