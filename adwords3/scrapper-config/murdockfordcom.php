...
$scrapper_configs["murdockfordcom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.murdockford.com/searchnew.aspx',
        'used' => 'https://www.murdockford.com/searchused.aspx'
    ),
...
add_filter("filter_murdockfordcom_field_price", "filter_murdockfordcom_field_price", 10, 3);

function filter_murdockfordcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
