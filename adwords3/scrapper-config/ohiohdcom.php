...
$scrapper_configs["ohiohdcom"] = array( 
	'entry_points' => array(
        'used' => 'https://ohiohd.com/preowned-inventory',
        'new'  => 'https://ohiohd.com/new-inventory',  
    ),
...
add_filter('filter_ohiohdcom_car_data', 'filter_ohiohdcom_car_data');

function filter_ohiohdcom_car_data($car_data) {
