...
$scrapper_configs["northlandfordmbca"] = array( 
	"entry_points" => array(
	        'new'   => 'https://www.northlandford.mb.ca/queryInventory',
            'used'  => 'https://www.northlandford.mb.ca/queryInventory'
        ),
        'vdp_url_regex'         => '/\/(?:new|pre-owned|certified)\/[^\/]+\/[^\/]+\/[0-9]{4}/',
        'use-proxy'             => true,
        'next_method'           => 'POST',
        'content_type'          => 'application/json',
        
        'picture_selectors' => [' li a img'],
        'picture_nexts'     => ['.next'],
        'picture_prevs'     => ['.prev'],
        'custom_data_capture'   => function($url, $data){
            ...
            foreach($objects->hits->hits as $obj)
            {
                ...
                $car_data = array(
                   ...
                   // 'price'             => $obj->price->finalMaxPrice,
                    'price'             => $obj->price->finalMaxPrice==0?$obj->price->price:$obj->price->finalMaxPrice,
                  ...
                  //  'weekly'            => $weekly,
                   // 'biweekly'          => $weekly * 2,
                    ...
                    'url'               => "https://www.northlandford.mb.ca/" . strtolower($obj->filters->condition) .
