...
$scrapper_configs["hellomazdavalenciacom"] = array( 
'entry_points' => array(
 ...
 foreach($objects->results[0]->hits as $obj)
  ...
  $response_data = HttpGet($car_data['url']);
             ...
             if(!strpos($car_data['description'],"ello Mazda of Valencia")){
                 slecho("the vehicle data is out of hello mazda of valencia");
                 continue;
            }
...
function filter_hellomazdavalenciacom_post_data($post_data, $stock_type)
{
  ...
  add_filter("filter_hellomazdavalenciacom_field_images", "filter_hellomazdavalenciacom_field_images");
function filter_hellomazdavalenciacom_field_images($im_urls) {
