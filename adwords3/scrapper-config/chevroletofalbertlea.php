...
$scrapper_configs["chevroletofalbertlea"] = array(
    'entry_points' => array(
        'new' => 'https://www.chevroletofalbertlea.com/searchnew.aspx',
        'used' => 'https://www.chevroletofalbertlea.com/searchused.aspx',
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/Markquart Price.\s*<\/span><span[^>]+>(?<price>\$[0-9,]+)/',
...
add_filter("filter_chevroletofalbertlea_field_images", "filter_chevroletofalbertlea_field_images");
add_filter('filter_chevroletofalbertlea_field_price', 'filter_chevroletofalbertlea_field_price', 10, 3);

function filter_chevroletofalbertlea_field_images($im_urls) {
    if (count($im_urls) < 2) {
        return array();
    }
...
function filter_chevroletofalbertlea_field_price($price, $car_data, $spltd_data) {
    $prices = [];
