<?php
    ...
    $scrapper_configs['vwcentre'] = array(
        'entry_points' => array(
            'new'   => 'https://www.vwcentre.com/new/',
            'used'  => 'https://www.vwcentre.com/used/'
        ),
    ...
    add_filter("filter_vwcentre_field_images", "filter_vwcentre_field_images");
    
    function filter_vwcentre_field_images($im_urls)
    {
