...
$scrapper_configs['andersonmotors'] = array(
    'entry_points' => array(
        'new' => 'https://www.andersonmotors.ca/new-inventory/index.htm',
        'used' => 'https://www.andersonmotors.ca/used-inventory/index.htm'
    ),
...
add_filter("filter_andersonmotors_field_price", "filter_andersonmotors_field_price", 10, 3);

function filter_andersonmotors_field_price($price, $car_data, $spltd_data) {
    $prices = [];
