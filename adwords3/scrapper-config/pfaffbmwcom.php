...
$scrapper_configs["pfaffbmwcom"] = array( 
	 'entry_points' => array(
             'used'  => 'https://www.pfaffbmw.com/used/',
            'new'   => 'https://www.pfaffbmw.com/new/',
    ...
    add_filter("filter_pfaffbmwcom_field_price", "filter_pfaffbmwcom_field_price", 10, 3);
    add_filter("filter_pfaffbmwcom_field_images", "filter_pfaffbmwcom_field_images");
    function filter_pfaffbmwcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("pfaffbmwcom Price: $price");
        }
    ...
    function filter_pfaffbmwcom_field_images($im_urls)
    {
