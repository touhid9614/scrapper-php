...
global $scrapper_configs;
 $scrapper_configs["markvillemotors"] = array( 
	   'entry_points' => array(
            'new'   => 'http://www.markvillechevrolet.com/new/',
            'used'  => 'http://www.markvillechevrolet.com/used/',
        ),
        ...
        'data_capture_regx' => array(
            ...
            'price'               => '/Internet Finance Price:<\/span>\s*<span[^>]+><meta[^>]+><span[^>]+>(?<price>\$[0-9,]+)/',
    ...
    add_filter("filter_markvillemotors_field_price", "filter_markvillemotors_field_price", 10, 3);
    add_filter("filter_markvillemotors_field_images", "filter_markvillemotors_field_images");
    function filter_markvillemotors_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("markvillemotors Price: $price");
        }
    ...
    function filter_markvillemotors_field_images($im_urls)
    {
