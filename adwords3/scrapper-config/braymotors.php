...
$scrapper_configs['braymotors'] = array(
    'entry_points' => array(
        'new'  => 'http://www.braymotors.com/VehicleSearchResults?search=new',
        'used' => 'http://www.braymotors.com/VehicleSearchResults?search=preowned',
        'certified' => 'http://www.braymotors.com/VehicleSearchResults?search=certified',
    ),
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_braymotors_next_page", "filter_braymotors_next_page",10,2);
     
     
    function filter_braymotors_next_page($next,$current_page) {
