...
$scrapper_configs['jonesfordbuckeye'] = array(
  'entry_points' => array(
...
add_filter("filter_jonesfordbuckeye_field_images", "filter_jonesfordbuckeye_field_images");
    
    function filter_jonesfordbuckeye_field_images($im_urls)
    {
       if(count($im_urls)<2)
            {
            return [];
