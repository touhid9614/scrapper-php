...
global $scrapper_configs;
 $scrapper_configs["grindstaffchryslerdodgejeepram"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.grindstaffchryslerdodgejeepram.com/new-inventory/index.htm',
            'used' => 'https://www.grindstaffchryslerdodgejeepram.com/used-inventory/index.htm',
...
add_filter("filter_grindstaffchryslerdodgejeepram_field_price", "filter_grindstaffchryslerdodgejeepram_field_price", 10, 3);
add_filter("filter_grindstaffchryslerdodgejeepram_field_images", "filter_grindstaffchryslerdodgejeepram_field_images");

function filter_grindstaffchryslerdodgejeepram_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
function filter_grindstaffchryslerdodgejeepram_field_images($im_urls) 
  {
        $retval = [];
