...
$scrapper_configs["klinenissancom"] = array( 
	'entry_points' => array(
...
add_filter("filter_klinenissancom_field_images", "filter_klinenissancom_field_images",10,2);
function filter_klinenissancom_field_images($im_urls, $car_data) {
    $retval = array();
   if(count($im_urls)<3)
            {
            return [];
