...
$scrapper_configs["bloomingtonvwcom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.bloomingtonvw.com/new-inventory/index.htm',
        'used' => 'https://www.bloomingtonvw.com/used-inventory/index.htm'
    ),
