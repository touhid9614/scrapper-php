...
$scrapper_configs["colonychevgmcbuick"] = array(
    'entry_points' => array(
...
function filter_colonychevgmcbuick_field_images($im_urls) {
    if (count($im_urls) < 3) {
        return array();
    }
    return $im_urls;
