...
$scrapper_configs["starautomall191com"] = array( 
	'entry_points' => array(
        'used' => 'https://www.starautomall191.com/newandusedcars?pagesize=1000&page=1',
    ),
...
add_filter('filter_starautomall191com_field_url', 'filter_starautomall191com_field_url');
function filter_starautomall191com_field_url($url) {
    return trim($url);
}
