...
$scrapper_configs['jimxamis'] = array(
    'entry_points' => array(
        'new' => 'https://www.jimxamis.com/searchnew.aspx',
        'used' => 'https://www.jimxamis.com/searchused.aspx',
    ),
    ...
    'images_regx' => '/class="carousel__item[^"]+"><\/div>\s*<[^>]+>\s*<img src="(?<img_url>[^"]+)/'
);
