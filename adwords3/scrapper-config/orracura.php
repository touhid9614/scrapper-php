...
global $scrapper_configs;
 $scrapper_configs["orracura"] = array( 
	'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/OrrAcuraShreveportSM.csv'
        ),
       ...
       'picture_selectors' => ['.view_all_images_wrapper'],
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('orracura');
            
            #Update
            $query = "SELECT * FROM orracura_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                $car_data = [
                    ...
                    'url'           => "https://www.orracura.com/auto/*/" . $vehicle['vin'],
