...
$scrapper_configs['infinitiofbrampton'] = array(
    'entry_points' => array(
        'new' => 'https://www.infinitiofbrampton.com/new-inventory/index.htm',
        'used' => 'https://www.infinitiofbrampton.com/used-inventory/index.htm'
    ),
...
add_filter("filter_infinitiofbrampton_field_price", "filter_infinitiofbrampton_field_price", 10, 3);

function filter_infinitiofbrampton_field_price($price, $car_data, $spltd_data) {
    $prices = [];
