...
$scrapper_configs['gmcarsbynelson'] = array(
    'entry_points' => array(
...
function filter_gmcarsbynelson_post_data($post_data, $stock_type) {
    ...
    add_filter("filter_gmcarsbynelson_field_images", "filter_gmcarsbynelson_field_images");
    function filter_gmcarsbynelson_field_images($im_urls)
    {
        return  array_filter($im_urls,function($img_url){
                return !endsWith($img_url,"placeholder-image.png");
            }
        );
    }
