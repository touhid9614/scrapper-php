...
global $scrapper_configs;
 $scrapper_configs["spanglersubarucom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.spanglersubaru.com/new-inventory/index.htm',
            'used' => 'https://www.spanglersubaru.com/used-inventory/index.htm',
    ...
    add_filter("filter_spanglersubarucom_field_price", "filter_spanglersubarucom_field_price", 10, 3);
    
    
    function filter_spanglersubarucom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
