...
$scrapper_configs['disbrowe'] = array(
     'entry_points' => array(
        'used' => 'https://www.disbrowe.com/used/',
        'new'  => 'https://www.disbrowe.com/new/',
    ),
    ...
    add_filter("filter_disbrowe_field_images", "filter_disbrowe_field_images");
    
    function filter_disbrowe_field_images($im_urls)
    {
       if(count($im_urls)<2)
            {
            return [];
