...
$scrapper_configs["davischevcom"] = array( 
	"entry_points" => array(
		'used' => 'https://www.davisgm.ca/used/',
        'new' => 'https://www.davischev.com/new/'
    ),
...
add_filter("filter_davischevcom_field_price", "filter_davischevcom_field_price", 10, 3);

function filter_davischevcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
