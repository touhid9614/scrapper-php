...
$scrapper_configs['jenkinshyundaiofleesburg'] = array(
    'entry_points' => array(
        'new' => 'https://www.jenkinshyundaiofleesburg.com/new-inventory/index.htm',
        'used' => 'https://www.jenkinshyundaiofleesburg.com/used-inventory/index.htm'
    ),
...
add_filter("filter_jenkinshyundaiofleesburg_field_model", "filter_jenkinshyundaiofleesburg_field_model");
add_filter("filter_jenkinshyundaiofleesburg_field_price", "filter_jenkinshyundaiofleesburg_field_price", 10, 3);

function filter_jenkinshyundaiofleesburg_field_model($model) {
    return str_replace('\x20', ' ', $model);
}

function filter_jenkinshyundaiofleesburg_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
add_filter("filter_jenkinshyundaiofleesburg_field_images", "filter_jenkinshyundaiofleesburg_field_images");

function filter_jenkinshyundaiofleesburg_field_images($im_urls) {
    if (count($im_urls) > 0) {
        unset($im_urls[0]);
    }
    return $im_urls;
