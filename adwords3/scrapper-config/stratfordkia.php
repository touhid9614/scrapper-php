<?php
    ...
    $scrapper_configs['stratfordkia'] = array(
       'entry_points' => array(
             'used'  => 'https://www.stratfordkia.com/used/',
            'new'   => 'https://www.stratfordkia.com/new/',
    ...
    add_filter("filter_stratfordkia_field_price", "filter_stratfordkia_field_price", 10, 3);
    add_filter("filter_stratfordkia_field_images", "filter_stratfordkia_field_images");
    function filter_stratfordkia_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("stratfordkia Price: $price");
        }
    ...
    function filter_stratfordkia_field_images($im_urls)
    {
