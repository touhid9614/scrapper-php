...
$scrapper_configs["acurasouthpointcom"] = array( 
	"entry_points" => array(  
         'used' => 'https://www.acurasouthpoint.com/used-inventory/native.htm',
        'new' => 'https://www.acurasouthpoint.com/new-inventory/index.htm',
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/Selling Price[^>]+>:[^>]+>[^>]+>[^>]+>(?<price>[^<]+)/', ///dealer price///
...
add_filter("filter_acurasouthpointcom_field_price", "filter_acurasouthpointcom_field_price", 10, 3);
add_filter("filter_acurasouthpointcom_field_images", "filter_acurasouthpointcom_field_images");
  

function filter_acurasouthpointcom_field_images($im_urls) {
   $retval = [];
...
function filter_acurasouthpointcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
