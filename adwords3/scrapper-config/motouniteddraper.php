<?php
	global $scrapper_configs;
	 $scrapper_configs["motouniteddraper"] = array( 
		'entry_points' => array(
			'used'  => 'https://www.motounitedsv.com/imglib/Inventory/cache/4412/UVehInv.js?v=7790067',
			'new'   => 'https://www.motounitedsv.com/imglib/Inventory/cache/4412/NVehInv.js?v=2303358',
		),
		...
		'custom_data_capture' => function($url, $resp){
			   ...
			   foreach($inventory as $obj)
			   {
				   if($obj->type == 'U')   
				   {
					   $url="https://www.motounitedsv.com/default.asp?page=xPreOwnedInventoryDetail";
				   }
				   else 
				   {
					   $url="https://www.motounitedsv.com/default.asp?page=xNewInventoryDetail";
				   }
				   $car_data = array(
	
					   'transmission'      => $obj->transmission,
                                           'vin'                => $obj->vin?$obj->vin:$obj->id,
					   ...
					   'url'               => $url.'&id='.$obj->id,
					   'exterior_color'    => $obj->color?$obj->color:"other",
					   'engine'            => $obj->engine,
 ...
 add_filter("filter_motouniteddraper_field_images", "filter_motouniteddraper_field_images");

function filter_motouniteddraper_field_images($im_urls) {

    $final_image = [];
    $check_exist = ["https://www.motounitedsv.com/your%20ZIP"];
