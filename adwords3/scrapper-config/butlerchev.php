...
global $scrapper_configs;
 $scrapper_configs["butlerchev"] = array( 
	'entry_points' => array(
        'new'  => 'https://www.butlerchev.net/VehicleSearchResults?search=new',
        'used' => 'https://www.butlerchev.net/VehicleSearchResults?search=preowned',
       // 'certified' => 'http://www.butlerchev.com/VehicleSearchResults?search=certified',
    ),
    'vdp_url_regex' => '/\/VehicleDetails\/(?:new|used|certified)-[0-9]{4}-\S+/',
     ...
     add_filter("filter_butlerchev_next_page", "filter_butlerchev_next_page",10,2);
     
     
    function filter_butlerchev_next_page($next,$current_page) {
