...
$scrapper_configs['south20rv'] = array(
    'entry_points' => array(
        'new'   => 'https://www.south20rv.com/imglib/Inventory/cache/2194/NVehInv.js?v=8217024',
        'used'  => 'https://www.south20rv.com/imglib/Inventory/cache/2194/UVehInv.js?v=2458402',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory as $obj)
           {
               if($obj->type == 'U')   
               {
                   $url="https://www.south20rv.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.south20rv.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
    ...
    add_filter('filter_south20rv_field_make', 'unicodify');
    add_filter('filter_south20rv_field_model', 'unicodify');

    function south20rv_images_proc($image_url)
    {
