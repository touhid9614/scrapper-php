...
$scrapper_configs["mercedesbenzsouthorlandocom"] = array( 
	"entry_points" => array(

	    'new' => 'https://www.mercedesbenzsouthorlando.com/new-inventory/index.htm',
        'used' => 'https://www.mercedesbenzsouthorlando.com/used-inventory/index.htm',
    ),
    ...
    'data_capture_regx_full' => array(
        'engine' => '/Engine\s*<\/span>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<engine>[^\<]+)/',
         'transmission' => '/Transmission\s*<\/span>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<transmission>[^\<]+)/',
          'interior_color' => '/Interior Color\s*<\/span>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<interior_color>[^\<]+)/',
          'kilometres' => '/Mileage\s*<\/span>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<kilometres>[^\<]+)/',
    ),
