...
$scrapper_configs["hondaofhotsprings"] = array(
    'entry_points' => array(
        'all' => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/GreggOrrHondaHotSpringsSM.csv'
    ),
    ...
    'custom_data_capture' => function ($url, $resp) {
        ...
        #Update
        $query = "SELECT * FROM hondaofhotsprings_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
        ...
        foreach ($vehicles as $vehicle) {
            $car_data = [
                ...
                'url' => "https://www.greggorrhondahotsprings.com/auto/*/" . $vehicle['vin'],
