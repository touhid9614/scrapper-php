...
$scrapper_configs["smprvca"] = array( 
'entry_points' => array(
    ...
    foreach($objects->results[0]->hits as $obj)
        {
            $car_data = array(
                ...
                'year'              => $obj->year,
                'make'              => $obj->make,
                'model'             => preg_replace('/[^A-Za-z0-9 -]/', '', strtolower($obj->model)),
                'trim'              => $obj->trim,
                'body_style'        => $obj->custom_body,
                'price'             => $obj->our_price,
...
add_filter('filter_smprvca_car_data', 'filter_smprvca_car_data');

function filter_smprvca_car_data($car_data)
{
