...
global $scrapper_configs;
 $scrapper_configs["scammellautosalesca"] = array( 
	 'entry_points' => array(
        'used' => 'https://www.scammellautosales.ca/used-inventory/index.htm',
        'new' => 'https://www.scammellautosales.ca/new-inventory/index.htm',
...
add_filter("filter_scammellautosalesca_field_price", "filter_scammellautosalesca_field_price", 10, 3);

function filter_scammellautosalesca_field_price($price, $car_data, $spltd_data) {
    $prices = [];
