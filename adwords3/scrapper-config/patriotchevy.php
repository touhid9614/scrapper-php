<?php
    ...
    $scrapper_configs['patriotchevy'] = array(
        'entry_points' => array(
            'new'   => 'http://www.patriotchevy.com/VehicleSearchResults?search=new',
            'used'  => 'http://www.patriotchevy.com/VehicleSearchResults?search=preowned'
       ),
    ...
    add_filter("filter_patriotchevy_next_page", "filter_patriotchevy_next_page",10,2);
    
    function filter_patriotchevy_next_page($next,$current_page) {
