...
$scrapper_configs["oreganscom"] = array(
    'entry_points' => array(
        'used' => 'https://oserv1.oreganscdn.com/api/vehicle-inventory-search/?do-search=1&search.results-offset=0&search.results-limit=50&app.referrer=https://www.oregans.com',
    ),
    'vdp_url_regex' => '/(?:pre-owned|new|used-cars|Used)-[0-9]{4}-/',
    'use-proxy' => true,
...
add_filter('filter_oreganscom_car_data', 'filter_oreganscom_car_data');
add_filter("filter_oreganscom_next_page", "filter_oreganscom_next_page", 10, 2);

function filter_oreganscom_car_data($car_data) {
    ...
    $car_data['url'] = str_replace('https://', 'https://www.oregans.com', $car_data['url']);
    ...
    if (isset($car_data['vin']) && $car_data['vin']) {
        ...
        $api_url = "https://oserv1.oreganscdn.com/api/vehicle-photos/";
        ...
        $in_cookies = '';
        $out_cookies = '';
        $response_data = HttpPost($api_url, $post_data, $in_cookies, $out_cookies, false, true, 'application/x-www-form-urlencoded', ['origin' => 'https://www.oregans.com']);
...
function filter_oreganscom_next_page($next, $current_page) {
