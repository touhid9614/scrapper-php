...
$scrapper_configs['boundarymotorsports'] = array(
    'entry_points' => array(
        'new'   => 'https://www.boundarymotorsports.com/imglib/Inventory/cache/331/NVehInv.js?v=2554945',
    ...
    'picture_selectors' => ['body.InventoryDetail #invUnitSliderTray .item > ul > li'],
    ...
    'details_start_tag'     => 'var Vehicles=',
        'custom_data_capture'   => function($url, $data){
            ...
            foreach($objects as $obj)
            {
                $car_data = array(
                    ...
                    'year'              => $obj->bike_year,
                    'make'              => unicodifyy($obj->manuf),
                    'model'             => $obj->vehtypename,
                    'trim'              => unicodifyy($obj->model),
                    'body_style'        => $obj->vehtypename,
                    'price'             => $obj->price,
                    'engine'            => $obj->engine,
                    'transmission'      => $obj->transmission,
                    'kilometres'        => $obj->miles,
                    'url'               => "https://www.boundarymotorsports.com/default.asp?page=xNewInventoryDetail&id={$obj->id}",
     ...
     'images_fallback_regx'   => '/unitSliderImg">\s*<img src=\'(?<img_url>[^\']+)/'
        ...
        add_filter('filter_boundarymotorsports_field_make', 'unicodifyy');
add_filter('filter_boundarymotorsports_field_model', 'unicodifyy');

function unicodifyy($txt)
{
