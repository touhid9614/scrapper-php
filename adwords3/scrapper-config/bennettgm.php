...
$scrapper_configs['bennettgm'] = array(
     'entry_points' => array(
        'used' => 'https://www.bennettgm.com/used/',
        'new' => 'https://www.bennettgm.com/new/',
    ),
    ...
    'data_capture_regx' => array(
        ...
        'model' => '/itemprop=\'model\' notranslate>(?<model>[^\s*]+)\s*(?<trim>[^<]+)/',
    ...
    'data_capture_regx_full' => array(
        'price' => '/itemprop="price" content="(?<price>[^"]+)"\s*/',
    ),
