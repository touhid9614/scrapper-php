<?php
    ...
    $scrapper_configs['dundas427usedcars'] = array(
        'entry_points' => array(
            'used'  => 'https://www.dundas427usedcars.ca/used-inventory/index.htm',
        ),
    ...
    add_filter("filter_dundas427usedcars_field_price", "filter_dundas427usedcars_field_price", 10, 3);

    
    function filter_dundas427usedcars_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
