...
$scrapper_configs["westernkia"] = array(
     'entry_points'  => array(
       'used' => 'https://www.westernkia.com/en/used-inventory/api/listing?limit=500',
       'new'  => 'https://service.vehicles.sm360.ca/inventory/vehicles-new?includeMetadata=true&location=NL&organizationId=650&organizationUnitId=1616',
        ...
        'custom_data_capture' => function ($url, $data) {
            ...
            foreach ($objects->vehicles as $obj) {
                ...
                $car_data = array(
                    ...
                    'url'          => "https://www.westernkia.com/en/used-inventory/" . $obj->make->name . '/' . $obj->model->name . '/' . $obj->year . '/' . $obj->year . '-' . $obj->make->name . '-' . $obj->model->name . '-id' . $obj->vehicleId,
      ...
      //  "Content-Length" => "94449",
       ...
       'custom_data_capture' => function($url, $data) {
        ...
        foreach ($objects->inventoryVehicles as $obj) {
            ...
            if($obj->newVehicle){
                $car_data['url']=strtolower("https://www.westernkia.com/en/new-catalog/" . $obj->make->name . '/' . $obj->model->name . '/' . 'buildmy-'  . $obj->make->name . '-' . $obj->model->name . '-' . $obj->bodyStyle->slug .'-id' . $obj->vehicleId);
            }
...
add_filter('filter_westernkia_post_data', 'filter_westernkia_post_data', 10, 2);

function filter_westernkia_post_data($post_data, $stock_type) {
...
add_filter('filter_westernkia_car_data', 'filter_westernkia_car_data');

function filter_westernkia_car_data($car_data) {

     if ($car_data['stock_number'] === '22068' || $car_data['stock_number'] === '22067' || $car_data['stock_number'] === '22845' || $car_data['stock_number'] === '22846' || $car_data['stock_number'] === '22902' || $car_data['stock_number'] === '23059' || $car_data['stock_number'] === '22908' || $car_data['stock_number'] === '23023' || $car_data['stock_number'] === '22842' || $car_data['stock_number'] === '22798' || $car_data['stock_number'] === '23064' || $car_data['stock_number'] === '23058') {
