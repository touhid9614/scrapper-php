...
$scrapper_configs["pfaffaudicom"] = array( 
	 'entry_points' => array(
             'used'  => 'https://www.pfaffaudi.com/used/',
            'new'   => 'https://www.pfaffaudi.com/new/',
    ...
    add_filter("filter_pfaffaudicom_field_price", "filter_pfaffaudicom_field_price", 10, 3);
    add_filter("filter_pfaffaudicom_field_images", "filter_pfaffaudicom_field_images");
    function filter_pfaffaudicom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_pfaffaudicom_field_images($im_urls)
    {
