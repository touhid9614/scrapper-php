...
$scrapper_configs["humberviewgm"] = array(
    "entry_points" => array(
        'new' => 'https://www.humberviewgm.com/new/',
        'used' => 'https://www.humberviewgm.com/used/group/',
    ),
...
add_filter("filter_humberviewgm_field_price", "filter_humberviewgm_field_price", 10, 3);
add_filter("filter_humberviewgm_field_images", "filter_humberviewgm_field_images");

function filter_humberviewgm_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    if ($price && numarifyPrice($price) > 0) {
        ...
        slecho("humberviewgm Price: $price");
    }
...
function filter_humberviewgm_field_images($im_urls) {
