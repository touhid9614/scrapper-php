...
global $scrapper_configs;
 $scrapper_configs["calgaryhondaca"] = array( 
	  'entry_points' => array(
            'used'   => 'https://www.calgaryhonda.ca/en/used-inventory/api/listing?limit=500', 
            'new'   => 'https://www.calgaryhonda.ca/en/new-inventory/api/listing?limit=500',  
        ...
        'vdp_url_regex'     => '/\/en\/(?:new|used)-(?:catalog|inventory)\/[a-zA-Z0-9]+\/[a-zA-Z0-9]+\/[0-9]{4}/i',
                   ...
                   $to_return = array();
                       ...
                       $car_data = array(
                           ...
                           'url'               => "https://www.calgaryhonda.ca/en/" . $stock_type . "-inventory/" . strtolower($obj->make->name) . '/' . strtolower($obj->model->name) . '/'  . $obj->year . '-' . strtolower($obj->make->name) . '-' . strtolower($obj->model->name) . '-id' . $obj->vehicleId,
