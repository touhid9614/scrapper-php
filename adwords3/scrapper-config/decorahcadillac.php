...
$scrapper_configs['decorahcadillac'] = array(
    'entry_points' => array(
        'new'  => 'http://www.decorahcadillac.com/VehicleSearchResults?search=new',
        'used' => 'http://www.decorahcadillac.com/VehicleSearchResults?search=preowned',
        //'certified' => 'http://www.decorahcadillac.com/VehicleSearchResults?search=certified',
    ),
     ...
     add_filter("filter_decorahcadillac_next_page", "filter_decorahcadillac_next_page",10,2);
     
     
    function filter_decorahcadillac_next_page($next,$current_page) {
