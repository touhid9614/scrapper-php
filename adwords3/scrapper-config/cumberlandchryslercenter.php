...
$scrapper_configs['cumberlandchryslercenter'] = array(
   'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/cumberlandcdjr.csv'
        ),
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('cumberlandchryslercenter');
            
            #Update
            $query = "SELECT * FROM cumberlandchryslercenter_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                $car_data = [
                    ...
                    'price'         => $vehicle['Price'],
                    'url'           => "https://www.cumberlandchryslercenter.com/auto/*/" . $vehicle['VIN'],
                ...
                if(key_exists($car_data['vin'], $current_cars)) {
                    ...
                    $explo_url1=explode("chryslercenter-mainten", $explo_url[0]);
