...
$scrapper_configs['decorahchevrolet'] = array(
    'entry_points' => array(
        'new'  => 'http://www.decorahchevrolet.com/VehicleSearchResults?search=new',
        'used' => 'http://www.decorahchevrolet.com/VehicleSearchResults?search=preowned',
        'certified' => 'http://www.decorahchevrolet.com/VehicleSearchResults?search=certified',
    ),
    ...
    'images_regx'        => '/itemprop="associatedMedia".*data-src="(?<img_url>[^"]+)/',
     ...
     add_filter("filter_decorahchevrolet_next_page", "filter_decorahchevrolet_next_page",10,2);
     
     
    function filter_decorahchevrolet_next_page($next,$current_page) {
