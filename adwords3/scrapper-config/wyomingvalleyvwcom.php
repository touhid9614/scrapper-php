...
$scrapper_configs["wyomingvalleyvwcom"] = array( 
	'entry_points' => array(
...
add_filter("filter_wyomingvalleyvwcom_field_images", "filter_wyomingvalleyvwcom_field_images",10,2);
function filter_wyomingvalleyvwcom_field_images($im_urls, $car_data) {
   if(count($im_urls)<3)
            {
            return [];
