...
$scrapper_configs['planethonda'] = array(
    'entry_points' => array(
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            $md5_of_no_car_images = [
                '7e73dce071bd2d409e5a906999b1559d'
            ];

            $all_images = array_filter((array)$obj->thumbnail, function ($image_url) use ($md5_of_no_car_images) {
            ...
            $car_data = array(
                ...
                'all_images' => isset($all_images[0]) ? $all_images[0] : '',
                'title' => $obj->title_vrp,
            );
...
add_filter('filter_planethonda_post_data', 'filter_planethonda_post_data', 10, 2);

function filter_planethonda_post_data($post_data, $stock_type)
{
    if ($stock_type == 'new') {
        $post_data = '{"requests":[{"indexName":"planethonda_production_inventory_low_to_high","params":"query=&hitsPerPage=1000&page=0&facets=%5B%22features%22%2C%22our_price%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.finance_monthly_payment%22%2C%22type%22%2C%22api_id%22%2C%22year%22%2C%22make%22%2C%22model%22%2C%22trim%22%2C%22body%22%2C%22miles%22%2C%22ext_color_generic%22%2C%22features%22%2C%22lightning.isSpecial%22%2C%22lightning.locations%22%2C%22fueltype%22%2C%22engine_description%22%2C%22transmission_description%22%2C%22metal_flags%22%2C%22lightning.locations.meta_location%22%5D&tagFilters=&facetFilters=%5B%5B%22type%3ANew%22%5D%5D"},{"indexName":"planethonda_production_inventory_low_to_high","params":"query=&hitsPerPage=1&page=0&attributesToRetrieve=%5B%5D&attributesToHighlight=%5B%5D&attributesToSnippet=%5B%5D&tagFilters=&analytics=false&clickAnalytics=false&facets=type"}]}';
