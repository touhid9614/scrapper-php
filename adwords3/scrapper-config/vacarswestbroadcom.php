...
$scrapper_configs["vacarswestbroadcom"] = array(
    'entry_points'         => array(
        'used' => 'https://www.vacarswestbroad.com/inventory',
    ),
    'vdp_url_regex'        => '/\/VehicleDetails\/[0-9]{4}\/[A-z0-9]{4,9}\/Henrico-VA-[0-9]{4}-/i',
    ...
    "custom_data_capture"  => function ($url, $data) {
        ...
        // file_put_contents("../caches/vacarsinccom.txt", print_r($merged_data, true));
