...
$scrapper_configs['orangevillehonda'] = array(
    'entry_points' => array(
        'new' => 'https://www.orangevillehonda.com/new/',
        'used' => 'https://www.orangevillehonda.com/used/group/'
    ),
...
add_filter("filter_orangevillehonda_field_images", "filter_orangevillehonda_field_images");

function filter_orangevillehonda_field_images($im_urls) {
