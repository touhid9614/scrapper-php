<?php
    ...
    $scrapper_configs['wallingfordautopark'] = array(
        'entry_points' => array(
            'used'  => 'https://www.wallingfordautopark.com/used-inventory/index.htm'
        ),
...
//        'images_regx'       => '/<li>\s*<a href="(?<img_url>(?:https?:)?\/\/pictures.dealer.com\/c\/[^"]+)" class="">/',
    ...
    add_filter("filter_wallingfordautopark_field_images", "filter_wallingfordautopark_field_images");
    
    function filter_wallingfordautopark_field_images($im_urls)
    {
