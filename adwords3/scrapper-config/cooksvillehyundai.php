...
global $scrapper_configs;
 $scrapper_configs["cooksvillehyundai"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.cooksvillehyundai.com/new/',
            'used'  => 'https://www.cooksvillehyundai.com/used/',
        ),
    ...
    add_filter("filter_cooksvillehyundai_field_price", "filter_cooksvillehyundai_field_price", 10, 3);
    add_filter("filter_cooksvillehyundai_field_images", "filter_cooksvillehyundai_field_images");
    function filter_cooksvillehyundai_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("cooksvillehyundai Price: $price");
        }
    ...
    function filter_cooksvillehyundai_field_images($im_urls)
    {
