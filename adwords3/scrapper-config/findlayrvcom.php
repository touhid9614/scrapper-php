...
$scrapper_configs["findlayrvcom"] = array( 
	"entry_points" => array(
	    'new'  => 'https://www.findlayrv.com/imglib/Inventory/cache/1833/NVehInv.js?v=9148939',
        'used' => 'https://www.findlayrv.com/imglib/Inventory/cache/1833/UVehInv.js?v=4181196',
           ...
           // $$tdata=$tdata . "]";
            ...
            foreach($objects as $obj)
            {
                $car_data = array(
                    ...
                    'url'               => "https://www.findlayrv.com/default.asp?page=xNewInventoryDetail&id={$obj->id}",
