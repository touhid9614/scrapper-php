<?php
    ...
    $scrapper_configs['audikw'] = array(
        'entry_points' => array(
            'new'   => 'http://www.audikw.com/new/',
            'used'  => 'http://www.audikw.com/used/'
        ),
    ...
    add_filter("filter_audikw_field_images", "filter_audikw_field_images");
    
    function filter_audikw_field_images($im_urls)
    {
