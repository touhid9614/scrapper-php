<?php
    ...
    $scrapper_configs['countryford'] = array(
        'entry_points' => array(
            'new'   => 'https://www.countryford.ca/new/',
            'used'  => 'https://www.countryford.ca/used/'
        ),
    ...
    add_filter("filter_countryford_field_images", "filter_countryford_field_images");
    
    function filter_countryford_field_images($im_urls)
    {
