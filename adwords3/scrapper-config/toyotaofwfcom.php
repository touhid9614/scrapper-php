...
$scrapper_configs['toyotaofwfcom'] = array(
     'entry_points' => array(
        'used' => 'https://www.toyotaofwf.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new' => 'https://www.toyotaofwf.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
                ...
                $car_data = array(
                  ...
                  //  'price' => $obj->pricing->finalPrice,
                   ...
                   // 'images'            => array_merge($obj->photos->user, $obj->photos->stock),    
                    'url' => "https://www.toyotaofwf.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_toyotaofwfcom_next_page", "filter_toyotaofwfcom_next_page", 10, 2);       
 function filter_toyotaofwfcom_next_page($next, $current_page) {
