...
global $scrapper_configs;
 $scrapper_configs["lloydbeltautomotive"] = array( 
	'entry_points' => array(
        'used' => 'https://lloydbeltautomotive.com/used-vehicles/',
    ),
...
add_filter("filter_lloydbeltautomotive_next_page", "filter_lloydbeltautomotive_next_page", 10, 2);

function filter_lloydbeltautomotive_next_page($next, $current_page) {
