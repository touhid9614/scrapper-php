...
$scrapper_configs["wyomingvalleykiacom"] = array( 
	'entry_points' => array(
...
add_filter("filter_wyomingvalleykiacom_field_images", "filter_wyomingvalleykiacom_field_images",10,2);
function filter_wyomingvalleykiacom_field_images($im_urls, $car_data) {
    $retval = array();
