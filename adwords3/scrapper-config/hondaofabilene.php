...
$scrapper_configs['hondaofabilene'] = array(
    'entry_points' => array(
        'new' => 'https://www.hondaofabilene.com/new-inventory/index.htm',
        'used' => 'https://www.hondaofabilene.com/used-inventory/index.htm',
    ),
...
add_filter("filter_hondaofabilene_field_price", "filter_hondaofabilene_field_price", 10, 3);
add_filter("filter_hondaofabilene_field_images", "filter_hondaofabilene_field_images");

function filter_hondaofabilene_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
function filter_hondaofabilene_field_images($im_urls) {
