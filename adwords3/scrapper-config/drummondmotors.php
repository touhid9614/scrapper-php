...
$scrapper_configs["drummondmotors"] = array(
  'entry_points' => array(
             'used'  => 'https://www.drummondmotors.ca/used/',
             'new'   => 'https://www.drummondmotors.ca/new',
    ...
    add_filter("filter_drummondmotors_field_images", "filter_drummondmotors_field_images");
    
    function filter_drummondmotors_field_images($im_urls)
    {
