...
global $scrapper_configs;
 $scrapper_configs["murrayfordstarkecom"] = array( 
	   'entry_points' => array(
            'new'  => 'https://www.murrayfordstarke.com/searchnew.aspx',
            'used' => 'https://www.murrayfordstarke.com/searchused.aspx'
        ),
        'vdp_url_regex'     => '/\/(?:new|used)-Starke-[0-9]{4}-/i',
        'use-proxy' => true,
...
add_filter("filter_murrayfordstarkecom_field_price", "filter_murrayfordstarkecom_field_price", 10, 3);
        function filter_murrayfordstarkecom_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
            ...
            if($price && numarifyPrice($price) > 0) {
                ...
                slecho("murrayfordstarkecom Price: $price");
            }
