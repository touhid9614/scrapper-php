...
$scrapper_configs["crickshighwaykiacomau"] = array( 
'entry_points' => array(
            'new'   => 'https://crickshighwaykia.com.au/stock/new',
            'used'  => 'https://crickshighwaykia.com.au/stock/used',
            'demo'  => 'https://crickshighwaykia.com.au/stock/demo',
        ),
    ...
    add_filter("filter_crickshighwaykiacomau_field_price", "filter_crickshighwaykiacomau_field_price", 10, 3);
    add_filter("filter_crickshighwaykiacomau_field_description", "filter_crickshighwaykiacomau_field_description");

function filter_crickshighwaykiacomau_field_description($description) {
    return strip_tags($description);
}
    function filter_crickshighwaykiacomau_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
add_filter("filter_crickshighwaykiacomau_field_images", "filter_crickshighwaykiacomau_field_images");
function filter_crickshighwaykiacomau_field_images($im_urls) {
    if(count($im_urls)<2)
            {
            return [];
...
add_filter('filter_crickshighwaykiacomau_car_data', 'filter_crickshighwaykiacomau_car_data');

function filter_crickshighwaykiacomau_car_data($car_data) {
