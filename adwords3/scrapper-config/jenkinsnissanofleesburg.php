<?php
    ...
    $scrapper_configs['jenkinsnissanofleesburg'] = array(
        'entry_points' => array(
            'new'  => 'https://www.jenkinsnissanofleesburg.com/new-inventory/index.htm',
            'used' => 'https://www.jenkinsnissanofleesburg.com/used-inventory/index.htm',
        //    'certified' => 'http://www.jenkinsnissanofleesburg.com/certified-inventory/index.htm'
        ),
    ...
    add_filter("filter_jenkinsnissanofleesburg_field_price", "filter_jenkinsnissanofleesburg_field_price", 10, 3);
    function filter_jenkinsnissanofleesburg_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
