...
$scrapper_configs["findlayacuracom"] = array( 
	'entry_points' => array(
...
function filter_findlayacuracom_field_price($price, $car_data, $spltd_data) {
    ...
    $msrp_regex = '/MSRP<\/strong><\/span><\/span>\s*<[^>]+><[^>]+><strong>(?<price>[^\<]+)/';
    $matches = [];
