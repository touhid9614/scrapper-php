<?php
    ...
    $scrapper_configs['mazdasbynelson'] = array(
       'entry_points' => array(
    ...
    'custom_data_capture' => function($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            $car_data = array(
                ...
                'stock_type'   => $obj->type=='Certified Used'? 'certified': ($obj->type=='Pre-Owned' ? 'used' : 'new'),
                'year' => $obj->year,
                'make' => $obj->make,
                'model' => $obj->model,
                'trim' => $obj->trim,
