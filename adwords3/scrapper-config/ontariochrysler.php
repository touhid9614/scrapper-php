<?php
    ...
    $scrapper_configs['ontariochrysler'] = array(
        'entry_points' => array(
            'new'   => 'https://www.ontariochrysler.ca/new-inventory/index.htm',
            'used'  => 'https://www.ontariochrysler.ca/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_ontariochrysler_field_images", "filter_ontariochrysler_field_images");
    add_filter("filter_ontariochrysler_field_price", "filter_ontariochrysler_field_price", 10, 3);

    function filter_ontariochrysler_field_images($im_urls)
    {
        $retval=array();
        ...
        return array_filter($retval, function($im_url){
            return !(endsWith($im_url, '45d96da759a6ec544557b7811b80f78cx.jpg')||endsWith($im_url, '5cbfe11e315786d3ec5e16f815aa323ax.jpg'));
        });
    }
    function filter_ontariochrysler_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $internet_regex   =  '/internetPrice final-price">.*class=\'value\'\s>(?<price>[^<]+)/';
