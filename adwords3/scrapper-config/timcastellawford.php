...
global $scrapper_configs;
 $scrapper_configs["timcastellawford"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.timcastellawford.net/searchnew.aspx',
            'used'  => 'https://www.timcastellawford.net/searchused.aspx'
        ),
        'use-proxy' => true,
        ...
        'data_capture_regx' => array(
            ...
            'price'         => '/Final Price:\s*<\/span>[^>]+>(?<price>[$0-9,]+)/',
     ...
     add_filter("filter_timcastellawford_field_price", "filter_timcastellawford_field_price", 10, 3);
    
    function filter_timcastellawford_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
