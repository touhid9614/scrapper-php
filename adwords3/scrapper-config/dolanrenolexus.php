...
$scrapper_configs['dolanrenolexus'] = array(
    'entry_points' => array(
        'new' => 'https://www.dolanrenolexus.com/new-inventory/index.htm',
        'used' => 'https://www.dolanrenolexus.com/used-inventory/index.htm',
    ),
    ...
    'details_start_tag' => '<ul class="inventoryList data list list-unstyled">',
...
add_filter("filter_dolanrenolexus_field_price", "filter_dolanrenolexus_field_price", 10, 3);
add_filter("filter_dolanrenolexus_field_images", "filter_dolanrenolexus_field_images");

function filter_dolanrenolexus_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
function filter_dolanrenolexus_field_images($im_urls) {
