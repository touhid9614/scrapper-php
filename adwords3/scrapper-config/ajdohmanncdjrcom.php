...
$scrapper_configs["ajdohmanncdjrcom"] = array( 
	"entry_points" => array(
	  'used' => 'https://www.ajdohmanncdjr.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new' => 'https://www.ajdohmanncdjr.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
 ...
 add_filter("filter_ajdohmanncdjrcom_next_page", "filter_ajdohmanncdjrcom_next_page", 10, 2);       
 function filter_ajdohmanncdjrcom_next_page($next, $current_page) {
