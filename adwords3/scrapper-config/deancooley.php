<?php
    ...
    $scrapper_configs['deancooley'] = array(
        'entry_points' => array(
            'new'   => 'http://www.deancooleygm.ca/new-inventory/index.htm',
            'used'  => 'http://www.deancooleygm.ca/used-inventory/index.htm',
            //'certified' => 'http://www.deancooleygm.ca/certified-inventory/index.htm'
        ),
        ...
        'data_capture_regx' => array(
            ...
            'certified'     => '/class="url"\s*href="\/(?<certified>certified)/'
        ),
    ...
    add_filter("filter_deancooley_field_price", "filter_deancooley_field_price", 10, 3);
    function filter_deancooley_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
