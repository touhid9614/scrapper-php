...
global $scrapper_configs;
 $scrapper_configs["buerkleacuracom"] = array( 
	   'entry_points' => array(
            'new'  => 'https://www.buerkleacura.com/searchnew.aspx',
            'used' => 'https://www.buerkleacura.com/searchused.aspx'
        ),
        'vdp_url_regex'     => '/\/(?:new|used)-Minneapolis-[0-9]{4}-/i',
        'use-proxy' => true,
...
add_filter("filter_buerkleacuracom_field_price", "filter_buerkleacuracom_field_price", 10, 3);
        function filter_buerkleacuracom_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
            ...
            if($price && numarifyPrice($price) > 0) {
                ...
                slecho("buerkleacuracom Price: $price");
            }

            $msrp_regex =  '/Internet Price[^>]+>[^>]+>(?<price>\$[0-9,]+)/';
