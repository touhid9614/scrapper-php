...
global $scrapper_configs;
 $scrapper_configs["clarksussex"] = array( 
	'entry_points' => array(
        ...
        'certified' => 'https://www.clarkssussex.ca/VehicleSearchResults?search=certified',
    ),
    'vdp_url_regex' => '/\/VehicleDetails\/(?:new|used|certified)-[0-9]{4}-\S+/',
     ...
     add_filter("filter_clarksussex_next_page", "filter_clarksussex_next_page",10,2);
     
     
    function filter_clarksussex_next_page($next,$current_page) {
