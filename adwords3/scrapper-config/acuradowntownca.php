...
$scrapper_configs["acuradowntownca"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.acuradowntown.ca/new/',
            'used'  => 'https://www.acuradowntown.ca/used/'
        ),
    ...
    add_filter("filter_acuradowntownca_field_images", "filter_acuradowntownca_field_images");
   
    function filter_acuradowntownca_field_images($im_urls)
    {
        return array_filter($im_urls, function($im_url){
            return !endsWith($im_url, 'no_image-640x480.jpg');
        });
    }
   add_filter("filter_acuradowntownca_field_price", "filter_acuradowntownca_field_price", 10, 3);

    function filter_acuradowntownca_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("acuradowntownca Price: $price");
        }
