...
$scrapper_configs["gatesofgrangercom"] = array( 
	 'entry_points' => array(
      
        'used' => 'https://www.gatesofgranger.com/used-inventory/index.htm',
    ),
  ...
  add_filter("filter_gatesofgrangercom_field_images", "filter_gatesofgrangercom_field_images");
    
    function filter_gatesofgrangercom_field_images($im_urls)
    {
        $retval = [];
