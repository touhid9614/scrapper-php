...
$scrapper_configs["indygenesisnet"] = array( 
	'entry_points' => array(
        'new'  => 'https://www.indygenesis.net/new-inventory/index.htm',
       ),
      ...
      "custom_data_capture" => function ($url, $data) {
          $site                 = "https://www.indygenesis.net/sitemap.xml";
          $vdp_url_regex        = '/\/(?:new|used)\/[^\/]+\/[0-9]{4}-/i';
...
add_filter("filter_indygenesisnet_field_images", "filter_indygenesisnet_field_images");

function filter_indygenesisnet_field_images($im_urls) 
