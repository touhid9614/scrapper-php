<?php
    ...
    $scrapper_configs['johnholtok'] = array(
        'entry_points' => array(
            'new'   => 'http://www.johnholtok.com/VehicleSearchResults?search=new',
            'used'  => 'http://www.johnholtok.com/VehicleSearchResults?search=used'
       ),
        ...
        'data_capture_regx_full' => array(
            'kilometres'    => '/title="MILEAGE".*\s*<span[^>]+>(?<kilometres>[^<]+)/',
     ...
     add_filter("filter_johnholtok_next_page", "filter_johnholtok_next_page",10,2);
    
    function filter_johnholtok_next_page($next,$current_page) {
