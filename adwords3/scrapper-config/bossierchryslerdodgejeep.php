<?php
    ...
    $scrapper_configs['bossierchryslerdodgejeep'] = array(
        'entry_points' => array(
            'new'   => 'http://www.bossierchryslerdodgejeep.net/new-inventory/index.htm',
            'used'  => 'http://www.bossierchryslerdodgejeep.net/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_bossierchryslerdodgejeep_field_images", "filter_bossierchryslerdodgejeep_field_images");
    
    function filter_bossierchryslerdodgejeep_field_images($im_urls)
    {
       $retval = array();
