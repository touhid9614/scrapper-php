...
$scrapper_configs["landroverbedfordcom"] = array( 
	     'entry_points' => array(
            'new'  => 'https://www.landroverbedford.com/new-inventory/index.htm',
            'used' => 'https://www.landroverbedford.com/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_landroverbedfordcom_field_price", "filter_landroverbedfordcom_field_price", 10, 3);
    add_filter("filter_landroverbedfordcom_field_images", "filter_landroverbedfordcom_field_images");
    
    
    function filter_landroverbedfordcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_landroverbedfordcom_field_images($im_urls)
    {
