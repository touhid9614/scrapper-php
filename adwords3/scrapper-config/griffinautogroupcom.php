...
$scrapper_configs["griffinautogroupcom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.griffinautogroup.com/searchnew.aspx',
        'used' => 'https://www.griffinautogroup.com/searchused.aspx'
    ),
...
add_filter("filter_griffinautogroupcom_field_price", "filter_griffinautogroupcom_field_price", 10, 3);

function filter_griffinautogroupcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
