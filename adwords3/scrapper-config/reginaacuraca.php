...
$scrapper_configs["reginaacuraca"] = array( 
	'entry_points'        => array(
        'used' => 'https://www.reginaacura.ca/en/used-inventory/api/listing?limit=500',
        'new'  => 'https://www.reginaacura.ca/en/new-inventory/api/listing?limit=500', 
    ),
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->vehicles as $obj) {
            ...
            $car_data   = array(
                ...
                'url'          => strtolower("https://www.reginaacura.ca/en/" . $stock_type . "-inventory/" . $obj->make->name . '/' . $obj->model->name . '/' . $obj->year . '-' . $obj->make->name . '-' . $obj->model->name . '-id' . $obj->vehicleId),
