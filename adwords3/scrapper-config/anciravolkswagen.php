<?php
    ...
    $scrapper_configs['anciravolkswagen'] = array(

        'entry_points' => array(
                'new' => 'https://www.anciravolkswagen.com/new-cars-volkswagen-san-antonio.html',
                'used'=> 'https://www.anciravolkswagen.com/used-car-dealer-san-antonio.html'
        ),
        'vdp_url_regex'       => '/\/(?:new|used)-San[^\-]+-[0-9]{4}-/i',
     ...
     add_filter("filter_anciravolkswagen_field_images", "filter_anciravolkswagen_field_images");
     add_filter('filter_anciravolkswagen_field_price', 'filter_anciravolkswagen_field_price',10,3);

        function filter_anciravolkswagen_field_images($im_urls)
        {
    ...
    function filter_anciravolkswagen_field_price($price,$car_data,$spltd_data)
    {
        $prices = [];
