...
$scrapper_configs['princealbertoyotaca'] = array(
    'entry_points'        => array(
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            if(strpos($obj->thumbnail,"89987ee9ef0f4e7a9356501e0bcfcf1b") || strpos($obj->thumbnail,"334dbe4cf909e045d8a2d3ad3defcb6b")){
                $car_data['all_images']="";
            }
...
add_filter('filter_princealbertoyotaca_post_data', 'filter_princealbertoyotaca_post_data', 10, 2);
function filter_princealbertoyotaca_post_data($post_data, $stock_type)
{
    if ($stock_type == 'new') {
