...
$scrapper_configs["stadiumautocaliforniacom"] = array( 
	'entry_points' => array(
            'used' => 'https://www.stadiumautocalifornia.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_stadiumautocaliforniacom_field_price", "filter_stadiumautocaliforniacom_field_price", 10, 3);
    add_filter("filter_stadiumautocaliforniacom_field_images", "filter_stadiumautocaliforniacom_field_images");
    
    
    function filter_stadiumautocaliforniacom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_stadiumautocaliforniacom_field_images($im_urls)
    {
