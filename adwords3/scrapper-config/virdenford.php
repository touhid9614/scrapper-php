<?php
    ...
    $scrapper_configs['virdenford'] = array(
       'entry_points' => array(
            'new'   => 'https://www.virdenford.ca/queryInventory',
            'used'  => 'https://www.virdenford.ca/queryInventory'
        ),
        ...
        'custom_data_capture'   => function($url, $data){
            ...
            foreach($objects->hits->hits as $obj)
            {
                ...
                $car_data = array(
                    ...
                    'url'               => "https://www.virdenford.ca/" . strtolower($obj->filters->condition) .
