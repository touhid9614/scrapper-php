...
$scrapper_configs['autosbynelson'] = array(
    'entry_points' => array(
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            $car_data = array(
                ...
                'model'          => $obj->model,
                'trim'           => $obj->trim,
                'body_style'     => substr($obj->body, 0, -1),
                'price'          => $obj->our_price,
