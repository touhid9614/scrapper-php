<?php
    ...
    $scrapper_configs['patmillikenford'] = array(
        'entry_points' => array(
            'new'  => 'https://www.patmillikenford.com/ford-for-sale-detroit-mi.html',
            'used' => 'https://www.patmillikenford.com/used-cars-detroit-mi.html',   
        ),
        'vdp_url_regex'     => '/\/(?:new|used)-Redfor[^\-]+-[0-9]{4}-/i',
        ...
        'data_capture_regx' => array(
            ...
            'price'            => '/(?:A\s*Plan\s*Price|Internet\s*Price).\s*<\/span><span[^>]+>(?<price>\$[0-9,]+)/',
        ),
        
        
        'data_capture_regx_full' => array(
            'body_style'      => '/Body\s+Style<\/span>\s*[^>]+>(?<body_style>[^<]+)/',
   ...
   add_filter("filter_patmillikenford_field_images", "filter_patmillikenford_field_images");
     add_filter('filter_patmillikenford_field_price', 'filter_patmillikenford_field_price',10,3);

        function filter_patmillikenford_field_images($im_urls)
        {
           if (count($im_urls) <= 2) {
            return array();
        }
    ...
    function filter_patmillikenford_field_price($price,$car_data,$spltd_data)
    {
        $prices = [];
