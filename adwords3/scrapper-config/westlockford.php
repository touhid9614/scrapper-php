...
global $scrapper_configs;
 $scrapper_configs["westlockford"] = array( 
	 'entry_points' => array(
            'new'   => 'https://www.westlockford.com/queryInventory',
            'used'  => 'https://www.westlockford.com/queryInventory'
        ),
        'vdp_url_regex'         => '/\/(?:new|pre-owned|used)\/[^\/]+\/[^\/]+\/[0-9]{4}-[^\.]+.html/',
//        'ajax_url_match'        => '/libs/formProcessor.html',
        ...
        'custom_data_capture'   => function($url, $data){
            ...
            foreach($objects->hits->hits as $obj)
            {
                ...
                $car_data = array(
                    ...
                    'url'               => "https://www.westlockford.com/" . strtolower($obj->filters->condition) .
                    ...
                    'images'            =>  westlockford_image_pipe_filters(
                                                        array_merge($obj->source->feed->images->uploaded, 
                                                        $obj->source->feed->images->managed, 
                                                        $obj->source->feed->images->managed_feed_image) 
                                            )           
    ...
    function filter_westlockford_post_data($post_data, $stock_type)
    {
     ...
     function westlockford_image_pipe_filters($im_urls)
    {
       $retval = array();
