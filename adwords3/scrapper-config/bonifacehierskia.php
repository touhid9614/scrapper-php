...
global $scrapper_configs;
 $scrapper_configs["bonifacehierskia"] = array( 
	'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/bonifacehierskia.csv'
        ),
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('bonifacehierskia');
            
            #Update
            $query = "SELECT * FROM bonifacehierskia_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                $car_data = [
                    ...
                    'price'         => $vehicle['Price'] ? $vehicle['Price'] :$vehicle['MSRP'],
                    'url'           => "https://www.bonifacehierskia.com/auto/*/" . $vehicle['VIN'],
