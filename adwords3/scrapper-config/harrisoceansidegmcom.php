...
$scrapper_configs["harrisoceansidegmcom"] = array( 
		'entry_points' => array(
 ...
 foreach($objects->results[0]->hits as $obj)
        {
            ...
            $regex       =  '/lease<\/h3>\s*<p class="option__price">(?<finance>[^<]+)/';
