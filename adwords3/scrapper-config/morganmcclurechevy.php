...
$scrapper_configs['morganmcclurechevy'] = array(
    'entry_points' => array(
        'new'  => 'http://www.morganmcclurechevy.com/VehicleSearchResults?search=new',
        'used' => 'http://www.morganmcclurechevy.com/VehicleSearchResults?search=preowned',
        'certified' => 'http://www.morganmcclurechevy.com/VehicleSearchResults?search=certified',
    ),
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_morganmcclurechevy_next_page", "filter_morganmcclurechevy_next_page",10,2);
     
     
    function filter_morganmcclurechevy_next_page($next,$current_page) {
