...
$scrapper_configs["samsfreedomfordcom"] = array( 
	'entry_points' => array(
        'new' => 'https://www.samsfreedomford.com/searchnew.aspx',
        'used' => 'https://www.samsfreedomford.com/searchused.aspx'
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/(?:Final Price:|Price)\s*<\/span>[^>]+>(?<price>[^<]+)/',
...
add_filter("filter_samsfreedomfordcom_field_price", "filter_samsfreedomfordcom_field_price", 10, 3);

    function filter_samsfreedomfordcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
...
add_filter("filter_samsfreedomfordcom_field_images", "filter_samsfreedomfordcom_field_images");

function filter_samsfreedomfordcom_field_images($im_urls) {
