<?php
    ...
    $scrapper_configs['welshmotors'] = array(
        'entry_points' => array(
            'new'  => 'http://www.welshmotors.com/new-inventory/index.htm',
            'used' => 'http://www.welshmotors.com/used-inventory/index.htm',
        ),
    ...
    add_filter('filter_welshmotors_field_images', 'filter_welshmotors_field_images');
    add_filter("filter_welshmotors_field_model", "filter_welshmotors_field_model");
    add_filter("filter_welshmotors_field_price", "filter_welshmotors_field_price", 10, 3);
    
    function filter_welshmotors_field_images($im_urls)
    {
     ...
     function filter_welshmotors_field_model($model)
    {
       return  str_replace('\x20', ' ', $model);
    }
    
   function filter_welshmotors_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
