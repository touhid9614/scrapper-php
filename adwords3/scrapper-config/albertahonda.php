<?php
    ...
    $scrapper_configs['albertahonda'] = array(
        'entry_points' => array(
            'new'   => 'http://www.albertahonda.com/new-honda-edmonton-ab',
            'used'  => 'http://www.albertahonda.com/used-cars-edmonton-ab'
        ),
        ...
        'images_regx'       => '/<span class="media-element"><img (?:src|data-lazy)="[^"]+"(?: alt="[^"]+" class="img-responsive" itemprop="image")? data-preview="(?<img_url>[^"]+)"/'
    );