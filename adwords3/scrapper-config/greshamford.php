...
$scrapper_configs["greshamford"] = array(
    'entry_points' => array(
        'new' => 'https://www.greshamford.com/searchnew.aspx',
        'used' => 'https://www.greshamford.com/searchused.aspx',
    ),
 ...
 // add_filter("filter_greshamford_field_images", "filter_greshamford_field_images");
    
 //    function filter_greshamford_field_images($im_urls)
 //    {
 //       if(count($im_urls)<2)
 //            {
 //            return [];
