<?php
    ...
    $scrapper_configs['countryfordlincoln'] = array(
        'entry_points' => array(
            'new'   => 'https://www.countrylincoln.com/new/',
            'used'  => 'https://www.countrylincoln.com/used/',
        ),
        ...
        'data_capture_regx' => array(
            ...
            'price'               => '/Internet Price:<\/span>\s*<span[^>]+><meta[^>]+><span[^>]+>(?<price>\$[0-9,]+)/',
    ...
    add_filter("filter_countryfordlincoln_field_price", "filter_countryfordlincoln_field_price", 10, 3);
    add_filter("filter_countryfordlincoln_field_images", "filter_countryfordlincoln_field_images");
    function filter_countryfordlincoln_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("countryfordlincoln Price: $price");
        }
    ...
    function filter_countryfordlincoln_field_images($im_urls)
    {
