...
$scrapper_configs["nimnichtchevycom"] = array( 
	'entry_points' => array(
            'used'   => 'https://sewjn80htn-2.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.6.0)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.2.2)&x-algolia-api-key=179608f32563367799314290254e3e44&x-algolia-application-id=SEWJN80HTN',
 ...
 foreach($objects->results[0]->hits as $obj)
        {
            ...
            $car_data = array(
                ...
                'trim'              => $obj->trim,
                'body_style'        => $obj->body,
                'price'             => $obj->our_price>0?butifyPrice($obj->our_price):"please call",
