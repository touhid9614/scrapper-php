...
$scrapper_configs["crickshighwaysubarucomau"] = array( 
	"entry_points" => array(
            'used'  => 'https://crickshighwaysubaru.com.au/stock/used',
            'demo'  => 'https://crickshighwaysubaru.com.au/stock/demo',
...
add_filter("filter_crickshighwaysubarucomau_field_price", "filter_crickshighwaysubarucomau_field_price", 10, 3);
add_filter("filter_crickshighwaysubarucomau_field_description", "filter_crickshighwaysubarucomau_field_description");

function filter_crickshighwaysubarucomau_field_description($description) {
    return strip_tags($description);
}

function filter_crickshighwaysubarucomau_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
add_filter("filter_crickshighwaysubarucomau_field_images", "filter_crickshighwaysubarucomau_field_images");
function filter_crickshighwaysubarucomau_field_images($im_urls) {
    if(count($im_urls)<2)
            {
            return [];
...
add_filter('filter_crickshighwaysubarucomau_car_data', 'filter_crickshighwaysubarucomau_car_data');

function filter_crickshighwaysubarucomau_car_data($car_data) {
