<?php
    ...
    $scrapper_configs['jenkinshondaofleesburg'] = array(
        'entry_points' => array(
            'new'  => 'https://www.jenkinshondaofleesburg.com/new-inventory/index.htm',
            'used' => 'https://www.jenkinshondaofleesburg.com/used-inventory/index.htm',
            'certified' => 'https://www.jenkinshondaofleesburg.com/certified-inventory/index.htm'
        ),
    ...
    add_filter("filter_jenkinshondaofleesburg_field_price", "filter_jenkinshondaofleesburg_field_price", 10, 3);
    add_filter("filter_jenkinshondaofleesburg_field_images", "filter_jenkinshondaofleesburg_field_images");
    
    
    function filter_jenkinshondaofleesburg_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $internet_regex   =  '/internetPrice final-price">.*class=\'value[^>]+>(?<price>[^<]+)/';
