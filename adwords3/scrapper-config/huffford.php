<?php
    ...
    $scrapper_configs['huffford'] = array(
        'entry_points' => array(
            'used'  => 'https://www.huffford.com/searchused.aspx',
            'new'   => 'https://www.huffford.com/searchnew.aspx',
    ...
    add_filter("filter_huffford_field_images", "filter_huffford_field_images");
    ...
    function filter_huffford_field_images($im_urls)
    {
        if (count($im_urls) < 2) {
            return array();
        }
