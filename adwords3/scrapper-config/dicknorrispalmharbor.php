...
$scrapper_configs['dicknorrispalmharbor'] = array(
    'entry_points' => array(
        'new'  => 'http://www.dicknorrispalmharbor.com/VehicleSearchResults?search=new',
        'used' => 'http://www.dicknorrispalmharbor.com/VehicleSearchResults?search=preowned',
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_dicknorrispalmharbor_next_page", "filter_dicknorrispalmharbor_next_page",10,2);
     
     
    function filter_dicknorrispalmharbor_next_page($next,$current_page) {
