...
$scrapper_configs["rustywallacechevroletcom"] = array( 
	'entry_points' => array(
...
add_filter("filter_rustywallacechevroletcom_field_images", "filter_rustywallacechevroletcom_field_images",10,2);
function filter_rustywallacechevroletcom_field_images($im_urls, $car_data) {
    $retval = array();
