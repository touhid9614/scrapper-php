...
$scrapper_configs["bmwgalleryca"] = array(
    'entry_points' => array(
            'used'   => 'https://www.bmwgallery.ca/en/used-inventory/api/listing?limit=500', 
            'new'   => 'https://www.bmwgallery.ca/en/new-inventory/api/listing?limit=500',  
        ...
        'srp_page_regex'     => '/\/en\/(?:new|used)-(?:catalog|inventory)/i',
                   ...
                   $to_return = array();
                       ...
                       $car_data = array(
                           ...
                           'url'               => "https://www.bmwgallery.ca/en/" . $stock_type . "-inventory/" . strtolower($obj->make->name) . '/' . strtolower($obj->model->name) . '/' . $obj->year . '-' . strtolower($obj->make->name) . '-' . strtolower($obj->model->name) . '-id' . $obj->vehicleId,
