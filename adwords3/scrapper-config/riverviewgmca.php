...
$scrapper_configs["riverviewgmca"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.riverviewgm.ca/new/',
            'used'  => 'https://www.riverviewgm.ca/used/'
        ),
    ...
    add_filter("filter_riverviewgmca_field_images", "filter_riverviewgmca_field_images");
   
    function filter_riverviewgmca_field_images($im_urls)
    {
        return array_filter($im_urls, function($im_url){
            return !endsWith($im_url, 'no_image-640x480.jpg');
        });
    }
   add_filter("filter_riverviewgmca_field_price", "filter_riverviewgmca_field_price", 10, 3);

    function filter_riverviewgmca_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("riverviewgmca Price: $price");
        }
