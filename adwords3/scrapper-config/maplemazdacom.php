...
$scrapper_configs["maplemazdacom"] = array( 
	'entry_points'        => array(
        'used' => 'https://www.maplemazda.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new'  => 'https://www.maplemazda.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1',
    ),
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->pageInfo->trackingData as $obj) {
            ...
            $car_data = array(
                ...
                'url' 		 => "https://www.maplemazda.com{$obj->link}",
...
add_filter("filter_maplemazdacom_next_page", "filter_maplemazdacom_next_page", 10, 2);
function filter_maplemazdacom_next_page($next, $current_page)
{
