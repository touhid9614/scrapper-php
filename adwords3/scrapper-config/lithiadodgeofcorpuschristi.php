...
global $scrapper_configs;
 ...
 $scrapper_configs["lithiadodgeofcorpuschristi"] = array( 
        'entry_points' => array(
            'new'  => 'https://www.lithiadodgeofcorpuschristi.com/new-inventory/index.htm',
            'used' => 'https://www.lithiadodgeofcorpuschristi.com/used-inventory/index.htm',
        ),
    ...
    add_filter("filter_lithiadodgeofcorpuschristi_field_price", "filter_lithiadodgeofcorpuschristi_field_price", 10, 3);
    function filter_lithiadodgeofcorpuschristi_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        //$wholesale_regex  =  '/"salePrice">.*class=\'value[^>]+>(?<price>[^<]+)/';
