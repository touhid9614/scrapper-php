...
global $scrapper_configs;
 $scrapper_configs["ottobotmotorscom"] = array( 
	 'entry_points' => array(
...
add_filter("filter_ottobotmotorscom_field_images", "filter_ottobotmotorscom_field_images");
    
    function filter_ottobotmotorscom_field_images($im_urls)
    {
       if(count($im_urls)<4)
            {
            return [];
