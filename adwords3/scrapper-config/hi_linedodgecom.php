...
global $scrapper_configs;
 $scrapper_configs["hi_linedodgecom"] = array( 
	'entry_points' => array(
...
add_filter('filter_hi_linedodgecom_post_data', 'filter_hi_linedodgecom_post_data', 10, 2);
add_filter("filter_hi_linedodgecom_field_images", "filter_hi_linedodgecom_field_images");
 function filter_hi_linedodgecom_field_images($im_urls)
    {   
