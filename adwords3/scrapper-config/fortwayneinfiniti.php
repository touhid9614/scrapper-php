...
global $scrapper_configs;
 $scrapper_configs["fortwayneinfiniti"] = array( 
	  'entry_points' => array(
...
add_filter("filter_fortwayneinfiniti_field_images", "filter_fortwayneinfiniti_field_images");
    
    function filter_fortwayneinfiniti_field_images($im_urls)
    {
       if(count($im_urls)<3)
            {
            return [];
