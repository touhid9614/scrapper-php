...
global $scrapper_configs;
 $scrapper_configs["edwardsrv"] = array( 
	'entry_points' => array(
        'new'   => 'https://www.edwardsrv.ca/imglib/Inventory/cache/5748/NVehInv.js?v=3239256',
        'used'  => 'https://www.edwardsrv.ca/imglib/Inventory/cache/5748/UVehInv.js?v=2341398',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory as $obj)
           {
               if($obj->type == 'U')   
               {
                   $url="https://www.edwardsrv.ca/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.edwardsrv.ca/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
