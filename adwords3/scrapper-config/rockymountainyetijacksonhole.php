<?php
    ...
    $scrapper_configs['rockymountainyetijacksonhole'] = array(
        'entry_points' => array(
            'new'   => 'https://www.rockymountainyetijacksonhole.com/new-inventory/index.htm',
            'used'  => 'https://www.rockymountainyetijacksonhole.com/used-inventory/index.htm'
        ),
...
//        'images_regx'       => '/<li>\s*<a href="(?<img_url>(?:https?:)?\/\/pictures.dealer.com\/c\/[^"]+)" class="">/',
    ...
    add_filter("filter_rockymountainyetijacksonhole_field_images", "filter_rockymountainyetijacksonhole_field_images");
    
    function filter_rockymountainyetijacksonhole_field_images($im_urls)
    {
