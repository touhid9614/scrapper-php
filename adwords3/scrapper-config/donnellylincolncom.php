...
$scrapper_configs["donnellylincolncom"] = array( 
	 'entry_points' => array(
             'used'  => 'https://www.donnellylincoln.com/used/',
            'new'   => 'https://www.donnellylincoln.com/new/',
    ...
    add_filter("filter_donnellylincolncom_field_price", "filter_donnellylincolncom_field_price", 10, 3);
    add_filter("filter_donnellylincolncom_field_images", "filter_donnellylincolncom_field_images");
    
    function filter_donnellylincolncom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
            ...
            if($price && numarifyPrice($price) > 0) {
                ...
                slecho("Donnellylinco Price: $price");
            }
    ...
    function filter_donnellylincolncom_field_images($im_urls)
    {
