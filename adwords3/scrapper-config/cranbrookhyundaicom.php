...
$scrapper_configs["cranbrookhyundaicom"] = array(
    "entry_points" => array(
        'new' => 'https://www.cranbrookhyundai.com/inventory/search?stock_type=New&page=1&page_length=500',
        'used' => 'https://www.cranbrookhyundai.com/inventory/search?stock_type=Used&page=1&page_length=500'
    ),
    ...
    'custom_data_capture' => function($url, $resp) {
        ...
        foreach ($inventory as $obj) {
            $car_data = array(
                ...
                'url' => "https://www.cranbrookhyundai.com/inventory/" . strtolower($obj->stock_type) .
    ...
    'images_regx' => '/<a href="(?<img_url>[^"]+)">\s*<img class/'
);
