...
$scrapper_configs['browns_elk'] = array(
    'entry_points' => array(
        'new' => 'https://www.browns-elk.com/new-inventory/index.htm',
        'used' => 'https://www.browns-elk.com/used-inventory/index.htm',
    ),
...
//add_filter("filter_browns_elk_field_price", "filter_browns_elk_field_price", 10, 3);
//add_filter("filter_browns_elk_field_images", "filter_browns_elk_field_images");
//
//function filter_browns_elk_field_price($price, $car_data, $spltd_data) {
//    $prices = [];
//
//    slecho('');
//
...
//}
//
//function filter_browns_elk_field_images($im_urls) {
