...
global $scrapper_configs;
 $scrapper_configs["moosejawtoyota"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.moosejawtoyota.ca/new/',
            'used'  => 'https://www.moosejawtoyota.ca/used/',
        ),
    ...
    add_filter("filter_moosejawtoyota_field_price", "filter_moosejawtoyota_field_price", 10, 3);
    add_filter("filter_moosejawtoyota_field_images", "filter_moosejawtoyota_field_images");
    function filter_moosejawtoyota_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("moosejawtoyota Price: $price");
        }
    ...
    function filter_moosejawtoyota_field_images($im_urls)
    {
