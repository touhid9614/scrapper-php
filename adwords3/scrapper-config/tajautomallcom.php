...
$scrapper_configs["tajautomallcom"] = array(
    "entry_points" => array(
        'used' => 'https://www.tajautomall.com/newandusedcars?pagesize=1000&page=1',
    ),
...
add_filter('filter_tajautomallcom_field_url', 'filter_tajautomallcom_field_url');

function filter_tajautomallcom_field_url($url) {
    return trim($url);
}
