...
$scrapper_configs["hertrichacuracom"] = array( 
	"entry_points" => array(
        'new' => 'https://www.hertrichacura.com/new-inventory/index.htm',
        'used' => 'https://www.hertrichacura.com/used-inventory/index.htm'
    ),
...
add_filter("filter_hertrichacuracom_field_price", "filter_hertrichacuracom_field_price", 10, 3);

function filter_hertrichacuracom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
