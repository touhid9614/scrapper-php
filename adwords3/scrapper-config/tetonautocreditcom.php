...
$scrapper_configs["tetonautocreditcom"] = array( 
	'entry_points' => array(         
            'used' => 'https://www.tetonautocredit.com/searchused.aspx'
        ),
...
add_filter("filter_tetonautocreditcom_field_price", "filter_tetonautocreditcom_field_price", 10, 3);
        function filter_tetonautocreditcom_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
            ...
            if($price && numarifyPrice($price) > 0) {
                ...
                slecho("tetonautocreditcom Price: $price");
            }
