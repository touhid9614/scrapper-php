...
$scrapper_configs["hellosubaruvalenciacom"] = array( 
	'entry_points'        => array(
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            if(!strpos($car_data['description'],"ello Subaru Of Valencia")){
                slecho("the vehicle data is out of hellosubaruvalenciacom"); 
                continue;
            }
