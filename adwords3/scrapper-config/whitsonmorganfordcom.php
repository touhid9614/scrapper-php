...
$scrapper_configs["whitsonmorganfordcom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.whitsonmorganford.com/new-inventory/index.htm',
            'used' => 'https://www.whitsonmorganford.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_whitsonmorganfordcom_field_price", "filter_whitsonmorganfordcom_field_price", 10, 3);
    add_filter("filter_whitsonmorganfordcom_field_images", "filter_whitsonmorganfordcom_field_images");
    
    
    function filter_whitsonmorganfordcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_whitsonmorganfordcom_field_images($im_urls)
    {
