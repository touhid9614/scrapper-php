...
$scrapper_configs["gvielectrickiwi"] = array( 
	"entry_points" => array(
	     'used'  => 'https://www.gvielectric.kiwi/vehicles',
        ),
...
add_filter("filter_gvielectrickiwi_field_images", "filter_gvielectrickiwi_field_images");
function filter_gvielectrickiwi_field_images($im_urls)
{
    $new_im_urls = [];
    $url_base = "https://www.gvielectric.kiwi";
     foreach ($im_urls as $im_url)
    {
        $new_im_url = preg_replace("/https:\/\/www.gvielectric.kiwi\/vehicle\/[^\/]+/", $url_base, $im_url);
