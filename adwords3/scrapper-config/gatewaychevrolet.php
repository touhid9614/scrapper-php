<?php
    ...
    $scrapper_configs['gatewaychevrolet'] = array(
        'entry_points' => array(
            'new'   => 'http://www.gatewaychevrolet.com/VehicleSearchResults?search=new',
            'used'  => 'http://www.gatewaychevrolet.com/VehicleSearchResults?search=preowned'
       ),
    ...
    add_filter("filter_gatewaychevrolet_next_page", "filter_gatewaychevrolet_next_page",10,2);
    
    
    function filter_gatewaychevrolet_next_page($next,$current_page) {
