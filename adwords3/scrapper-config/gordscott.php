<?php
    ...
    $scrapper_configs['gordscott'] = array(
       'entry_points' => array(
        'new'   => 'https://www.reddeernissan.com/inventory/search?stock_type=New&page=1&page_length=500',
        'used'  => 'https://www.reddeernissan.com/inventory/search?stock_type=Used&page=1&page_length=100'
    ),
        ...
        'custom_data_capture' => function($url, $resp){
            ...
            foreach($inventory as $obj)
            {
                $car_data = array(
                    ...
                    'url'               => "https://www.reddeernissan.com/inventory/" . strtolower($obj->stock_type) .
