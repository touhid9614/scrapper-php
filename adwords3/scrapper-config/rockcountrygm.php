...
$scrapper_configs['rockcountrygm'] = array(
    "entry_points" => array(
        ...
        'used' => 'https://10aprxotjr-1.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=003c8cddb5b15f2cfa774c02b7a3b59e&x-algolia-application-id=10APRXOTJR',
    ),
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            $regex       =  '/<meta name="description" content="(?<iption>[^"]+)/';
            $matches = [];
