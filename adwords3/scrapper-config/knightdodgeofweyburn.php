...
$scrapper_configs['knightdodgeofweyburn'] = array(
    'entry_points' => array(
       ...
       $response_data = HttpGet($car_data['url']);
           ...
           if(preg_match_all($images_regex, $temp_data, $matches))
                ...
                if (count($matches['img_url']) <= 3) {
                   ...
                   $car_data['images'] = str_replace(['https://s3.us-east-2.amazonaws.com/dealer-inspire-vps-vehicle-images/21000089/1C6SRFVT0NN196012/daba0873307276779aea60ec6b967e12.jpg'], [''], $car_data['images']);
