...
global $scrapper_configs;
 $scrapper_configs["hullnissangatineauca"] = array( 
	 'entry_points' => array(
            'new'   => 'https://www.hullnissangatineau.ca/wp-json/strathcom/vehicles/search?language=en&stock_type=New&page=1&page_length=1000',
            'used'   => 'https://www.hullnissangatineau.ca/wp-json/strathcom/vehicles/search?language=en&stock_type=Used&page=1&page_length=1000',
        ...
        'custom_data_capture' => function($url, $resp){
            ...
            foreach($inventory as $obj)
            {
                $car_data = array(
                    ...
                    'url'               => "https://www.hullnissangatineau.ca/en/inventory/" . strtolower($obj->stock_type) .
...
add_filter("filter_hullnissangatineauca_field_images", "filter_hullnissangatineauca_field_images");       
function filter_hullnissangatineauca_field_images($im_urls) {
