...
$scrapper_configs['flowermotor'] = array(
    'entry_points' => array(
        'new' => 'https://www.flowermotor.net/new-inventory/index.htm',
        'used' => 'https://www.flowermotor.net/used-inventory/index.htm',
    ),
    ...
    'data_capture_regx' => array(
        ...
        'trim' => '/data-trim="(?<trim>[^"]+)/',
        'price' => '/(?:Flower Motor Price|Conditional Final Price)[^\$]+(?<price>\$[0-9,]+)/',
        'kilometres' => '/Mileage:<\/dt>\s*<dd>(?<kilometres>[^\<]+)/',
        'stock_number' => '/Stock \#\:<\/dt> <dd>(?<stock_number>[^<]+)/',
