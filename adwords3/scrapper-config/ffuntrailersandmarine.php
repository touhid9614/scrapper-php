...
$scrapper_configs['ffuntrailersandmarine'] = array(
    'entry_points' => array(
        'new' => 'https://www.ffuntrailersandmarine.com/imglib/Inventory/cache/1749/NVehInv.js?v=6769850',
        'used' => 'https://www.ffuntrailersandmarine.com/imglib/Inventory/cache/1749/UVehInv.js?v=3242964',
    ),
    ...
    'custom_data_capture' => function($url, $resp) {
        ...
        foreach ($inventory as $obj) {
            if ($obj->type == 'U') {
                $url = "https://www.ffuntrailersandmarine.com/default.asp?page=xPreOwnedInventoryDetail";
            } else {
                $url = "https://www.ffuntrailersandmarine.com/default.asp?page=xNewInventoryDetail";
            }
            $car_data = array(
                ...
                // 'url'               => "http://www.ffuntrailersandmarine.com/default.asp?page=xNewInventoryDetail&id={$obj->id}",
                'url' => $url . '&id=' . $obj->id,
...
add_filter('filter_ffuntrailersandmarine_field_make', 'unicodify');
add_filter('filter_ffuntrailersandmarine_field_model', 'unicodify');

function ffuntrailersandmarine_images_proc($image_url) {
