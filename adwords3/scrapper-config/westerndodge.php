<?php
    ...
    $scrapper_configs['westerndodge'] = array(
        'entry_points' => array(
            'new'    => 'https://www.westerndodge.ca/inventory/new-srp?stock_type=New&page=1&page_length=1000',
            'used'   => 'https://www.westerndodge.ca/inventory/search?page=1&page_length=1000&stock_type=Used&sort_by=make&sort_order=ASC'
        ),
        'vdp_url_regex'     => '/\/inventory\/(?:new|used)\/[0-9]{4}-/i',
        //'ty_url_regex'      => '/\/thank-you\//i',
        'use-proxy' => true,
        'picture_selectors' => ['.slides li'],
        'picture_nexts'     => ['.carousel-next'],
        'picture_prevs'     => ['.carousel-prev'],
        'custom_data_capture' => function($url, $resp){
            ...
            foreach($inventory as $obj)
            {
                $car_data = array(
                    ...
                    'url'               => "https://www.westerndodge.ca/inventory/" . strtolower($obj->stock_type) .
    ...
    add_filter("filter_westerndodge_field_images", "filter_westerndodge_field_images");
    
    function filter_westerndodge_field_images($im_urls)
    {
