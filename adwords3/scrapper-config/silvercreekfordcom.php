...
$scrapper_configs["silvercreekfordcom"] = array( 
	 'entry_points' => array(
            'new'  => 'https://www.silvercreekford.com/searchnew.aspx',
            'used' => 'https://www.silvercreekford.com/searchused.aspx'
        ),
    ...
    'picture_prevs' => ['.mfp-arrow-left'],
        ...
        'data_capture_regx' => array(
            ...
            'price'            => '/Sale Price:\s*<\/span><span[^>]+>\$(?<price>[^<]+)/',
        ),
    ...
    add_filter('filter_silvercreekfordcom_field_price', 'filter_silvercreekfordcom_field_price',10,3);
    
    function filter_silvercreekfordcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $retail_regex =  '/Silver Creek Ford\'s Price:\s*<\/span><span[^>]+>\$(?<price>[^<]+)/';
