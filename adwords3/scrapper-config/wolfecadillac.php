...
$scrapper_configs['wolfecadillac'] = array(
    'entry_points' => array(
        'new'  => 'https://www.wolfecadillac.com/inventory/new/',
        'used' => 'https://www.wolfecadillac.com/inventory/used/'
   ...
   'picture_selectors' => ['.slick-slide'],
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/Wolfe Price<\/div>[^\$]+\$[^>]+>(?<price>[0-9,]+)/',
...
add_filter("filter_wolfecadillac_field_price", "filter_wolfecadillac_field_price", 10, 3);
  

    function filter_wolfecadillac_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
