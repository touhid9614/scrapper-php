<?php
    ...
    $scrapper_configs['mountainviewfordofmarion'] = array(
        'entry_points' => array(
            'new'   => 'http://www.mountainviewfordofmarion.com/new-inventory/index.htm',
            'used'  => 'http://www.mountainviewfordofmarion.com/used-inventory/index.htm',
    ...
    add_filter("filter_mountainviewfordofmarion_field_price", "filter_mountainviewfordofmarion_field_price", 10, 3);
    function filter_mountainviewfordofmarion_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
