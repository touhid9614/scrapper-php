...
$scrapper_configs["fortcollinsjeepcom"] = array( 
   'entry_points' => array(
            'new'  => 'https://www.fortcollinsjeep.com/new-inventory/index.htm',
            'used' => 'https://www.fortcollinsjeep.com/used-inventory/index.htm',
         ),
       ...
       'data_capture_regx' => array(
            ...
            'price' => '/Conditional Final Price[^>]+>[^>]+>[^>]+>[^>]+>(?<price>\$[0-9,]+)/',
    ...
    add_filter("filter_fortcollinsjeepcom_field_price", "filter_fortcollinsjeepcom_field_price", 10, 3);
    add_filter("filter_fortcollinsjeepcom_field_images", "filter_fortcollinsjeepcom_field_images");
    
    
    function filter_fortcollinsjeepcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_fortcollinsjeepcom_field_images($im_urls)
    {
