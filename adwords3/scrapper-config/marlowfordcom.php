...
$scrapper_configs["marlowfordcom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.marlowford.com/new-inventory/index.htm',
        'used' => 'https://www.marlowford.com/used-inventory/index.htm'
    ),
...
add_filter("filter_marlowfordcom_field_price", "filter_marlowfordcom_field_price", 10, 3);

function filter_marlowfordcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $cond_final_regex = '/Conditional Final Price<[^>]+>:<\/span><\/span><[^>]+>(?<price>[^<]+)/';
