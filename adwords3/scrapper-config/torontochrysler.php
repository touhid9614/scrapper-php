...
$scrapper_configs['torontochrysler'] = array(
    'entry_points' => array(
        'new' => 'https://www.torontochrysler.com/new-inventory/index.htm',
        'used' => 'https://www.torontochrysler.com/used-inventory/index.htm',
    ),
    'no_scrap' => true,
...
add_filter("filter_torontochrysler_field_price", "filter_torontochrysler_field_price", 10, 3);

function filter_torontochrysler_field_price($price, $car_data, $spltd_data) {
    $prices = [];
