...
$scrapper_configs["coastchryslernorthvanca"] = array( 
    'entry_points' => array(
...
add_filter('filter_coastchryslernorthvanca_post_data', 'filter_coastchryslernorthvanca_post_data', 10, 2);

function filter_coastchryslernorthvanca_post_data($post_data, $stock_type) {
...
add_filter('filter_coastchryslernorthvanca_car_data', 'filter_coastchryslernorthvanca_car_data');

function filter_coastchryslernorthvanca_car_data($car_data)
{         
    if (trim($car_data['stock_number']) == '') {
        $car_data['stock_number'] = $car_data['vin'];
    }   
    if ($car_data['custom'] == 'https://coastchryslernorthvan.ca/wp-content/uploads/Pricing-Event-Overlay.png') {
...
add_filter('filter_for_fb_coastchryslernorthvanca', 'filter_for_fb_coastchryslernorthvanca', 10, 2);

function filter_for_fb_coastchryslernorthvanca($car_data, $feed_type)
{
