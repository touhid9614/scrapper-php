...
$scrapper_configs["infinitiquebec"] = array(
    'entry_points' => array(
        'new' => 'http://www.infinitiquebec.com/en/new',
        'used' => 'http://www.infinitiquebec.com/en/for-sale/all/used'
    ),
    'use-proxy' => true,
    ...
    'used' => array(
        ...
        'data_capture_regx_full' => array(
            ...
            'interior_color' => '/Interior Color<\/dt>\s*<dd>\s*(?<interior_color>[^<]+)/',
