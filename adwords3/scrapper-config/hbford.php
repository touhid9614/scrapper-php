<?php
    ...
    $scrapper_configs['hbford'] = array(
         'entry_points' => array(
            'new'   => 'https://www.hbford.com/searchnew.aspx',
            'used'  => 'https://www.hbford.com/searchused.aspx'
        ),
        'use-proxy' => true,
     ...
     add_filter("filter_hbford_field_price", "filter_hbford_field_price", 10, 3);
    
    function filter_hbford_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
