...
$scrapper_configs["centennialhonda"] = array(
    'entry_points' => array(
        'new' => 'https://www.centennialhonda.com/en/new-inventory',
        'used' => 'https://www.centennialhonda.com/en/used-inventory',
    ),
    ...
    'images_fallback_regx' => '/class="inventory-list-layout__preview-image">\s*<img\s*src="(?<img_url>[^"]+)/'
);

// function filter_centennialhonda_field_images($im_urls)
// {
//     $md5_of_no_car_images = [
//         'cdf21341e12a698e4e952a68ebdb1651',
//         '4419c41236755c6bd3995aba274c0c0b',
//         '65305e70a498539e0b19e8b6d2e10eca',
//         'a900293ddb2ef93742b7492ef57b98e9',
//         'bd5391cc9f23f41f559c2dffb8a49738'
//     ];
...
// 
add_filter("filter_centennialhonda_field_images", "filter_centennialhonda_field_images");

function filter_centennialhonda_field_images($im_urls) {
    return array_filter($im_urls, function($im_url) {
        return !endsWith($im_url, 'no-photo1594838702363.jpg');
    });
}
