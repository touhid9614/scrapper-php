...
$scrapper_configs['ggruner'] = array(
    'entry_points' => array(
        'new'  => 'http://www.ggruner.com/VehicleSearchResults?search=new',
        'used' => 'http://www.ggruner.com/VehicleSearchResults?search=preowned'
...
//        'stock_type'     => '/<a itemprop="url" .*\/VehicleDetails\/(?<stock_type>[^\-]+)/',
        ...
        'price'          => '/itemprop="price" class="value " data-action="priceSpecification"[^>]+>(?<price>[^<]+)/',
    ...
    add_filter("filter_ggruner_next_page", "filter_ggruner_next_page",10,2);
    
    function filter_ggruner_next_page($next,$current_page) {
