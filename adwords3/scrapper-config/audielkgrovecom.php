...
$scrapper_configs["audielkgrovecom"] = array( 
	'entry_points' => array(
        'new' => 'https://www.audielkgrove.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1',
        'used' => 'https://www.audielkgrove.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
    ),
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                   ...
                   // 'stock_number' => $obj->stockNumber,
                    ...
                    'price' => $obj->msrp < $obj->internetPrice ? $obj->msrp:$obj->internetPrice,
                    'trim' => $obj->trim,
                   ...
                   // 'images'            => array_merge($obj->photos->user, $obj->photos->stock),    
                    'url' => "https://www.audielkgrove.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_audielkgrovecom_next_page", "filter_audielkgrovecom_next_page", 10, 2);       
 function filter_audielkgrovecom_next_page($next, $current_page) {
...
//add_filter("filter_audielkgrovecom_field_images", "filter_audielkgrovecom_field_images");
//    
//    function filter_audielkgrovecom_field_images($im_urls)
//    {
//       if(count($im_urls)<2)
//            {
//            return [];
