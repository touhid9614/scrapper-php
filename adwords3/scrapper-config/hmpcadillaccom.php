...
$scrapper_configs["hmpcadillaccom"] = array(
	 "entry_points" => array(
        'used' => 'https://www.hmpcadillac.com/used/',
        'new' => 'https://www.hmpcadillac.com/new/',
    ),
...
add_filter("filter_hmpcadillaccom_field_price", "filter_hmpcadillaccom_field_price", 10, 3);
add_filter("filter_hmpcadillaccom_field_images", "filter_hmpcadillaccom_field_images");

function filter_hmpcadillaccom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    if ($price && numarifyPrice($price) > 0) {
        ...
        slecho("hmpcadillaccom Price: $price");
    }
...
function filter_hmpcadillaccom_field_images($im_urls) {
