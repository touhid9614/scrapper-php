...
global $scrapper_configs;
 $scrapper_configs["brownsvw"] = array( 
	'entry_points' => array(
            'used' => 'https://www.brownsvw.ca/en/inventory/search?stock_type=Used&page=1&page_length=1000&sort_by=price&sort_order=DESC',
            'new'  => 'https://www.brownsvw.ca/en/inventory/search?stock_type=New&page=1&page_length=1000&sort_by=price&sort_order=DESC',
                ...
                foreach($inventory as $obj)
                {
                    $car_data = array(
                       ...
                       // 'body_style'        => $obj->source->feed->bodyStyle,
                        ...
                        'url'               => "https://www.brownsvw.ca/en/inventory/" . strtolower($obj->stock_type) .
                                           '/' .strtolower($obj->year).'-'. strtolower($obj->make) . '-' . strtolower(str_replace(" ","-",$obj->model))  . '-charlottetown-prince-edward-island/' . strtolower($obj->id),
  ...
  add_filter('filter_brownsvw_car_data', 'filter_brownsvw_car_data');  
    function filter_brownsvw_car_data($car_data)
{

	//remove sold cars
	if ($car_data['stock_number'] == '180704'|$car_data['stock_number'] == '103613'|$car_data['stock_number'] == '042952'|$car_data['stock_number'] == 'AC4130') {
		return null;
	}
	return $car_data;
}