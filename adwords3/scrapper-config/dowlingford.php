<?php
    ...
    $scrapper_configs['dowlingford'] = array(
        'entry_points' => array(
            'new'  => 'http://www.dowlingford.com/new-inventory/index.htm',
            'used' => 'http://www.dowlingford.com/used-inventory/index.htm',
          ),
    ...
    add_filter("filter_dowlingford_field_price", "filter_dowlingford_field_price", 10, 3);
    add_filter("filter_dowlingford_field_images", "filter_dowlingford_field_images");
    
    
    function filter_dowlingford_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_dowlingford_field_images($im_urls)
    {
        $retval = [];
