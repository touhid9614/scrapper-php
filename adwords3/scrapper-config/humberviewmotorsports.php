...
global $scrapper_configs;
 $scrapper_configs["humberviewmotorsports"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.humberviewmotorsports.com/new/',
            'used'  => 'https://www.humberviewmotorsports.com/used/',
        ),
    ...
    add_filter("filter_humberviewmotorsports_field_price", "filter_humberviewmotorsports_field_price", 10, 3);
    add_filter("filter_humberviewmotorsports_field_images", "filter_humberviewmotorsports_field_images");
    function filter_humberviewmotorsports_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("humberviewmotorsports Price: $price");
        }
    ...
    function filter_humberviewmotorsports_field_images($im_urls)
    {
