...
$scrapper_configs['nanaimohonda'] = array(
    'entry_points'        => array(
        'used' => 'https://www.nanaimohonda.com/api/v1/vehicles?category=used&order=price_asc&page=1',
        'new'  => 'https://www.nanaimohonda.com/api/v1/vehicles?category=new&order=in_stock_date_asc&page=1',
    ),
    ...
    'custom_data_capture' => function ($url, $resp) {
        ...
        foreach ($inventory as $obj) {
            $car_data = array(
                ...
                'make'           => $obj->make,
                'model'          => $obj->model,
                'price'          => $obj->price < $obj->pricing->selling_price ? $obj->price : $obj->pricing->selling_price,
