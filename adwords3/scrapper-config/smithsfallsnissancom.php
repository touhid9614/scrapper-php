...
$scrapper_configs["smithsfallsnissancom"] = array( 
	 'entry_points' => array(
        'used' => 'https://www.smithsfallsnissan.com/used/',
        'new' => 'https://www.smithsfallsnissan.com/new/',
    ),
...
add_filter("filter_smithsfallsnissancom_field_images", "filter_smithsfallsnissancom_field_images");
    
    function filter_smithsfallsnissancom_field_images($im_urls)
    {
       if(count($im_urls)<2)
            {
            return [];
