<?php
    ...
    $scrapper_configs['thorntonroadhyundai'] = array(
        'entry_points' => array(
            'new'  => 'http://www.thorntonroadhyundai.com/new-inventory/index.htm',
            'used' => 'http://www.thorntonroadhyundai.com/used-inventory/index.htm',
           // 'certified' => 'http://www.thorntonroadhyundai.com/certified-inventory/index.htm'
        ),
     ...
     add_filter("filter_thorntonroadhyundai_field_price", "filter_thorntonroadhyundai_field_price", 10, 3);
    
    function filter_thorntonroadhyundai_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
