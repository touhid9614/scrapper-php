<?php
    ...
    $scrapper_configs['cottonwoodautosales'] = array(  
       
        'entry_points' => array(
            'all'   => 'https://cottonwoodautosales.com/service/inventory/website',
        ),

        'use-proxy' => true,
        'vdp_url_regex'     => '/\/inventory\/[0-9]*\/view\//i',
        'picture_selectors' => ['.l-box .img'],
            ...
            foreach($objects as $obj)
            {
               // if($obj->salepending) { continue; }
                ...
                $car_data = array(
                    ...
                    'price'             => $obj->specialPrice ? $obj->specialPrice : $obj->price,
                    'engine'            => $obj->engine,
                    'transmission'      => $obj->transmission,
                    'kilometres'        => round($obj->mileage),
                    'url'               => "https://cottonwoodautosales.com/inventory/33937/view/{$obj->stockNo}/Cottonwood-AZ/$slug",
