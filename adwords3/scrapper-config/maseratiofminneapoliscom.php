...
$scrapper_configs["maseratiofminneapoliscom"] = array( 
	 'entry_points' => array(
...
add_filter("filter_maseratiofminneapoliscom_field_images", "filter_maseratiofminneapoliscom_field_images");
    
    function filter_maseratiofminneapoliscom_field_images($im_urls)
    {
       if(count($im_urls)<3)
            {
            return [];
