...
$scrapper_configs['gutweinmotor'] = array(
    'entry_points' => array(
        'new' => 'https://www.gutweinmotor.com/new-inventory/index.htm',
        'used' => 'https://www.gutweinmotor.com/used-inventory/index.htm',
    ),
    'vdp_url_regex' => '/\/(?:new|used|certified)\/[^\/]+\/[0-9]{4}-/i',
    'picture_selectors' => ['.jcarousel .jcarousel-item'],
...
add_filter("filter_gutweinmotor_field_price", "filter_gutweinmotor_field_price", 10, 3);
add_filter("filter_gutweinmotor_field_images", "filter_gutweinmotor_field_images");

function filter_gutweinmotor_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
function filter_gutweinmotor_field_images($im_urls) {
    $retval = [];
