...
$scrapper_configs['hennessyjaguaratlanta'] = array(
    'entry_points' => array(
        'certified' => 'http://www.hennessyjaguaratlanta.com/certified-inventory/index.htm',
    ),
...
add_filter("filter_hennessyjaguaratlanta_field_price", "filter_hennessyjaguaratlanta_field_price", 10, 3);

function filter_hennessyjaguaratlanta_field_price($price, $car_data, $spltd_data) {
    $prices = [];
