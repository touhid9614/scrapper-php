...
$scrapper_configs["lehightonfordcom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.lehightonford.com/searchnew.aspx',
            'used' => 'https://www.lehightonford.com/searchused.aspx'
        ),
...
add_filter("filter_lehightonfordcom_field_price", "filter_lehightonfordcom_field_price", 10, 3);
        function filter_lehightonfordcom_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
            ...
            if($price && numarifyPrice($price) > 0) {
                ...
                slecho("lehightonfordcom Price: $price");
            }
