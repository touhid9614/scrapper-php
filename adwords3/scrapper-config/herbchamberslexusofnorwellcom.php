...
global $scrapper_configs;
 $scrapper_configs["herbchamberslexusofnorwellcom"] = array( 
  'entry_points' => array(
        'new' => 'https://www.herbchamberslexusofhingham.com/new-inventory/index.htm',
        'used' => 'https://www.herbchamberslexusofhingham.com/used-inventory/index.htm',
    ),
...
add_filter("filter_herbchamberslexusofnorwellcom_field_price", "filter_herbchamberslexusofnorwellcom_field_price", 10, 3);

function filter_herbchamberslexusofnorwellcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
