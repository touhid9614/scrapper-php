...
global $scrapper_configs;
 $scrapper_configs["hintondodgeca"] = array(  
      'entry_points' => array(
        'used' => 'https://www.hintondodge.ca/used-inventory/index.htm',
        'new'  => 'https://www.hintondodge.ca/new-inventory/index.htm',
    ),
    ...
    'data_capture_regx_full' => array(
        ...
        'fuel_type' => '/>Fuel Economy[^>]+>[^>]+>[^>]+>[^>]+>[^>]+>[^>]+>(?<fuel_type>[^<]+)/',
...
add_filter("filter_hintondodgeca_field_price", "filter_hintondodgeca_field_price", 10, 3);

function filter_hintondodgeca_field_price($price, $car_data, $spltd_data) {
    $prices = [];
