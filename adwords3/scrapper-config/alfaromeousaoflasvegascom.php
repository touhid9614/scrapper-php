...
$scrapper_configs["alfaromeousaoflasvegascom"] = array( 
	'entry_points' => array(
...
add_filter('filter_alfaromeousaoflasvegascom_post_data', 'filter_alfaromeousaoflasvegascom_post_data', 10, 2);

function filter_alfaromeousaoflasvegascom_post_data($post_data, $stock_type) {
    if ($stock_type == 'new') {
