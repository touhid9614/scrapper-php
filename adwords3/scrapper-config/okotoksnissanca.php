...
$scrapper_configs["okotoksnissanca"] = array( 
	"entry_points" => array(
	     'used' => 'https://www.okotoksnissan.ca/used/',
         'new' => 'https://www.okotoksnissan.ca/new/'
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/Our Price:[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<price>\$[0-9,]+)/',
...
add_filter("filter_okotoksnissanca_field_price", "filter_okotoksnissanca_field_price", 10, 3);

function filter_okotoksnissanca_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $msrp_regex = '/Your Price:[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<price>\$[0-9,]+)/';
    $wholesale_regex = '/MSRP:[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<price>\$[0-9,]+)/';
    $internet_regex = '/Average Market Price:[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<price>\$[0-9,]+)/';
