...
$scrapper_configs["demo_performancehondabountiful_dealerinspire"] = array( 
	  'entry_points'        => array(
        'new'  => 'https://v3zovi2qfz-1.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=ec7553dd56e6d4c8bb447a0240e7aab3&x-algolia-application-id=V3ZOVI2QFZ',
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
           ...
           $temp_data = HttpGet($car_data['url']);
            $images_regex = '/<div class="vehicle-image-bg swiper-lazy" data-background="(?<img_url>[^"]+)/';
            $matches = [];
...
add_filter('filter_demo_performancehondabountiful_dealerinspire_car_data', 'filter_demo_performancehondabountiful_dealerinspire_car_data');
function filter_demo_performancehondabountiful_dealerinspire_car_data($car_data)
{
