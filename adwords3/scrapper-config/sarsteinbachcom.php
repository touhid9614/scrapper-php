...
$scrapper_configs["sarsteinbachcom"] = array( 
	 'entry_points' => array(
        'new'   => 'https://www.sarsteinbach.com/imglib/Inventory/cache/3437/NVehInv.js?v=2761488',
        'used'  => 'https://www.sarsteinbach.com/imglib/Inventory/cache/3437/UVehInv.js?v=3105360',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory as $obj)
           {
               if($obj->type == 'U')   
               {
                   $url="https://www.sarsteinbach.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.sarsteinbach.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
