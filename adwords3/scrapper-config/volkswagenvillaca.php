...
$scrapper_configs["volkswagenvillaca"] = array( 
	'entry_points' => array(
            'used' => 'https://www.volkswagenvilla.ca/wp-json/strathcom/vehicles/search?language=en&stock_type=Used&page=1&page_length=1000&sort_by=price&sort_order=ASC',
            'new'  => 'https://www.volkswagenvilla.ca/wp-json/strathcom/vehicles/search?language=en&stock_type=New&make=Volkswagen&page=1&page_length=1000&sort_by=price&sort_order=ASC'    
        ),
                ...
                foreach($inventory as $obj)
                {
                    $car_data = array(
                       ...
                       // 'body_style'        => $obj->source->feed->bodyStyle,
                        ...
                        'url'               => "https://www.volkswagenvilla.ca/en/inventory/" . strtolower($obj->stock_type) .
                                           '/' .strtolower($obj->year).'-'. strtolower($obj->make) . '-' . strtolower(str_replace(" ","-",$obj->model))  . '-thornhill-ontario/' . strtolower($obj->id),
     ...
     add_filter("filter_volkswagenvillaca_field_images", "filter_volkswagenvillaca_field_images");

    function filter_volkswagenvillaca_field_images($im_urls)
    {
