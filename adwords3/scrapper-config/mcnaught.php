...
$scrapper_configs['mcnaught'] = array(
    'entry_points'        => array(
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            $car_data = array(
                ...
                'trim'           => $obj->trim,
                'body_style'     => $obj->body,
                'price'          => $obj->msrp > $obj->our_price ? $obj->our_price : $obj->msrp,
