...
$scrapper_configs['woodchesterinfiniti'] = array(
    'entry_points' => array(
        'new' => 'https://www.woodchesterinfiniti.ca/new-inventory/index.htm',
        'used' => 'https://www.woodchesterinfiniti.ca/used-inventory/index.htm'
    ),
...
add_filter("filter_woodchesterinfiniti_field_price", "filter_woodchesterinfiniti_field_price", 10, 3);

function filter_woodchesterinfiniti_field_price($price, $car_data, $spltd_data) {
    $prices = [];
