...
$scrapper_configs['titanauto'] = array(
   "entry_points" => array(
...
add_filter('filter_titanauto_car_data', 'filter_titanauto_car_data');
function filter_titanauto_car_data($car_data) {
    //https://app.guidecx.com/app/projects/d11ba293-ffa8-4c8c-855d-b6e49b01efb8/notes
    if($car_data['stock_number']=='GP10062P'|| $car_data['stock_number']=='CU-TRANS'||$car_data['stock_number']=='GP10942A'||$car_data['stock_number']=='GP11136' || $car_data['stock_number']=='GP12930'||$car_data['stock_number']=='GP11111'||$car_data['stock_number']=='CUBenz'||$car_data['stock_number']=="CUBENZ")
    {
        slecho("We are filtering this car");
        $car_data = [];
    }
