...
$scrapper_configs["lakelandfordpacom"] = array( 
	'entry_points'           => array(
        'used' => 'https://www.lakelandfordpa.com/used/',
        'new'  => 'https://www.lakelandfordpa.com/new/'
    ),
...
add_filter("filter_lakelandfordpacom_field_images", "filter_lakelandfordpacom_field_images");
function filter_lakelandfordpacom_field_images($im_urls)
{
