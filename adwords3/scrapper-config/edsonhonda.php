...
global $scrapper_configs;
 $scrapper_configs["edsonhonda"] = array( 
	'entry_points' => array(
        'new'   => 'https://www.edsonhonda.com/imglib/Inventory/cache/6667/NVehInv.js?v=1058332',
        'used'  => 'https://www.edsonhonda.com/imglib/Inventory/cache/6667/UVehInv.js?v=6988889',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory as $obj)
           {
               if($obj->type == 'U')   
               {
                   $url="https://www.edsonhonda.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.edsonhonda.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
