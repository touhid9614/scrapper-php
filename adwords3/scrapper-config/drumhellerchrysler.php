...
global $scrapper_configs;
 $scrapper_configs["drumhellerchrysler"] = array( 
	 "entry_points" => array( 
             'new'  => 'https://www.drumhellerchrysler.com/new-inventory/index.htm',
            'used' => 'https://www.drumhellerchrysler.com/used-inventory/index.htm',
    ...
    add_filter("filter_drumhellerchrysler_field_price", "filter_drumhellerchrysler_field_price", 10, 3);

    
    
    function filter_drumhellerchrysler_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
...
//     add_filter("filter_drumhellerchrysler_field_images", "filter_drumhellerchrysler_field_images");
//    function filter_drumhellerchrysler_field_images($im_urls) {
//
//  $retvals = [];
//
...
//        return !(startsWith($retval, 'https://images.dealer') || startsWith($retval, 'https://pictures.dealer.com/cc') || endsWith($retval,'PXJ.jpg'));
//    });
//}