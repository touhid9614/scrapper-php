<?php
    ...
    $scrapper_configs['acuracentre'] = array(
        'entry_points' => array(
            'new'   => 'https://www.acuracentre.com/new/',
            'used'  => 'https://www.acuracentre.com/used'
        ),
    ...
    add_filter("filter_acuracentre_field_images", "filter_acuracentre_field_images");
    
    function filter_acuracentre_field_images($im_urls)
    {
