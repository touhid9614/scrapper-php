<?php
    ...
    $scrapper_configs['tomahlbuickgmc'] = array(
        'entry_points' => array(
             'used' => 'https://www.tomahlbuickgmc.com/used-inventory/index.htm',
             'new' => 'https://www.tomahlbuickgmc.com/new-inventory/index.htm',
...
add_filter("filter_tomahlbuickgmc_field_images", "filter_tomahlbuickgmc_field_images");
function filter_tomahlbuickgmc_field_images($im_urls) {
...
add_filter("filter_tomahlbuickgmc_field_price", "filter_tomahlbuickgmc_field_price", 10, 3);

function filter_tomahlbuickgmc_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
