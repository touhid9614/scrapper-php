...
$scrapper_configs["liavwcom"] = array( 
	   'entry_points' => array(
            'used'  => 'https://www.liavw.com/searchused.aspx?Dealership=Lia%20Volkswagen',
            'new'   => 'https://www.liavw.com/searchnew.aspx?Dealership=Lia%20Volkswagen',
     ...
     add_filter("filter_liavwcom_field_price", "filter_liavwcom_field_price", 10, 3);
    
    function filter_liavwcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
