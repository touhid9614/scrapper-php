<?php
    ...
    $scrapper_configs['achrysler'] = array(
        'entry_points' => array(
            'new'   => 'https://albernichrysler.com/?page_id=4776',
            'used'  => 'https://albernichrysler.com/?page_id=179'
        ),
   ...
   add_filter('filter_achrysler_post_data', 'filter_achrysler_post_data');
    
    function filter_achrysler_post_data($post_data) {
