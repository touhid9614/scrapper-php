...
$scrapper_configs['foundationdodgedraytonvalley'] = array(
    'entry_points' => array(
        'new' => 'https://www.foundationdodgedraytonvalley.com/new-inventory/index.htm',
        'used' => 'https://www.foundationdodgedraytonvalley.com/used-inventory/index.htm'
    ),
...
add_filter("filter_foundationdodgedraytonvalley_field_price", "filter_foundationdodgedraytonvalley_field_price", 10, 3);

function filter_foundationdodgedraytonvalley_field_price($price, $car_data, $spltd_data) {
    $prices = [];
