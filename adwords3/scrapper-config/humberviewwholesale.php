...
global $scrapper_configs;
 $scrapper_configs["humberviewwholesale"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.humberviewwholesale.com/new/',
            'used'  => 'https://www.humberviewwholesale.com/used/',
        ),
    ...
    add_filter("filter_humberviewwholesale_field_price", "filter_humberviewwholesale_field_price", 10, 3);
    add_filter("filter_humberviewwholesale_field_images", "filter_humberviewwholesale_field_images");
    function filter_humberviewwholesale_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("humberviewwholesale Price: $price");
        }
    ...
    function filter_humberviewwholesale_field_images($im_urls)
    {
