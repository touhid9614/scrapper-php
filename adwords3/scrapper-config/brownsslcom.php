...
$scrapper_configs['brownsslcom'] = array(
     'entry_points' => array(
        'used' => 'https://www.brownssl.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new' => 'https://www.brownssl.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
 ...
 add_filter("filter_brownsslcom_next_page", "filter_brownsslcom_next_page", 10, 2);       
 function filter_brownsslcom_next_page($next, $current_page) {
