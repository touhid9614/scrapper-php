...
global $scrapper_configs;
 $scrapper_configs["southtrailhyundai"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.southtrailhyundai.com/content/templates/southhyundai/themes/southhyundai/inventory-ax-loader.php',
            'used'  => 'https://www.southtrailhyundai.com/content/templates/southhyundai/themes/southhyundai/inventory-ax-loader.php'
        ),
        'use-proxy' => true,
    ...
    add_filter('filter_southtrailhyundai_post_data', 'filter_southtrailhyundai_post_data',10, 3);
    add_filter('filter_southtrailhyundai_data', 'filter_southtrailhyundai_data');
    
    function filter_southtrailhyundai_post_data($post_data, $stock_type, $data)
    {
        if($post_data == '') {
            $post_data = 'offset=0';
        }
        ...
        return "filters%5B%5D=&filters%5B%5D=$stock_type&filters%5B%5D=&filters%5B%5D=&filters%5B%5D=&filters%5B%5D=0&filters%5B%5D=0&filters%5B%5D=$offset&filters%5B%5D=0&filters%5B%5D=&certified=false&sub=&trim=";
    }

    function filter_southtrailhyundai_data($data)
    {
        if($data)
        {
            if(isJSON($data)){
