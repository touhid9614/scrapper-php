...
$scrapper_configs["goteamkiacom"] = array( 
	"entry_points" => array(  
         'used' => 'https://www.goteamkia.com/used-inventory/index.htm',
        'new' => 'https://www.goteamkia.com/new-inventory/index.htm',
...
add_filter("filter_goteamkiacom_field_price", "filter_goteamkiacom_field_price", 10, 3);
add_filter("filter_goteamkiacom_field_images", "filter_goteamkiacom_field_images");
  

function filter_goteamkiacom_field_images($im_urls) {
   $retval = [];
...
function filter_goteamkiacom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
