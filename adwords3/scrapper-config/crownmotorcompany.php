<?php
    ...
    $scrapper_configs['crownmotorcompany'] = array(
        'entry_points' => array(
            'new'  => 'https://www.crownmotorcompany.com/searchnew.aspx',
            'used' => 'https://www.crownmotorcompany.com/searchused.aspx'
        ),
    ...
    add_filter('filter_crownmotorcompany_field_price', 'filter_crownmotorcompany_field_price',10,3);
    
    function filter_crownmotorcompany_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
