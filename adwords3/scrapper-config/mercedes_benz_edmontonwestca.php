...
global $scrapper_configs;
 $scrapper_configs["mercedes_benz_edmontonwestca"] = array( 
	'entry_points' => array(
    ...
    'init_method' => 'POST',
    'next_method' => 'POST',
    'picture_selectors' => ['.owl-item img'],
...
add_filter('filter_mercedes_benz_edmontonwestca_post_data', 'filter_mercedes_benz_edmontonwestca_post_data', 10, 2);

function filter_mercedes_benz_edmontonwestca_post_data($post_data, $stock_type) {
    if ($stock_type == 'new') {
        $post_data = '{"requests":[{"indexName":"mercedesbenzedmontonwestltd_production_inventory_high_to_low","params":"query=&hitsPerPage=1000&maxValuesPerFacet=250&page=0&facets=%5B%22features%22%2C%22our_price%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.finance_monthly_payment%22%2C%22type%22%2C%22api_id%22%2C%22year%22%2C%22make%22%2C%22model%22%2C%22model_number%22%2C%22trim%22%2C%22body%22%2C%22doors%22%2C%22miles%22%2C%22ext_color_generic%22%2C%22features%22%2C%22lightning.isSpecial%22%2C%22lightning.locations%22%2C%22fueltype%22%2C%22engine_description%22%2C%22transmission_description%22%2C%22metal_flags%22%2C%22city_mpg%22%2C%22hw_mpg%22%2C%22lightning.locations.meta_location%22%5D&tagFilters=&facetFilters=%5B%5B%22type%3ANew%22%5D%5D"},{"indexName":"mercedesbenzedmontonwestltd_production_inventory_high_to_low","params":"query=&hitsPerPage=1&maxValuesPerFacet=250&page=0&attributesToRetrieve=%5B%5D&attributesToHighlight=%5B%5D&attributesToSnippet=%5B%5D&tagFilters=&analytics=false&clickAnalytics=false&facets=type"}]}';
    } elseif ($stock_type == 'used') {
        $post_data = '{"requests":[{"indexName":"mercedesbenzedmontonwestltd_production_inventory_specials_oem_price","params":"query=&hitsPerPage=1000&maxValuesPerFacet=250&page=0&facets=%5B%22features%22%2C%22our_price%22%2C%22lightning.lease_monthly_payment%22%2C%22lightning.finance_monthly_payment%22%2C%22type%22%2C%22api_id%22%2C%22year%22%2C%22make%22%2C%22model%22%2C%22model_number%22%2C%22trim%22%2C%22body%22%2C%22doors%22%2C%22miles%22%2C%22ext_color_generic%22%2C%22features%22%2C%22lightning.isSpecial%22%2C%22lightning.locations%22%2C%22fueltype%22%2C%22engine_description%22%2C%22transmission_description%22%2C%22metal_flags%22%2C%22city_mpg%22%2C%22hw_mpg%22%2C%22lightning.locations.meta_location%22%5D&tagFilters=&facetFilters=%5B%5B%22type%3APre-Owned%22%2C%22type%3ACertified%20Pre-Owned%22%5D%5D"},{"indexName":"mercedesbenzedmontonwestltd_production_inventory_specials_oem_price","params":"query=&hitsPerPage=1&maxValuesPerFacet=250&page=0&attributesToRetrieve=%5B%5D&attributesToHighlight=%5B%5D&attributesToSnippet=%5B%5D&tagFilters=&analytics=false&clickAnalytics=false&facets=type"}]}';
    }

    return $post_data;
}

add_filter("filter_mercedes_benz_edmontonwestca_field_images", "filter_mercedes_benz_edmontonwestca_field_images");
 function filter_mercedes_benz_edmontonwestca_field_images($im_urls)
    {         if(count($im_urls)<3)
            {
            return [];
