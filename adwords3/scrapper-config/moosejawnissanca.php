...
$scrapper_configs["moosejawnissanca"] = array( 
	'entry_points'        => array(
        'used' => 'https://yl5afxm3dw-3.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=59d32b7b5842f84284e044c7ca465498&x-algolia-application-id=YL5AFXM3DW',
        'new'  => 'https://yl5afxm3dw-1.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=59d32b7b5842f84284e044c7ca465498&x-algolia-application-id=YL5AFXM3DW',
    ),
    'vdp_url_regex'       => '/inventory\/(?:new|used|certified-used)-[0-9]{4}-/i',
    'srp_page_regex'      => '/\/(?:new|used|certified|pre-owned)-vehicles\//i',
    'use-proxy'           => true,
    'refine'              => false,
    'init_method'         => 'POST',
    'next_method'         => 'POST',
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            $car_data = array(
                ...
                'stock_type'     => ($obj->type == 'New') ? 'new' : 'used',
                'year'           => $obj->year,
                'make'           => $obj->make,
                'model'          => $obj->model,
                'trim'           => $obj->trim,
            ...
            $images_regex = '/img class=\'swiper\-lazy\'\s*data\-src=\'(?<img_url>[^\']+)/';
            $matches = [];
