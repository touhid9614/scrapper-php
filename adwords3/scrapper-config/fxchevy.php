...
$scrapper_configs['fxchevy'] = array(
    'entry_points' => array(
        'new'  => 'http://www.fxchevy.com/VehicleSearchResults?search=new',
        'used' => 'http://www.fxchevy.com/VehicleSearchResults?search=used'
    ...
    add_filter("filter_fxchevy_next_page", "filter_fxchevy_next_page",10,2);
    
    function filter_fxchevy_next_page($next,$current_page) {
