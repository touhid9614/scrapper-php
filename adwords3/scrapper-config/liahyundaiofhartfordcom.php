...
$scrapper_configs["liahyundaiofhartfordcom"] = array(
    "entry_points" => array(
        'new' => 'https://www.liahyundaiofhartford.com/searchnew.aspx?Dealership=Lia%20Hyundai%20of%20Hartford',
        'used' => 'https://www.liahyundaiofhartford.com/searchused.aspx?Dealership=Lia%20Hyundai%20of%20Hartford',
    ),
    'use-proxy' => true,
...
add_filter("filter_liahyundaiofhartfordcom_field_price", "filter_liahyundaiofhartfordcom_field_price", 10, 3);

function filter_liahyundaiofhartfordcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
