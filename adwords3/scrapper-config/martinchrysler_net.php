...
$scrapper_configs["martinchrysler_net"] = array(
    'entry_points'        => array(
    ...
    'srp_page_regex'      => '/\/(?:new|used)-vehicles/',
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            $to_return[] = martinchrysler_net_update($car_data);
        }
