<?php
    ...
    $scrapper_configs['jaguargwinnett'] = array(
        'entry_points' => array(
          //  'new'   => 'https://www.jaguargwinnett.com/new-inventory/index.htm',
           // 'used'  => 'https://www.jaguargwinnett.com/used-inventory/index.htm',
         //   Name: Touhid Date:28/06/2018Requirement: Only certified vehicles have to scrape
            
       
            'certified'   => 'https://www.jaguargwinnett.com/certified-inventory/index.htm',
        ),
    ...
    add_filter("filter_jaguargwinnett_field_price", "filter_jaguargwinnett_field_price", 10, 3);
      
    function filter_jaguargwinnett_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
  ...
  /*   add_filter('filter_jaguargwinnett_car_data', 'filter_jaguargwinnett_car_data');
    
    function filter_jaguargwinnett_car_data($car_data) 
    {
        //taking all cars except Corvette
        if(stripos($car_data['model'], 'Corvette') !== false) 
        {
