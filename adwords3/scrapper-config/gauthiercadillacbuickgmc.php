<?php
    ...
    $scrapper_configs['gauthiercadillacbuickgmc'] = array(
        'entry_points' => array(
             'certified' => 'https://www.gauthiercadillacbuickgmc.com/used-inventory/index.htm?compositeType=certified',
             'new' => 'https://www.gauthiercadillacbuickgmc.com/new-inventory/index.htm',
             'used' => 'https://www.gauthiercadillacbuickgmc.com/used-inventory/index.htm',
    ),
    ...
    add_filter("filter_gauthiercadillacbuickgmc_field_images", "filter_gauthiercadillacbuickgmc_field_images");
    
    function filter_gauthiercadillacbuickgmc_field_images($im_urls)
    {
       if(count($im_urls)<3)
            {
            return [];
