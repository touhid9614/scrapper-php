...
$scrapper_configs['streetsvillehyundai'] = array(
    'entry_points' => array(
        'new' => 'https://www.streetsvillehyundai.com/new/',
        'used' => 'https://www.streetsvillehyundai.com/used/group/'
    ),
...
add_filter("filter_streetsvillehyundai_field_images", "filter_streetsvillehyundai_field_images");

function filter_streetsvillehyundai_field_images($im_urls) {
