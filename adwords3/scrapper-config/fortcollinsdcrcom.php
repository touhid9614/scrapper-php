...
$scrapper_configs["fortcollinsdcrcom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.fortcollinsdcr.com/new-inventory/index.htm',
        'used' => 'https://www.fortcollinsdcr.com/used-inventory/index.htm'
    ),
    'vdp_url_regex' => '/\/(?:new|certified|used|wholesale-used)\/[^\/]+\/[0-9]{4}-/i',
    'use-proxy' => true,
