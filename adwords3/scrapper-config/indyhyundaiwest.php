...
global $scrapper_configs;
 $scrapper_configs["indyhyundaiwest"] = array( 
      'entry_points' => array(
...
add_filter('filter_indyhyundaiwest_post_data', 'filter_indyhyundaiwest_post_data', 10, 2);
 add_filter("filter_indyhyundaiwest_field_images", "filter_indyhyundaiwest_field_images");
 function filter_indyhyundaiwest_field_images($im_urls)
    {
