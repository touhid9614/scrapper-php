...
$scrapper_configs["woodwheaton"] = array(
    'entry_points' => array(
        'used' => 'https://www.woodwheaton.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new' => 'https://www.woodwheaton.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                   ...
                   // 'images'            => array_merge($obj->photos->user, $obj->photos->stock),    
                    'url' => "https://www.woodwheaton.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_woodwheaton_next_page", "filter_woodwheaton_next_page", 10, 2);       
 function filter_woodwheaton_next_page($next, $current_page) {
...
add_filter("filter_woodwheaton_field_images", "filter_woodwheaton_field_images");
    
    function filter_woodwheaton_field_images($im_urls)
    {
       if(count($im_urls)<4)
            {
            return [];
        ...
        return array_filter($im_urls, function($im_url) {
            ...
            return !endsWith($im_url, '6f0f7cbec39f59679940e02bfd74be3dx.jpg');
