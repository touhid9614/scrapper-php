<?php
    ...
    $scrapper_configs['murraygm'] = array(
       'entry_points' => array(
        'new' => 'https://www.murraygm.com/inventory/New/',
        'used' => 'https://www.murraygm.com/inventory/Used/'
    ),
    'use-proxy' => true,
     'refine' => false,
...
add_filter("filter_murraygm_field_price", "filter_murraygm_field_price", 10, 3);

function filter_murraygm_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
add_filter("filter_murraygm_field_images", "filter_murraygm_field_images",10,2);

     function filter_murraygm_field_images($im_urls,$car_data)
    {
          
    if(isset($car_data['url']) && $car_data['url'])
    {   
      
       $api_url="https://www.murraygm.com/api/ajax_requests/?currentQuery=".$car_data['url'];
