...
$scrapper_configs['advantagefordfremont'] = array(
    'entry_points' => array(
        'new' => 'https://www.advantagefordfremont.com/new-inventory/index.htm',
        'used' => 'https://www.advantagefordfremont.com/used-inventory/index.htm',
    ),
...
add_filter("filter_advantagefordfremont_field_price", "filter_advantagefordfremont_field_price", 10, 3);
add_filter("filter_advantagefordfremont_field_images", "filter_advantagefordfremont_field_images");

function filter_advantagefordfremont_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
function filter_advantagefordfremont_field_images($im_urls) {
    $retval = [];
