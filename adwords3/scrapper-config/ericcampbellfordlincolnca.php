...
$scrapper_configs["ericcampbellfordlincolnca"] = array( 
	"entry_points" => array(
            'new'   => 'https://www.ericcampbellfordlincoln.ca/queryInventory',
            'used'  => 'https://www.ericcampbellfordlincoln.ca/queryInventory'
        ),
        ...
        'custom_data_capture'   => function($url, $data){
            ...
            foreach($objects->hits->hits as $obj)
            {
                ...
                $car_data = array(
                    ...
                    'price'             => $obj->price->finalMinPrice,
                   // 'weekly'            => $weekly,
                  //  'biweekly'          => $weekly * 2,
                    'engine'            => $obj->filters->engine,
                    'transmission'      => $obj->source->feed->transmissionType,
                    'kilometres'        => $obj->mileage,
                    'url'               => "https://www.ericcampbellfordlincoln.ca/" . strtolower($obj->filters->condition) .
