...
$scrapper_configs["toyotaofancasterca"] = array(
    "entry_points" => array(
        'used' => 'https://www.toyotaofancaster.ca/used/',
        'new' => 'https://www.toyotaofancaster.ca/new/'
    ),
...
add_filter("filter_toyotaofancasterca_field_price", "filter_toyotaofancasterca_field_price", 10, 3);

function filter_toyotaofancasterca_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $old_regex = '/Suggested Price:[^>]+>[^>]+>[^>]+>(?<price>[^\<]+)/';
