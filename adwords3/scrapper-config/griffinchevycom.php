...
$scrapper_configs["griffinchevycom"] = array( 
	'entry_points' => array(     
             'new'  => 'https://www.griffinchevy.com/searchnew.aspx',
            'used' => 'https://www.griffinchevy.com/searchused.aspx',
...
add_filter("filter_griffinchevycom_field_price", "filter_griffinchevycom_field_price", 10, 3);
        function filter_griffinchevycom_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
