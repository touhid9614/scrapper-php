...
global $scrapper_configs;
 $scrapper_configs["infinitiofmelbourne"] = array( 
	  'entry_points' => array(
        'new' => 'https://www.infinitiofmelbourne.com/searchnew.aspx',
        'used' => 'https://www.infinitiofmelbourne.com/searchused.aspx',
    ),
 ...
 add_filter("filter_infinitiofmelbourne_field_price", "filter_infinitiofmelbourne_field_price", 10, 3);

    function filter_infinitiofmelbourne_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("infinitiofmelbourne Price: $price");
        }
