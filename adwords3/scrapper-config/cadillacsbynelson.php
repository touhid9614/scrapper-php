...
$scrapper_configs['cadillacsbynelson'] = array(
    'entry_points' => array(
        'new' => 'http://www.cadillacsbynelson.com/VehicleSearchResults?search=new',
        'used' => 'http://www.cadillacsbynelson.com/VehicleSearchResults?search=preowned',
    //  'certified' => 'http://www.cadillacsbynelson.com/VehicleSearchResults?search=certified',
    ),
...
add_filter("filter_cadillacsbynelson_next_page", "filter_cadillacsbynelson_next_page", 10, 2);

function filter_cadillacsbynelson_next_page($next, $current_page) {
