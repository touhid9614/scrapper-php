...
$scrapper_configs["genesisoflagunaniguelcom"] = array( 
	 'entry_points' => array(
        'new' => 'https://2591j46p8g-3.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=78311e75e16dd6273d6b00cd6c21db3c&x-algolia-application-id=2591J46P8G',
        'used' => 'https://2591j46p8g-3.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=78311e75e16dd6273d6b00cd6c21db3c&x-algolia-application-id=2591J46P8G'
        ),
    ...
    'custom_data_capture' => function($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            $images_regex = '/swiper-lazy\'\s*data-src=\'(?<img_url>[^\']+)\'/';
            $matches = [];
...
add_filter('filter_for_fb_genesisoflagunaniguelcom', 'filter_for_fb_genesisoflagunaniguelcom', 10, 2);
function filter_for_fb_genesisoflagunaniguelcom($car_data, $feed_type)
{
