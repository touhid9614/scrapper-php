...
global $scrapper_configs;
 $scrapper_configs["express_toyotaofirving"] = array( 
	  'entry_points' => array(
             'new'  => 'https://express.toyotaofirving.com/api/dealer_new_inventory?f=submodel%3A&sort=lowest%20price&large_inventory=1&request_vehicles=1',
             'used'   => 'https://express.toyotaofirving.com/api/dealer_used_inventory?f=submodel%3A&sort=lowest%20price&large_inventory=1&request_vehicles=1',
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory as $obj)
           {
               ...
               $url="https://express.toyotaofirving.com/express/";
    ...
    add_filter("filter_express_toyotaofirving_field_images", "filter_express_toyotaofirving_field_images");
       
    function filter_express_toyotaofirving_field_images($im_urls)
    {
