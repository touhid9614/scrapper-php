<?php
    ...
    $scrapper_configs['mmchrysler'] = array(
        'entry_points' => array(
            'new'  => 'http://www.mmchrysler.com/new-inventory/index.htm',
            'used' => 'http://www.mmchrysler.com/used-inventory/index.htm',   
        ),
    ...
    add_filter("filter_mmchrysler_field_price", "filter_mmchrysler_field_price", 10, 3);
    add_filter("filter_mmchrysler_field_images", "filter_mmchrysler_field_images");
    
   
    function filter_mmchrysler_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
     ...
     function filter_mmchrysler_field_images($im_urls)
    {
