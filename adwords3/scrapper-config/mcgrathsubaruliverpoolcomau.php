...
$scrapper_configs["mcgrathsubaruliverpoolcomau"] = array( 
	"entry_points" => array(
        'all'  => 'https://www.mcgrathsubaruliverpool.com.au/all-stock/list/?q=perpage%3A30',
	    'used'  => 'https://www.mcgrathsubaruliverpool.com.au/used-subaru-liverpool/?q=perpage%3A30',
	    'new'   => 'https://www.mcgrathsubaruliverpool.com.au/new-subaru-range-liverpool/subaru/?q=perpage%3A30',
        'demo'  => 'https://www.mcgrathsubaruliverpool.com.au/subaru-demos-liverpool/?q=perpage%3A30',
        
    ),
    'use-proxy' => true,
    "refine"                 => false,
    'vdp_url_regex'          => '/\/(?:new|used|certified-used|demo|all-stock).*\/view\/[0-9]{4}-/i',
...
add_filter('filter_mcgrathsubaruliverpoolcomau_car_data', 'filter_mcgrathsubaruliverpoolcomau_car_data');

function filter_mcgrathsubaruliverpoolcomau_car_data($car_data) {
