...
$scrapper_configs["millenniumchevroletcom"] = array( 
	'entry_points' => array(
...
add_filter("filter_millenniumchevroletcom_field_images", "filter_millenniumchevroletcom_field_images",10,2);
function filter_millenniumchevroletcom_field_images($im_urls, $car_data) {
    $retval = array();
