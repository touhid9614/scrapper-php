...
global $scrapper_configs;
 $scrapper_configs["audiburlingtoncom"] = array( 
	  'entry_points' => array(
        'new' => 'https://www.audiburlington.com/new-inventory/index.htm',
        'used' => 'https://www.audiburlington.com/used-inventory/index.htm',
    ),
...
add_filter("filter_audiburlingtoncom_field_price", "filter_audiburlingtoncom_field_price", 10, 3);

function filter_audiburlingtoncom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
