...
$scrapper_configs["discoveryofaltavistacom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.discoveryofaltavista.com/searchnew.aspx',
        'used' => 'https://www.discoveryofaltavista.com/searchused.aspx',
    ),
...
add_filter("filter_discoveryofaltavistacom_field_price", "filter_discoveryofaltavistacom_field_price", 10, 3);

function filter_discoveryofaltavistacom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $msrp_regex = '/DISCOVERY EASY PRICE:[^>]+>[^>]+>(?<price>\$[0-9,]+)/';
