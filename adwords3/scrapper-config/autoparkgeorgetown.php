<?php
    ...
    $scrapper_configs['autoparkgeorgetown'] = array(
        'entry_points' => array(
            'used'  => 'https://www.autoparkgeorgetown.ca/used'
        ),
    ...
    add_filter("filter_autoparkgeorgetown_field_images", "filter_autoparkgeorgetown_field_images");
    add_filter("filter_autoparkgeorgetown_field_stock_number", "filter_autoparkgeorgetown_field_stock_number");
    
    function filter_autoparkgeorgetown_field_images($im_urls)
    {
        return array_filter($im_urls, function($im_url){
            return !endsWith($im_url, 'no_image-640x480.jpg');
        });
    }
    function filter_autoparkgeorgetown_field_stock_number($stock_number)
    {
