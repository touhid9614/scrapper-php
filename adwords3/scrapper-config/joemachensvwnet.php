...
$scrapper_configs["joemachensvwnet"] = array( 
	'entry_points' => array(
...
add_filter("filter_joemachensvwnet_field_images", "filter_joemachensvwnet_field_images",10,2);
function filter_joemachensvwnet_field_images($im_urls, $car_data) {
    $retval = array();
