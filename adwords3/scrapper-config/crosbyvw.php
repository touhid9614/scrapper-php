<?php
    ...
    $scrapper_configs['crosbyvw'] = array(
        'entry_points' => array(
            'new'   => 'http://www.crosbyvw.com/new/',
            'used'  => 'http://www.crosbyvw.com/used/'
        ),
    ...
    add_filter("filter_crosbyvw_field_images", "filter_crosbyvw_field_images");
    
    function filter_crosbyvw_field_images($im_urls)
    {
