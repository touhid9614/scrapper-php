...
$scrapper_configs["denwoodmotorscom"] = array( 
 'entry_points' => array(
        'new'  => 'https://www.denwoodmotors.com/VehicleSearchResults?search=new',
        'used' => 'https://www.denwoodmotors.com/VehicleSearchResults?search=preowned',
    ...
    'vdp_url_regex' => '/\/VehicleDetails\/(?:new|used|certified)-[0-9]{4}-\S+/',
     ...
     add_filter("filter_denwoodmotorscom_next_page", "filter_denwoodmotorscom_next_page",10,2);
     
     
    function filter_denwoodmotorscom_next_page($next,$current_page) {
...
add_filter("filter_denwoodmotorscom_field_price", "filter_denwoodmotorscom_field_price", 10, 3);
function filter_denwoodmotorscom_field_price($price, $car_data, $spltd_data) {
