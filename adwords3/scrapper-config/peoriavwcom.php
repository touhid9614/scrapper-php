...
$scrapper_configs["peoriavwcom"] = array(
    'entry_points'        => array(
        'new'  => 'https://express.peoriavw.com/api/dealer_new_inventory?f=submodel%3A&sort=lowest%20price&large_inventory=1&request_vehicles=1',
        'used' => 'https://express.peoriavw.com/api/dealer_used_inventory?f=submodel%3A&sort=lowest%20price&large_inventory=1&request_vehicles=1'
    ),
    ...
    'custom_data_capture' => function ($url, $resp) {
        ...
        foreach ($inventory as $obj) {
            $url = "https://express.peoriavw.com/express/";
            $car_data = [
...
add_filter("filter_peoriavwcom_field_images", "filter_peoriavwcom_field_images");

function filter_peoriavwcom_field_images($im_urls)
{
