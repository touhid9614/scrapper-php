...
$scrapper_configs["tristatenissancom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.tristatenissan.com/new-inventory/index.htm',
        'used' => 'https://www.tristatenissan.com/used-inventory/index.htm'
    ),
