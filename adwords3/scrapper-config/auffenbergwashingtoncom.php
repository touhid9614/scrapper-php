...
$scrapper_configs["auffenbergwashingtoncom"] = array( 
	 'entry_points' => array(
        'new' => 'https://www.auffenbergwashington.com/searchnew.aspx',
        'used' => 'https://www.auffenbergwashington.com/searchused.aspx',
    ),
...
add_filter("filter_auffenbergwashingtoncom_field_images", "filter_auffenbergwashingtoncom_field_images");
add_filter('filter_auffenbergwashingtoncom_field_price', 'filter_auffenbergwashingtoncom_field_price', 10, 3);

function filter_auffenbergwashingtoncom_field_images($im_urls) {
...
function filter_auffenbergwashingtoncom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
