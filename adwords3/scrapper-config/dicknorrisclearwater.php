...
$scrapper_configs['dicknorrisclearwater'] = array(
    'entry_points' => array(
        'new'  => 'http://www.dicknorrisclearwater.com/VehicleSearchResults?search=new',
        'used' => 'http://www.dicknorrisclearwater.com/VehicleSearchResults?search=preowned',
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_dicknorrisclearwater_next_page", "filter_dicknorrisclearwater_next_page",10,2);
     
     
    function filter_dicknorrisclearwater_next_page($next,$current_page) {
