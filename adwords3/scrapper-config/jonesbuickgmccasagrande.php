...
global $scrapper_configs;
 $scrapper_configs["jonesbuickgmccasagrande"] = array( 
    'entry_points' => array(
...
function filter_jonesbuickgmccasagrande_post_data($post_data, $stock_type) {
 ...
 add_filter("filter_jonesbuickgmccasagrande_field_images", "filter_jonesbuickgmccasagrande_field_images");
 function filter_jonesbuickgmccasagrande_field_images($im_urls)
    {
