...
$scrapper_configs["edwardsnissancom"] = array( 
	 'entry_points'        => array(
...
function filter_edwardsnissancom_field_images($im_urls, $car_data)
{
