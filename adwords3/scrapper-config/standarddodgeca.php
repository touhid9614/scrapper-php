...
$scrapper_configs["standarddodgeca"] = array( 
	   'entry_points' => array(
 ...
 foreach($objects->results[0]->hits as $obj)
        {
           ...
           $response_data = HttpGet($car_data['url']);
            ...
            if (preg_match($regex, $response_data, $matches)) {
                ...
                $car_data['custom'] = $matches['description'];
...
add_filter("filter_standarddodgeca_field_images", "filter_standarddodgeca_field_images",10,2);
function filter_standarddodgeca_field_images($im_urls, $car_data) {
