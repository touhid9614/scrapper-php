<?php
    ...
    $scrapper_configs['landroverbuckhead'] = array(
        'entry_points' => array(
            'certified'   => 'http://www.landroverbuckhead.net/certified-inventory/index.htm',
        ),
 ...
 add_filter("filter_landroverbuckhead_field_price", "filter_landroverbuckhead_field_price", 10, 3);
    function filter_landroverbuckhead_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
