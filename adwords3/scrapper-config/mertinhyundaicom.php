...
$scrapper_configs["mertinhyundaicom"] = array( 
	"entry_points" => array(
        'new' => 'https://www.mertinhyundai.com/new/',
        'used' => 'https://www.mertinhyundai.com/used/'
    ),
...
add_filter("filter_mertinhyundaicom_field_price", "filter_mertinhyundaicom_field_price", 10, 3);

function filter_mertinhyundaicom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
add_filter("filter_mertinhyundaicom_field_images", "filter_mertinhyundaicom_field_images");

function filter_mertinhyundaicom_field_images($im_urls) {
