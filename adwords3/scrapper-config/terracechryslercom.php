...
$scrapper_configs["terracechryslercom"] = array( 
	'entry_points'        => array(
        ...
        'new'  => 'https://v2mzlxx99f-1.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=f7b5e3f281e3dbaf7bb03d10029e9291&x-algolia-application-id=V2MZLXX99F',
    ),
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            $images_regex = '/<div class="swiper-slide">\s*<img data-src="(?<img_url>[^"]+)" alt/';
            $matches = [];
...
add_filter('filter_for_fb_terracechryslercom', 'filter_for_fb_terracechryslercom', 10, 2);

function filter_for_fb_terracechryslercom($car_data, $feed_type) {
