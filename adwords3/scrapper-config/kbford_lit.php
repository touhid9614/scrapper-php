<?php
    ...
    $scrapper_configs['kbford_lit'] = array(
        'entry_points' => array(
            'new'  => 'http://www.kbford.com/new-inventory/index.htm?accountId=kellerbrosfordfd',
            'used' => 'http://www.kbford.com/used-inventory/index.htm?accountId=kellerbrosfordfd',
            'certified'=> 'http://www.kbford.com/certified-inventory/index.htm?accountId=kellerbrosfordfd'
//            'certified'=> 'http://www.kbford.com/certified-inventory/index.htm?accountId=kellerbrosfordfd'
        ),
    ...
    add_filter("filter_kbford_lit_field_price", "filter_kbford_lit_field_price", 10, 3);
    
    function filter_kbford_lit_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
