...
$scrapper_configs["winnipegkiacom"] = array( 
	'entry_points' => array(
            'used'   => 'https://www.winnipegkia.com/wp-json/strathcom/vehicles/search?language=en&stock_type=USED&page=1&page_length=100',
            'new'    => 'https://www.winnipegkia.com/wp-json/strathcom/vehicles/search?language=en&stock_type=NEW&page=1&page_length=100',
        ),
            ...
            foreach($inventory as $obj)
            {
                $car_data = array(
                   ...
                   // 'body_style'        => $obj->source->feed->bodyStyle,
                    ...
                    'url'               => "https://www.winnipegkia.com/inventory/" . strtolower($obj->stock_type) .
