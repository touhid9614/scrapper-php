...
global $scrapper_configs;
 $scrapper_configs["jacksonchryslerdodgejeep"] = array( 
	 'entry_points' => array(
...
function filter_jacksonchryslerdodgejeep_post_data($post_data, $stock_type)
{
  ...
  add_filter("filter_jacksonchryslerdodgejeep_field_images", "filter_jacksonchryslerdodgejeep_field_images");
function filter_jacksonchryslerdodgejeep_field_images($im_urls) {
  if(count($im_urls)<2)
            {
            return [];
      ...
      return array_filter($im_urls, function($im_url) {
        return !endsWith($im_url, 'processing.jpg');
    });
    }