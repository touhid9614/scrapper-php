...
$scrapper_configs['boblowthford'] = array(
    'entry_points' => array(
        'new' => 'https://www.boblowthford.com/new-inventory/index.htm',
        'used' => 'https://www.boblowthford.com/used-inventory/index.htm'
    ),
...
add_filter("filter_boblowthford_field_price", "filter_boblowthford_field_price", 10, 3);

function filter_boblowthford_field_price($price, $car_data, $spltd_data) {
    $prices = [];
