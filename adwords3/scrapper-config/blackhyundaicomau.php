...
$scrapper_configs["blackhyundaicomau"] = array(
    "entry_points"           => array(
        'new'  => 'https://www.blackhyundai.com.au/new-hyundai-in-stock-warwick/list?q=perpage%3A30',
        'demo' => 'https://www.blackhyundai.com.au/demo-hyundai-warwick/list?q=({make:Hyundai}),condition:demo',
        // 'used' => 'https://www.blackhyundai.com.au/used-hyundai-in-stock-warwick/list?q=perpage%3A30', //no sued vehicles in website
    ),
    // 'use-proxy'              => true,
    "refine"                 => false,
    ...
    'data_capture_regx_full' => array(
        'price'          => '/itemOriginalPrice:\s*"(?<price>[^"]+)/',
...
add_filter('filter_blackhyundaicomau_car_data', 'filter_blackhyundaicomau_car_data');

function filter_blackhyundaicomau_car_data($car_data)
{
