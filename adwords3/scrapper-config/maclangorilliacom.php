...
$scrapper_configs["maclangorilliacom"] = array( 
	"entry_points" => array(
	           'used' => 'https://www.maclangorillia.com/used/',
               'new' => 'https://www.maclangorillia.com/new/',
    ),
   ...
   // 'refine' => false,
    ...
    'details_end_tag' => '<footer class="opt-6 wp"',
