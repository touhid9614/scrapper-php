...
$scrapper_configs["kooltoyotacom"] = array( 
	 "entry_points" => array(
        'new' => 'https://www.kooltoyota.com/new-toyota-grand-rapids-mi',
        'used' => 'https://www.kooltoyota.com/used-vehicles-grand-rapids-mi'
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/Kool Price\s*[^>]+>\s*[^>]+>\s*(?<price>\$[0-9,]+)/',
    ),
...
add_filter("filter_kooltoyotacom_field_price", "filter_kooltoyotacom_field_price", 10, 3);

function filter_kooltoyotacom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $internet = '/Our Price\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<price>\$[0-9,]+)/';
