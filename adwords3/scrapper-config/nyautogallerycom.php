...
$scrapper_configs["nyautogallerycom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.nyautogallery.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        // 'new' => 'https://www.nyautogallery.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
        ...
        'custom_data_capture' => function($url, $data) {
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                  ...
                  //  'url' => "https://www.nyautogallery.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
                     'url'           => "https://www.nyautogallery.com/{$obj->link}",
 ...
 add_filter("filter_nyautogallerycom_next_page", "filter_nyautogallerycom_next_page", 10, 2);       
 function filter_nyautogallerycom_next_page($next, $current_page) {
...
add_filter("filter_nyautogallerycom_field_images", "filter_nyautogallerycom_field_images");
    
    function filter_nyautogallerycom_field_images($im_urls)
    {
       if(count($im_urls)<2)
            {
            return [];
