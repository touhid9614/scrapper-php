...
$scrapper_configs['millsbuickgmc'] = array(
    'entry_points'        => array(
...
add_filter('filter_millsbuickgmc_post_data', 'filter_millsbuickgmc_post_data', 10, 2);
add_filter("filter_millsbuickgmc_field_images", "filter_millsbuickgmc_field_images");

function filter_millsbuickgmc_field_images($im_urls)
{
    if (count($im_urls) <= 3) {
        return [];
    }
