...
$scrapper_configs["mcgavocknissanlubbockcom"] = array( 
	'entry_points' => array(
        'new' => 'https://www.mcgavocknissanlubbock.com/new-nissan-lubbock-tx',
        'used' => 'https://www.mcgavocknissanlubbock.com/used-vehicles-lubbock-tx',
    ),
...
add_filter("filter_mcgavocknissanlubbockcom_field_price", "filter_mcgavocknissanlubbockcom_field_price", 10, 3);

function filter_mcgavocknissanlubbockcom_field_price($price, $car_data, $spltd_data) {
       $prices = [];
 ...
 add_filter("filter_mcgavocknissanlubbockcom_field_images", "filter_mcgavocknissanlubbockcom_field_images");
    
    function filter_mcgavocknissanlubbockcom_field_images($im_urls)
    {
       $retval = array();
