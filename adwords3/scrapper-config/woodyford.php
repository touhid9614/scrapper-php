<?php
    ...
    $scrapper_configs['woodyford'] = array(
        'entry_points' => array(
            'new'   => 'http://www.woodyford.com/new-inventory/index.htm',
            'used'  => 'http://www.woodyford.com/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_woodyford_field_images", "filter_woodyford_field_images");
    
    function filter_woodyford_field_images($im_urls)
    {
       $retval = array();
