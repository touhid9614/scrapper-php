...
global $scrapper_configs;
 $scrapper_configs["infinitiofwillowdale"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.infinitiofwillowdale.com/new/',
            'used'  => 'https://www.infinitiofwillowdale.com/used/',
        ),
    ...
    add_filter("filter_infinitiofwillowdale_field_price", "filter_infinitiofwillowdale_field_price", 10, 3);
 
    function filter_infinitiofwillowdale_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("infinitiofwillowdale Price: $price");
        }
