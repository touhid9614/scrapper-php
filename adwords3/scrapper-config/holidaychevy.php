...
$scrapper_configs['holidaychevy'] = array(
   'entry_points'        => array(
        'used' => 'https://www.holidaychevy.net/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new'  => 'https://www.holidaychevy.net/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1',
        'certified' => 'https://www.holidaychevy.net/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_CERTIFIED_USED:inventory-data-bus1/getInventory?srpSessionId=702186f9-d008-435f-9752-29f183e81742&srpRequestId=17c76f46-d067-4ee6-8025-b7412fdf07dd&start=0&page=1',
    ),
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->pageInfo->trackingData as $obj) {
            ...
            $car_data = array(
                ...
                'url' 		 => "https://www.holidaychevy.net{$obj->link}",
...
add_filter("filter_holidaychevy_next_page", "filter_holidaychevy_next_page", 10, 2);
function filter_holidaychevy_next_page($next, $current_page)
{
