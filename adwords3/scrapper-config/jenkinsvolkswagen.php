<?php
    ...
    $scrapper_configs['jenkinsvolkswagen'] = array(
        'entry_points' => array(
            'new'  => 'http://www.jenkinsvolkswagen.com/new-inventory/index.htm',
            'used' => 'http://www.jenkinsvolkswagen.com/used-inventory/index.htm',
           // 'certified' => 'http://www.jenkinsvolkswagen.com/certified-inventory/index.htm'
        ),
    ...
    add_filter("filter_jenkinsvolkswagen_field_price", "filter_jenkinsvolkswagen_field_price", 10, 3);
    function filter_jenkinsvolkswagen_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
