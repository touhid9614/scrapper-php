...
global $scrapper_configs;
 $scrapper_configs["juliojoneskia"] = array( 
	  'entry_points' => array(
...
add_filter('filter_juliojoneskia_car_data', 'filter_juliojoneskia_car_data');

function filter_juliojoneskia_car_data($car_data) {
...
// add_filter("filter_juliojoneskia_field_images", "filter_juliojoneskia_field_images");
// function filter_juliojoneskia_field_images($im_urls)
//    {
//       if(count($im_urls)<3)
//            {
//            return [];
