...
global $scrapper_configs;
 $scrapper_configs["dinosauto"] = array( 
	  'entry_points' => array(
          //  'new'  => 'https://www.citybuick.com/new/',
            'used'  => 'https://www.dinosauto.ca/used/'
        ),
    ...
    add_filter("filter_dinosauto_field_images", "filter_dinosauto_field_images");
    add_filter("filter_dinosauto_field_stock_number", "filter_dinosauto_field_stock_number");
    
    function filter_dinosauto_field_images($im_urls)
    {
        return array_filter($im_urls, function($im_url){
            return !endsWith($im_url, 'no_image-640x480.jpg');
        });
    }
    function filter_dinosauto_field_stock_number($stock_number)
    {
