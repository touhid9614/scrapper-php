<?php
    ...
    $scrapper_configs['lexusmontereypeninsula'] = array(
        'entry_points' => array(
            'new'   => 'http://www.lexusmontereypeninsula.com/VehicleSearchResults?search=new',
            'used'  => 'http://www.lexusmontereypeninsula.com/VehicleSearchResults?search=preowned',
            'certified'=> 'http://www.lexusmontereypeninsula.com/VehicleSearchResults?search=certified'
       ),
    ...
    add_filter("filter_lexusmontereypeninsula_next_page", "filter_lexusmontereypeninsula_next_page",10,2);
    
    function filter_lexusmontereypeninsula_next_page($next,$current_page) {
