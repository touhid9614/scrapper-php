...
$scrapper_configs["marineunitedcom"] = array( 
	  'entry_points' => array(
        'new'   => 'https://www.marineunited.com/imglib/Inventory/cache/4861/NVehInv.js?v=5479917',
        'used'  => 'https://www.marineunited.com/imglib/Inventory/cache/4861/UVehInv.js?v=3274137',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           {    
               ...
               if($obj->type == 'U')   
               {
                   $url="https://www.marineunited.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.marineunited.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
