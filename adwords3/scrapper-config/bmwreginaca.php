...
$scrapper_configs["bmwreginaca"] = array( 
	 'entry_points'        => array(
        'used' => 'https://www.bmwregina.ca/en/used-inventory/api/listing?limit=500',
        'new'  => 'https://www.bmwregina.ca/en/new-inventory/api/listing?limit=500',
    ),
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->vehicles as $obj) {
            ...
            $car_data   = array(
                ...
                'url'          => strtolower("https://www.bmwregina.ca/en/" . $stock_type . "-inventory/" . $obj->make->name . '/' . $obj->model->name . '/' . $obj->year . '-' . $obj->make->name . '-' . $obj->model->name . '-id' . $obj->vehicleId),
