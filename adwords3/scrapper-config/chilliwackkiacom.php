...
$scrapper_configs["chilliwackkiacom"] = array( 
	"entry_points" => array(
        'new' => 'https://www.chilliwackkia.com/new/',
        'used' => 'https://www.chilliwackkia.com/used/'
    ),
...
add_filter("filter_chilliwackkiacom_field_price", "filter_chilliwackkiacom_field_price", 10, 3);

function filter_chilliwackkiacom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
