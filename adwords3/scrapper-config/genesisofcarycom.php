...
$scrapper_configs["genesisofcarycom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.genesisofcary.com/used-inventory/index.htm',
        'new' => 'https://www.genesisofcary.com/new-inventory/index.htm',
       ...
       'vdp_url_regex'     => '/\/(?:new|used|certified)\/[^\/]+\/[0-9]{4}-/i',
        ...
        'data_capture_regx' => array(
            ...
            'trim'          => '/data-trim="(?<trim>[^"]+)/',
            'price'         => '/(?:Sale Price|Price)[^>]+>:<\/span><\/span>[^>]+>(?<price>\$[0-9,]+)/',
    ...
    add_filter("filter_genesisofcarycom_field_price", "filter_genesisofcarycom_field_price", 10, 3);
    add_filter("filter_genesisofcarycom_field_images", "filter_genesisofcarycom_field_images");
    function filter_genesisofcarycom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_genesisofcarycom_field_images($im_urls)
    {
           $retval = [];
