<?php
    ...
    $scrapper_configs['overturfmotors'] = array(
        'entry_points' => array(
            'new'   => 'http://www.overturfmotors.com/new-inventory/index.htm',
            'used'  => 'http://www.overturfmotors.com/used-inventory/index.htm'
        ),
...
add_filter("filter_overturfmotors_field_price", "filter_overturfmotors_field_price", 10, 3);
    function filter_overturfmotors_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
