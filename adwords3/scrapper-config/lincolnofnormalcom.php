...
$scrapper_configs["lincolnofnormalcom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.lincolnofnormal.com/new-inventory/index.htm',
        'used' => 'https://www.lincolnofnormal.com/used-inventory/index.htm'
    ),
