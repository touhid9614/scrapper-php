...
$scrapper_configs['fmssaskatoon'] = array(
    'entry_points' => array(
        'new'   => 'https://www.fmssaskatoon.com/imglib/Inventory/cache/1747/NVehInv.js?v=6175764',
        'used'  => 'https://www.fmssaskatoon.com/imglib/Inventory/cache/1747/UVehInv.js?v=8305189',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory as $obj)
           {
               if($obj->type == 'U')   
               {
                   $url="https://www.fmssaskatoon.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.fmssaskatoon.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
    ...
    add_filter('filter_fmssaskatoon_field_make', 'unicodify');
    add_filter('filter_fmssaskatoon_field_model', 'unicodify');

    function fmssaskatoon_images_proc($image_url)
    {
