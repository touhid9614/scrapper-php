<?php
    ...
    $scrapper_configs['lakeshoretoyota'] = array(
        'entry_points' => array(
            'new'   => 'https://www.lakeshoretoyota.com/toyota-burns-harbor-in.htm',
            'used'  => 'http://www.lakeshoretoyota.com/used-inventory/index.htm'
        ),
        ...
        'data_capture_regx' => array(
            ...
            'kilometres'    => '/<dd>(?<kilometres>[^\s]+)\smiles/',
    ...
    add_filter("filter_lakeshoretoyota_field_price", "filter_lakeshoretoyota_field_price", 10, 3);
    function filter_lakeshoretoyota_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
