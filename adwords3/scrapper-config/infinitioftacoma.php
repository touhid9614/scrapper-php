...
$scrapper_configs['infinitioftacoma'] = array(
    'entry_points' => array(
        'new'  => 'http://www.infinitioftacoma.com/VehicleSearchResults?search=new',
        'used' => 'http://www.infinitioftacoma.com/VehicleSearchResults?search=preowned',
       // 'certified' => 'http://www.infinitioftacoma.com/VehicleSearchResults?search=certified'
    ),
    ...
    add_filter("filter_infinitioftacoma_next_page", "filter_infinitioftacoma_next_page",10,2);
    
    function filter_infinitioftacoma_next_page($next,$current_page) {
