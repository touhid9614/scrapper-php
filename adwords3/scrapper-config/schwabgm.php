...
$scrapper_configs['schwabgm'] = array(
    'entry_points' => array(
        'new'  => 'http://www.schwabgm.ca/VehicleSearchResults?search=new',
        'used' => 'http://www.schwabgm.ca/VehicleSearchResults?search=used',
     //   'certified' => 'http://www.schwabgm.com/VehicleSearchResults?search=certified',
    ),
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_schwabgm_next_page", "filter_schwabgm_next_page",10,2);
     
     
    function filter_schwabgm_next_page($next,$current_page) {
