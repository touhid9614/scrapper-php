...
global $scrapper_configs;
 $scrapper_configs["robgreenbuickgmc"] = array( 
	'entry_points' => array(
        'new'  => 'http://www.robgreenbuickgmc.com/VehicleSearchResults?search=new',
        'used' => 'http://www.robgreenbuickgmc.com/VehicleSearchResults?search=used',
    ...
    'vdp_url_regex' => '/\/VehicleDetails\/(?:new|used|certified)-[0-9]{4}-\S+/',
     ...
     add_filter("filter_robgreenbuickgmc_next_page", "filter_robgreenbuickgmc_next_page",10,2);
     
     
    function filter_robgreenbuickgmc_next_page($next,$current_page) {
