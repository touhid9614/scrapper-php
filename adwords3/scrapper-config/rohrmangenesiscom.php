...
$scrapper_configs["rohrmangenesiscom"] = array(
    'entry_points' => array(
        'new'  => 'https://www.genesisoflafayette.net/new-inventory/index.htm',
       ),
      ...
      "custom_data_capture" => function ($url, $data) {
          $site                 = "https://www.genesisoflafayette.net/sitemap.xml";
          $vdp_url_regex        = '/\/(?:new|used)\/[^\/]+\/[0-9]{4}-/i';
...
add_filter("filter_rohrmangenesiscom_field_images", "filter_rohrmangenesiscom_field_images");
    
    function filter_rohrmangenesiscom_field_images($im_urls)
    {
       if(count($im_urls)<2)
            {
            return [];
