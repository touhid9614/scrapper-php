...
$scrapper_configs["overdrive_usacom"] = array( 
	 'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/cumberlandover.csv'
        ),
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('overdrive_usacom');
            
            #Update
            $query = "SELECT * FROM overdrive_usacom_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
