...
$scrapper_configs['mcmedicinehat'] = array(
    'entry_points' => array(
        'new' => 'https://www.mcmedicinehat.ca/VehicleSearchResults?search=new',
        'used' => 'https://www.mcmedicinehat.ca/VehicleSearchResults?search=preowned',
    ),
...
add_filter("filter_mcmedicinehat_next_page", "filter_mcmedicinehat_next_page", 10, 2);

function filter_mcmedicinehat_next_page($next, $current_page) {
