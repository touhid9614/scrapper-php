...
global $scrapper_configs;
 $scrapper_configs["bonifacehiersmazda"] = array( 
	 'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/bonifacehiersmazda.csv'
        ),
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('bonifacehiersmazda');
            
            #Update
            $query = "SELECT * FROM bonifacehiersmazda_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                $car_data = [
                    ...
                    'url'           => "https://www.bonifacehiersmazda.com/auto/*/" . $vehicle['VIN'],
