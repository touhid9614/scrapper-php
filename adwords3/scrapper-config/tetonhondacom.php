...
$scrapper_configs["tetonhondacom"] = array( 
	 'entry_points' => array(
        'new' => 'https://www.tetonhonda.com/searchnew.aspx',
        'used' => 'https://www.tetonhonda.com/searchused.aspx',
    ),
    ...
    'data_capture_regx' => array(
        ...
        'kilometres' => '/class="label-visible-xs">Mileage:\s*[^>]+>(?<kilometres>[^<]+)/',
        'price' => '/MSRP:\s*<\/span><span[^>]+>(?<price>\$[0-9,]+)/',
...
add_filter("filter_tetonhondacom_field_price", "filter_tetonhondacom_field_price", 10, 3);

function filter_tetonhondacom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
add_filter("filter_tetonhondacom_field_images", "filter_tetonhondacom_field_images");
    
    function filter_tetonhondacom_field_images($im_urls)
    {
        if(count($im_urls)<2)
            {
            return [];
