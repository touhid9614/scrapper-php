...
$scrapper_configs["wvmazdacom"] = array( 
	'entry_points' => array(
...
add_filter("filter_wvmazdacom_field_images", "filter_wvmazdacom_field_images",10,2);
function filter_wvmazdacom_field_images($im_urls, $car_data) {
    $retval = array();
