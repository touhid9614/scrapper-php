...
$scrapper_configs["davesmithfordonline"] = array(
    'entry_points' => array(
        'used'  => 'https://www.davesmithfordonline.com/used-inventory/index.htm',
       ),
      ...
      "custom_data_capture" => function ($url, $data) {
          $site                 = "https://www.davesmithfordonline.com/sitemap.xml";
          $vdp_url_regex        = '/\/(?:new|used)\/[^\/]+\/[0-9]{4}-/i';
