...
$scrapper_configs['sheboyganauto'] = array(
     'entry_points' => array(
         'used' => 'https://www.sheboyganauto.com/searchused.aspx',
            'new'  => 'https://www.sheboyganauto.com/searchnew.aspx',
            
        ),
        # When you copy, make sure it works
        # vdp_url_regex was copied from bournivaljeep without testing it
        'vdp_url_regex'     => '/\/(?:new|used)-Sheboygan-[0-9]{4}-/i',
        'use-proxy' => true,
    ...
    add_filter('filter_sheboyganauto_field_price', 'filter_sheboyganauto_field_price',10,3);
    
    function filter_sheboyganauto_field_price($price,$car_data,$spltd_data)
    {
        $prices = [];
        ...
        $price_regex       =  '/Internet Price <\/span><span[^>]+>(?<price>\$[0-9,]+)/';
