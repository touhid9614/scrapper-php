...
$scrapper_configs["progressiveautosales"] = array(
    'entry_points' => array(
        'used' => 'https://www.progressiveautosales.com/used/',
    ),
     'vdp_url_regex'     => '/\/(?:new|used)\/vehicle\/[0-9]{4}-/i',
        ...
        'data_capture_regx' => array(
           ...
           // 'trim'                => '/"trim":"(?<trim>[^"]+)"/',
            ...
            // 'city'               => '/class="table-col">City:[^>]+>[^>]+>(?<city>[^<]+)/',
...
add_filter("filter_progressiveautosales_field_price", "filter_progressiveautosales_field_price", 10, 3);

function filter_progressiveautosales_field_price($price, $car_data, $spltd_data) {
    $prices = [];
