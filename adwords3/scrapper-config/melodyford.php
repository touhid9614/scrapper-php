...
global $scrapper_configs;
 $scrapper_configs["melodyford"] = array( 
	'entry_points' => array(
            'used'  => 'http://www.melodyford.ca/queryInventory',
            'new'   => 'http://www.melodyford.ca/queryInventory',
        ...
        'custom_data_capture'   => function($url, $data){
            ...
            foreach($objects->hits->hits as $obj)
            {
                ...
                $car_data = array(
                    ...
                    'url'               => "http://melodyford.ca/" . strtolower($obj->filters->condition) .
