...
$scrapper_configs["mercedes_benz_kamloopsca"] = array( 
	 "entry_points" => array(
        'used' => 'https://www.mercedes-benz-kamloops.ca/en/used-inventory?limit=500',
        'new' => 'https://www.mercedes-benz-kamloops.ca/en/new-inventory?limit=500',
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/inventoryListingPreviewPrice_fontColor">\s*(?<price>[^<]+)/',
    ...
    'images_regx' => '/<span class="overlay">\s*<img\s*(?:class=""|)\s*src="(?<img_url>[^"]+)"/',
