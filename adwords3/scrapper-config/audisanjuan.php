<?php
    ...
    $scrapper_configs['audisanjuan'] = array(
        'entry_points' => array(
            'new'  => 'http://www.audisanjuan.com/new-inventory/index.htm',
            'used' => 'http://www.audisanjuan.com/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_audisanjuan_field_price", "filter_audisanjuan_field_price", 10, 3);
    add_filter("filter_audisanjuan_field_images", "filter_audisanjuan_field_images");
    function filter_audisanjuan_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_audisanjuan_field_images($im_urls)
    {
