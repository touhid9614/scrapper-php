...
$scrapper_configs["atlanticchevroletcom"] = array( 
	'entry_points' => array(
...
add_filter("filter_atlanticchevroletcom_field_images", "filter_atlanticchevroletcom_field_images",10,2);
function filter_atlanticchevroletcom_field_images($im_urls, $car_data) {
    $retval = array();
