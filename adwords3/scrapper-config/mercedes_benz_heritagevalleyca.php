...
$scrapper_configs["mercedes_benz_heritagevalleyca"] = array( 
	'entry_points' => array(
 ...
 foreach($objects->results[0]->hits as $obj)
        {
            ...
            $car_data = array(
                ...
                'stock_type'        => $obj->type=='Pre-Owned'?'used':  strtolower($obj->type),
                'year'              => $obj->year,
                'make'              => $obj->make,
                'model'             => $obj->model,
                'trim'              => $obj->trim,
