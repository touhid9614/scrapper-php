...
$scrapper_configs['wheatonhonda'] = array(
    "entry_points" => array(
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            {
                // if(strpos($car_data['url'],"inventory/used") || strpos($car_data['url'],"inventory/certified-used")){
                //     unset($matches['img_url'][0]);
                // }
                
                $car_data['images']  = $matches['img_url'];
                
                if(count($car_data['images'])>4){
