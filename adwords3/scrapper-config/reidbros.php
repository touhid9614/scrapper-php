...
$scrapper_configs['reidbros'] = array(
    'entry_points' => array(
        'new'  => 'http://www.reidbros.ca/VehicleSearchResults?search=new',
        'used' => 'http://www.reidbros.ca/VehicleSearchResults?search=preowned',
      //  'certified' => 'http://www.reidbros.ca/VehicleSearchResults?search=certified',
    ),
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_reidbros_next_page", "filter_reidbros_next_page",10,2);
     
     
    function filter_reidbros_next_page($next,$current_page) {
