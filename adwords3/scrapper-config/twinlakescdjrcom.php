...
$scrapper_configs["twinlakescdjrcom"] = array( 
	'entry_points' => array(
...
add_filter("filter_twinlakescdjrcom_field_images", "filter_twinlakescdjrcom_field_images",10,2);
function filter_twinlakescdjrcom_field_images($im_urls, $car_data) {
    $retval = array();
