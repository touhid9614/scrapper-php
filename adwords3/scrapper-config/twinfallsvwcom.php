...
$scrapper_configs["twinfallsvwcom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.twinfallsvw.com/searchnew.aspx',
        'used' => 'https://www.twinfallsvw.com/searchused.aspx'
    ),
...
// add_filter("filter_twinfallsvwcom_field_price", "filter_twinfallsvwcom_field_price", 10, 3);

// function filter_twinfallsvwcom_field_price($price, $car_data, $spltd_data) {
//     $prices = [];
