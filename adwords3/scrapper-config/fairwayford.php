...
global $scrapper_configs;
 $scrapper_configs["fairwayford"] = array( 
	 'entry_points' => array(
            'new'  => 'https://www.fairwayford.com/searchnew.aspx',
            'used' => 'https://www.fairwayford.com/searchused.aspx'
        ),
        'vdp_url_regex'     => '/\/(?:new|used)-Greenville[^-]*-[0-9]{4}/i',
        'use-proxy' => true,
        ...
        'data_capture_regx' => array(
            ...
            'price'            => '/FAIRWAY PRICE:\s*<\/span><span[^>]+>\$(?<price>[^<]+)/',
        ),
    ...
    add_filter('filter_fairwayford_field_price', 'filter_fairwayford_field_price',10,3);
    
    function filter_fairwayford_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
