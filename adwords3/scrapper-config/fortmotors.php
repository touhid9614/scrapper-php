<?php
    ...
    $scrapper_configs['fortmotors'] = array(
        'entry_points' => array(
        'new' => 'https://www.fortmotors.ca/inventory/search?stock_type=New&page=1&page_length=500',
        'used' => 'https://www.fortmotors.ca/inventory/search?stock_type=Used&page=1&page_length=500'
    ),
        ...
        foreach ($inventory as $obj) {
            $car_data = array(
               ...
               // 'trim' => $obj->trim->description ? $obj->trim->description : ($obj->trim->value . " " . $obj->trim->variation),
                ...
                'url' => "https://www.fortmotors.ca/inventory/" . strtolower($obj->stock_type) .
