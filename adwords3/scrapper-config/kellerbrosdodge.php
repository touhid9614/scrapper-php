<?php
    ...
    $scrapper_configs['kellerbrosdodge'] = array(
        'entry_points' => array(
            'new'  => 'https://www.kellerbrosdodge.net/new-inventory/index.htm',
            'used' => 'https://www.kellerbrosdodge.net/used-inventory/index.htm',
           // 'certified'=> 'http://www.kellerbrosdodge.net/certified-inventory/index.htm'
        ),
    ...
    add_filter("filter_kellerbrosdodge_field_price", "filter_kellerbrosdodge_field_price", 10, 3);
    function filter_kellerbrosdodge_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
