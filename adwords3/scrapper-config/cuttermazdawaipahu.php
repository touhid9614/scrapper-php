...
global $scrapper_configs;
 $scrapper_configs["cuttermazdawaipahu"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.cuttermazdawaipahu.com/new-mazda-for-sale',
            'used' => 'https://www.cuttermazdawaipahu.com/used-cars-for-sale',
        ...
        'data_capture_regx' => array(
            ...
            'price'         => '/(?:Sale Price:|Your Price:)[^\$]+\$<\/span><span itemprop=\'price\' content=\'(?<price>[0-9]+)/',
...
add_filter("filter_cuttermazdawaipahu_next_page", "filter_cuttermazdawaipahu_next_page", 10, 2);

function filter_cuttermazdawaipahu_next_page($next_page_regex)
{
