<?php
    ...
    $scrapper_configs['autoparktoronto'] = array(
        'entry_points' => array(
    ...
    add_filter("filter_autoparktoronto_field_images", "filter_autoparktoronto_field_images");
    add_filter("filter_autoparktoronto_field_stock_number", "filter_autoparktoronto_field_stock_number");
    
    function filter_autoparktoronto_field_images($im_urls)
    {
