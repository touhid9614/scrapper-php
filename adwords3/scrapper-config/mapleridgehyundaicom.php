...
$scrapper_configs["mapleridgehyundaicom"] = array( 
	'entry_points' => array(
            'used'   => 'https://v3zovi2qfz-1.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.1.0)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.1.1)&x-algolia-api-key=ec7553dd56e6d4c8bb447a0240e7aab3&x-algolia-application-id=V3ZOVI2QFZ',
             'new'   => 'https://v3zovi2qfz-3.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.1.0)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.1.1)&x-algolia-api-key=ec7553dd56e6d4c8bb447a0240e7aab3&x-algolia-application-id=V3ZOVI2QFZ',
       ),
...
add_filter("filter_mapleridgehyundaicom_field_images", "filter_mapleridgehyundaicom_field_images",10,2);
function filter_mapleridgehyundaicom_field_images($im_urls, $car_data) {
    $retval = array();
