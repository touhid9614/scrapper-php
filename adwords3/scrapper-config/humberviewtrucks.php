...
$scrapper_configs["humberviewtrucks"] = array(
    "entry_points" => array(
        'new' => 'https://www.humberviewtrucks.com/new/',
        'used' => 'https://www.humberviewtrucks.com/used/',
    ),
...
add_filter("filter_humberviewtrucks_field_price", "filter_humberviewtrucks_field_price", 10, 3);
add_filter("filter_humberviewtrucks_field_images", "filter_humberviewtrucks_field_images");

function filter_humberviewtrucks_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    if ($price && numarifyPrice($price) > 0) {
        ...
        slecho("humberviewtrucks Price: $price");
    }
...
function filter_humberviewtrucks_field_images($im_urls) {
