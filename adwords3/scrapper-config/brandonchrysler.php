...
$scrapper_configs["brandonchrysler"] = array(
    'entry_points' => array(
        'new' => 'https://www.brandonchrysler.ca/searchnew.aspx',
        'used' => 'https://www.brandonchrysler.ca/searchused.aspx'
    ),
...
add_filter("filter_brandonchrysler_field_price", "filter_brandonchrysler_field_price", 10, 3);

add_filter("filter_brandonchrysler_field_images", "filter_brandonchrysler_field_images");


    function filter_brandonchrysler_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
...
function filter_brandonchrysler_field_images($im_urls)
{
    $images=  array_filter($im_urls,function($img_url){
        return !endsWith($img_url,"carfax.png");
    });

    if(count($images) < 4) { return array(); }
