<?php
    ...
    $scrapper_configs['riverviewford'] = array(
        'entry_points' => array(
            'all'   => 'https://riverviewford.ca/data/inventory.json?ts=' . time(),
         ),
        'use-proxy' => true,
        ...
        'custom_data_capture'   => function($url, $data){
            ...
            foreach($objects->vehicles as $obj)
            {
                ...
                $car_data = array(
                    ...
                    'url'               => "https://www.riverviewford.ca/view/" . strtolower($obj->condition) .
               ...
               $details_url = "https://riverviewford.ca/data/{$obj->id}.json?{$obj->timestamp}";
