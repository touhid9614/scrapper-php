...
$scrapper_configs['lexusoftacomafife'] = array(
    'entry_points' => array(
        //'new'  => 'http://www.lexusoftacomafife.com/VehicleSearchResults?search=new',
        'used' => 'http://www.lexusoftacomafife.com/VehicleSearchResults?search=preowned',
      //  'certified' => 'http://www.lexusoftacomafife.com/VehicleSearchResults?search=certified',
    ),
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_lexusoftacomafife_next_page", "filter_lexusoftacomafife_next_page",10,2);
     
     
    function filter_lexusoftacomafife_next_page($next,$current_page) {
