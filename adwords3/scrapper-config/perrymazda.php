...
$scrapper_configs["perrymazda"] = array(
    'entry_points' => array(
        'new' => 'https://www.perrymazda.com/new-inventory/index.htm',
        'used' => 'https://www.perrymazda.com/used-inventory/index.htm',
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/class="msrp final-price">.*class=\'value[^>]+>(?<price>[^<]+)/', ///msrp price///
...
add_filter("filter_perrymazda_field_price", "filter_perrymazda_field_price", 10, 3);

function filter_perrymazda_field_price($price, $car_data, $spltd_data) {
    $prices = [];
