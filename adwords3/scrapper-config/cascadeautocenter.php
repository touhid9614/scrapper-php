<?php
    ...
    $scrapper_configs['cascadeautocenter'] = array(
        'entry_points' => array(
            'used'   => 'http://www.cascadeautocenter.com/search/used/tp/',
         ),
        'use-proxy' => true,
        ...
        'data_capture_regx' => array(
            ...
            'kilometres'    => '/mileageFromOdometer.*\s*.*content="(?<kilometres>[^"]+)/',
...
//    add_filter("filter_cascadeautocenter_field_images", "filter_cascadeautocenter_field_images");
//    
//    function filter_cascadeautocenter_field_images($im_urls)
//    {
//       $retval = array();
//
