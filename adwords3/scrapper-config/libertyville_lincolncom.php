...
$scrapper_configs["libertyville_lincolncom"] = array(
    'entry_points' => array(
        'used'  => 'https://www.libertyville-lincoln.com/used-inventory/index.htm',
       ),
      ...
      "custom_data_capture" => function ($url, $data) {
          $site                 = "https://www.libertyville-lincoln.com/sitemap.xml";
          $vdp_url_regex        = '/\/(?:new|used)\/[^\/]+\/[0-9]{4}-/i';
...
add_filter('filter_for_fb_libertyville_lincolncom', 'filter_for_fb_libertyville_lincolncom', 10, 1);

function filter_for_fb_libertyville_lincolncom($car)
{
