<?php
    ...
    $scrapper_configs['tuckerford'] = array(
        'entry_points' => array(
            'new'  => 'http://www.tuckerford.com/new-inventory/index.htm',
            'used' => 'http://www.tuckerford.com/used-inventory/index.htm'
        ),
        ...
        'data_capture_regx' => array(
            ...
            'trim'          => '/data-trim="(?<trim>[^"]+)/',
            'price'         => '/final-price"><span[^>]+>[^<]+.*<span[^>]+>[^<]+<\/span><\/span><span\s*class=\'value\'[^>]+>(?<price>\$[0-9,]+)/',
            'kilometres'    => '/Mileage:<\/dt>\s*<dd>\s*(?<kilometres>[^\s]+)/',
    ...
    add_filter("filter_tuckerford_field_price", "filter_tuckerford_field_price", 10, 3);
    
    
    
    function filter_tuckerford_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
