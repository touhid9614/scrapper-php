...
$scrapper_configs['murrayhonda'] = array(
    'entry_points' => array(
...
add_filter('filter_murrayhonda_post_data', 'filter_murrayhonda_post_data', 10, 2);
add_filter('filter_murrayhonda_data', 'filter_murrayhonda_data');

function filter_murrayhonda_post_data($post_data, $stock_type)
{
    global $achrysler_current_page;
...
function filter_murrayhonda_data($data)
{
    if($data)
    {
