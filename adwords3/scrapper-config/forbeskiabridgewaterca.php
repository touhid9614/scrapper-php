...
$scrapper_configs["forbeskiabridgewaterca"] = array( 
	"entry_points" => array(
	   'used' => 'https://www.forbeskiabridgewater.ca/used/',
        'new' => 'https://www.forbeskiabridgewater.ca/new/',
    ),
  ...
  add_filter("filter_forbeskiabridgewaterca_field_images", "filter_forbeskiabridgewaterca_field_images");
    
    function filter_forbeskiabridgewaterca_field_images($im_urls)
    {
