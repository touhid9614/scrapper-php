...
$scrapper_configs["acuraofbellevuecom"] = array( 
	"entry_points" => array(
	    'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/acuraofbellevue.csv'
        ),
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('acuraofbellevuecom');
            
            #Update
            $query = "SELECT * FROM acuraofbellevuecom_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
