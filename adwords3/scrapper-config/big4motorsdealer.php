...
global $scrapper_configs;
 $scrapper_configs["big4motorsdealer"] = array( 
	 'entry_points' => array(
            'new'   => 'https://www.big4motorsdealer.com/new-inventory/index.htm',
            'used'  => 'https://www.big4motorsdealer.com/used-inventory/index.htm'
        ),
...
//        'images_regx'       => '/<li>\s*<a href="(?<img_url>(?:https?:)?\/\/pictures.dealer.com\/c\/[^"]+)" class="">/',
    ...
    add_filter("filter_big4motorsdealer_field_images", "filter_big4motorsdealer_field_images");
    
    function filter_big4motorsdealer_field_images($im_urls)
    {
