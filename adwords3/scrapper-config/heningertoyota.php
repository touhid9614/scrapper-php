...
$scrapper_configs["heningertoyota"] = array(
        "entry_points" => array(
        ...
        foreach ($objects->results[0]->hits as $obj) {
           ...
           if(preg_match_all($images_regex, $temp_data, $matches))
               ...
               $im_urls=array_unique($im_urls);
                if (count($matches['img_url']) <= 15) {
                        
                    } else {
               //https://app.guidecx.com/app/tasks?edit-task=true&milestone-id=26b372d3-45d3-42c2-9675-8a59075b6979&task-id=0dc63c71-90b8-45ab-892f-f5fb73d6d837&task-tab=notes
...
// add_filter("filter_heningertoyota_field_images", "filter_heningertoyota_field_images");
    
//     function filter_heningertoyota_field_images($im_urls)
//     {
//          //https://app.guidecx.com/app/tasks?edit-task=true&milestone-id=26b372d3-45d3-42c2-9675-8a59075b6979&task-id=0dc63c71-90b8-45ab-892f-f5fb73d6d837&task-tab=notes
//        if(count($im_urls)<15)
//             {
