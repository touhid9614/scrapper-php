...
$scrapper_configs["whitsonmorganozarknet"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.whitsonmorganozark.net/new-inventory/index.htm',
            'used' => 'https://www.whitsonmorganozark.net/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_whitsonmorganozarknet_field_price", "filter_whitsonmorganozarknet_field_price", 10, 3);
    add_filter("filter_whitsonmorganozarknet_field_images", "filter_whitsonmorganozarknet_field_images");
    
    
    function filter_whitsonmorganozarknet_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $final_regex   =  '/Special Internet Price[^>]+>[^>]+>[^>]+>[^>]+>(?<price>[^<]+)/';
    ...
    function filter_whitsonmorganozarknet_field_images($im_urls)
    {
