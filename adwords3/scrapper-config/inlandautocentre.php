...
$scrapper_configs['inlandautocentre'] = array(
    'entry_points' => array(
        'new' => 'https://www.inlandautoinlandautocentre.com/new-inventory/index.htm',
        'used' => 'https://www.inlandautoinlandautocentre.com/used-inventory/index.htm'
    ),
...
add_filter("filter_inlandautoinlandautocentre_field_price", "filter_inlandautoinlandautocentre_field_price", 10, 3);

function filter_inlandautoinlandautocentre_field_price($price, $car_data, $spltd_data) {
    $prices = [];
