...
$scrapper_configs['smpchev'] = array(
    'entry_points' => array(
...
add_filter("filter_smpchev_field_images", "filter_smpchev_field_images");

function filter_smpchev_field_images($im_urls) {
    return array_filter($im_urls, function($im_url) {
        return !endsWith($im_url, 'notfound.jpg');
    });
}

add_filter('filter_smpchev_car_data', 'filter_smpchev_car_data');

function filter_smpchev_car_data($car_data) {
    //taking all cars except Corvette and above 80,000


    if (($car_data['price'] > '80000') || (stripos($car_data['model'], 'Corvette') !== false)) {
