...
global $scrapper_configs;
 $scrapper_configs["goderichhonda"] = array( 
	 "entry_points" => array(
		'new'   => 'https://www.goderichhonda.com/new/',
		'used'  => 'https://www.goderichhonda.com/used/group/',
	),
	...
	add_filter("filter_goderichhonda_field_price", "filter_goderichhonda_field_price", 10, 3);
    add_filter("filter_goderichhonda_field_images", "filter_goderichhonda_field_images");
    function filter_goderichhonda_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("goderichhonda Price: $price");
        }
    ...
    function filter_goderichhonda_field_images($im_urls)
    {
