<?php
    ...
    $scrapper_configs['rockydodge'] = array(
        'entry_points' => array(
            'new'   => 'https://www.rockymountaindodge.com/new/',
            'used'  => 'https://www.rockymountaindodge.com/used/',
        ),
        ...
        'data_capture_regx' => array(
            ...
            'price'               => '/Adjusted Price:<\/span>\s*<span[^>]+><meta[^>]+><meta[^>]+><span[^>]+>(?<price>\$[0-9,]+)/',
    ...
    add_filter("filter_rockydodge_field_price", "filter_rockydodge_field_price", 10, 3);
    add_filter("filter_rockydodge_field_images", "filter_rockydodge_field_images");
    function filter_rockydodge_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_rockydodge_field_images($im_urls)
    {
