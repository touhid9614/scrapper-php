...
$scrapper_configs['mikejacksongm'] = array(
...
add_filter("filter_mikejacksongm_field_images", "filter_mikejacksongm_field_images");

function filter_mikejacksongm_field_images($im_urls) 
{
       if(count($im_urls)<3)
            {
            return [];
