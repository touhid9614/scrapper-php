...
$scrapper_configs["pfaffautocom"] = array( 
	 'entry_points' => array(
             'used'  => 'https://www.pfaffauto.com/used/',
            'new'   => 'https://www.pfaffauto.com/new/',
    ...
    add_filter("filter_pfaffautocom_field_price", "filter_pfaffautocom_field_price", 10, 3);
    add_filter("filter_pfaffautocom_field_images", "filter_pfaffautocom_field_images");
    function filter_pfaffautocom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("pfaffautocom Price: $price");
        }
    ...
    function filter_pfaffautocom_field_images($im_urls)
    {
