...
$scrapper_configs['wheatonchev'] = array(
    'entry_points' => array(
            'used'   => 'https://www.wheatonchev.com/en/used-inventory/api/listing?limit=500', 
            'new'   => 'https://www.wheatonchev.com/en/new-inventory/api/listing?limit=500',    
        ),
        ...
        'srp_page_regex'     => '/\/en\/(?:new|used)-(?:catalog|inventory)/i',
                   ...
                   $to_return = array();
                       ...
                       $car_data = array(
                           ...
                           'url'               => "https://www.wheatonchev.com/en/" . $stock_type . "-inventory/" . strtolower($obj->make->name) . '/' . strtolower($obj->model->name) . '/' . $obj->year . '-' . strtolower($obj->make->name) . '-' . strtolower($obj->model->name) . '-id' . $obj->vehicleId,
