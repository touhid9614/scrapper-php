...
$scrapper_configs["raypricevolvocarscom"] = array( 
	"entry_points" => array(
        'new' => 'https://www.raypricevolvocars.com/new-inventory/index.htm',
        'used' => 'https://www.raypricevolvocars.com/used-inventory/index.htm',
    ),
    ...
    'new'               => array(
        ...
        'data_capture_regx' => array(
            ...
            'price' => '/Conditional Final Price[^>]+>:[^>]+>[^>]+>[^>]+>(?<price>[^<]+)/',
...
add_filter("filter_raypricevolvocarscom_field_images", "filter_raypricevolvocarscom_field_images");
  

function filter_raypricevolvocarscom_field_images($im_urls) {
   $retval = [];
