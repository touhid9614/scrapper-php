...
$scrapper_configs["jerseycitykiacom"] = array( 
	'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/MP22490.csv'
        ),
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $db_connect = DbConnect::get_instance('jerseycitykiacom');
            
            #Update
            $query = "SELECT * FROM jerseycitykiacom_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                $car_data = [
                    ...
                    'price'         => $vehicle['Price'],
                    'url'           => "https://www.jerseycitykia.com/auto/*/" . $vehicle['VIN'],
