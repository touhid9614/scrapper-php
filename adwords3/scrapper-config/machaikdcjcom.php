...
$scrapper_configs["machaikdcjcom"] = array( 
	 'entry_points' => array(
...
add_filter('filter_machaikdcjcom_post_data', 'filter_machaikdcjcom_post_data', 10, 2);

function filter_machaikdcjcom_post_data($post_data, $stock_type) {
    if ($stock_type == 'new') {
...
add_filter("filter_machaikdcjcom_field_images", "filter_machaikdcjcom_field_images");
function filter_machaikdcjcom_field_images($im_urls) {
