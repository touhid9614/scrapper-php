...
$scrapper_configs["sthdcom"] = array( 
  'entry_points' => array(
             'used' => 'https://sthd.com/used-inventory',
            'new'  => 'https://sthd.com/new-inventory',
   ...
   add_filter("filter_sthdcom_field_description", "filter_sthdcom_field_description");

function filter_sthdcom_field_description($description) {
