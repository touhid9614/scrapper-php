...
$scrapper_configs["pfaffvwcom"] = array( 
	'entry_points' => array(
        ...
        'init_method'       => 'POST',
        'next_method'       => 'POST',
        'picture_selectors' => ['.vehicle-image-bg.swiper-lazy'],
