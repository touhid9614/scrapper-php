<?php
    ...
    $scrapper_configs['kingfordsales'] = array(
        'entry_points' => array(
            'new'   => 'http://www.kingfordsales.com/new-inventory/index.htm',
            'used'  => 'http://www.kingfordsales.com/used-inventory/index.htm'
        ),
     ...
     //   'must_contain_regx' => '/<link itemprop="availability" href="http:\/\/schema.org\/InStock"\/>/i',
        'data_capture_regx' => array(
            ...
            'price'         => '/(?:stackedConditionalFinal|final-price)"><span[^>]+>[^<]+<span[^>]+>[^<]+<\/span><\/span><span\s*class=\'value\'[^>]+>(?<price>[^<]+)/',
