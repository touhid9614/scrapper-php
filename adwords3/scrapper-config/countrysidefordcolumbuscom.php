...
$scrapper_configs["countrysidefordcolumbuscom"] = array( 
	'entry_points' => array(
            'used' => 'https://www.countrysidefordcolumbus.com/used-inventory/index.htm',
            'new'  => 'https://www.countrysidefordcolumbus.com/new-inventory/index.htm',
    ...
    add_filter("filter_countrysidefordcolumbuscom_field_price", "filter_countrysidefordcolumbuscom_field_price", 10, 3);
    add_filter("filter_countrysidefordcolumbuscom_field_images", "filter_countrysidefordcolumbuscom_field_images");
    
    
    function filter_countrysidefordcolumbuscom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $final_regex   =  '/Countryside Price[^>]+>[^>]+>[^>]+>[^>]+>(?<price>[^<]+)/';
    ...
    function filter_countrysidefordcolumbuscom_field_images($im_urls)
    {       if(count($im_urls)<3)
            {
            return [];
