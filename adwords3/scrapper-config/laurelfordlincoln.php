...
$scrapper_configs['laurelfordlincoln'] = array(
    'entry_points' => array(
        'new'       => 'https://www.laurelfordlincoln.com/new-inventory/index.htm',
        'used'      => 'https://www.laurelfordlincoln.com/used-inventory/index.htm',
       // 'certified' => 'http://www.laurelfordlincoln.com/certified-used-cars-laurel-ms'
    ),
    ...
    add_filter("filter_laurelfordlincoln_field_price", "filter_laurelfordlincoln_field_price", 10, 3);
    function filter_laurelfordlincoln_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
