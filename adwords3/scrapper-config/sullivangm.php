<?php
    ...
    $scrapper_configs['sullivangm'] = array(
    'entry_points' => array(
 ...
 foreach($objects->results[0]->hits as $obj)
        {
            ...
            $car_data = array(
                ...
                'trim'              => $obj->trim,
                'body_style'        => $obj->body,
                'price'             => ($obj->msrp >= $obj->our_price)? ($obj->our_price):($obj->msrp==0?"Please Call":$obj->msrp),
...
function filter_sullivangm_post_data($post_data, $stock_type)
{
   ...
   add_filter("filter_sullivangm_field_images", "filter_sullivangm_field_images");
    
    function filter_sullivangm_field_images($im_urls)
    {
    ...
    add_filter('filter_for_fb_sullivangm', 'filter_for_fb_sullivangm', 10, 2);

function filter_for_fb_sullivangm($car_data, $feed_type)
{
   
    if (isset($car_data['model'])) {
        return null;
    }
    return $car_data;
}
