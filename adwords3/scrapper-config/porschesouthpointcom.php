...
$scrapper_configs["porschesouthpointcom"] = array( 
	"entry_points" => array(  
         'used' => 'https://www.porschesouthpoint.com/used-inventory/index.htm',
        'new' => 'https://www.porschesouthpoint.com/new-inventory/index.htm',
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/Demo Price[^>]+>:[^>]+>[^>]+>[^>]+>(?<price>[^<]+)/', ///dealer price///
...
add_filter("filter_porschesouthpointcom_field_price", "filter_porschesouthpointcom_field_price", 10, 3);
add_filter("filter_porschesouthpointcom_field_images", "filter_porschesouthpointcom_field_images");
  

function filter_porschesouthpointcom_field_images($im_urls) {
   $retval = [];
...
function filter_porschesouthpointcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
