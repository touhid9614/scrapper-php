...
global $scrapper_configs;
 $scrapper_configs["wallacejccom"] = array( 
	 "entry_points" => array(  
         'used' => 'https://www.wallacejc.com/used-inventory/index.htm',
        'new' => 'https://www.wallacejc.com/new-inventory/index.htm',
...
add_filter("filter_wallacejccom_field_price", "filter_wallacejccom_field_price", 10, 3);
add_filter("filter_wallacejccom_field_images", "filter_wallacejccom_field_images");
  

function filter_wallacejccom_field_images($im_urls) {
   $retval = [];
...
function filter_wallacejccom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
