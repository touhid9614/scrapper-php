...
$scrapper_configs['hillsidechevrolet'] = array(
    'entry_points' => array(
 ...
 foreach($objects->results[0]->hits as $obj)
        {
            ...
            $car_data = array(
               ...
               // 'stock_type'        => $obj->isCertified=='YES'? 'certified': ($obj->type=='Used' ? 'used' : 'new'),
...
//   add_filter("filter_hillsidechevrolet_field_images", "filter_hillsidechevrolet_field_images");
// function filter_hillsidechevrolet_field_images($im_urls) {
