...
$scrapper_configs['bayfieldford'] = array(
    'entry_points' => array(
        'new' => 'https://www.bayfieldford.com/new/',
        'used' => 'https://www.bayfieldford.com/used/group/'
    ),
...
add_filter("filter_bayfieldford_field_images", "filter_bayfieldford_field_images");

function filter_bayfieldford_field_images($im_urls) {
