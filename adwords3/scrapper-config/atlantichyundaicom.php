...
$scrapper_configs["atlantichyundaicom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.atlantichyundai.com/new-inventory/index.htm',
        'used' => 'https://www.atlantichyundai.com/used-inventory/index.htm'
    ),
