...
$scrapper_configs["landroverchicagocom"] = array( 
	"entry_points" => array(

	    'new' => 'https://www.landroverchicago.com/new-inventory/index.htm',
        'used' => 'https://www.landroverchicago.com/used-inventory/index.htm'
    ),
