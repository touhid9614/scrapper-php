...
$scrapper_configs["infinitiofrichmond"] = array(
    'entry_points' => array(
        'new' => 'https://www.infinitiofrichmond.com/wp-json/strathcom/vehicles/search?language=en&stock_type=New&page=1&page_length=1000',
        'used' => 'https://www.infinitiofrichmond.com/wp-json/strathcom/vehicles/search?language=en&stock_type=Used&page=1&page_length=1000',
    ),
    ...
    'custom_data_capture' => function($url, $resp) {
        ...
        foreach ($inventory as $obj) {
            $car_data = array(
                ...
                'url' => "https://www.infinitiofrichmond.com/inventory/" . strtolower($obj->stock_type) .
