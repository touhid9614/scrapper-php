...
$scrapper_configs['gurneehyundai'] = array(
    'entry_points' => array(
        'used'  => 'https://www.gurneehyundai.com/used-inventory/index.htm',
       ),
      ...
      "custom_data_capture" => function ($url, $data) {
          $site                 = "https://www.gurneehyundai.com/sitemap.xml";
          $vdp_url_regex        = '/\/(?:new|used)\/[^\/]+\/[0-9]{4}-/i';
...
add_filter('filter_gurneehyundai_car_data', 'filter_gurneehyundai_car_data');
function filter_gurneehyundai_car_data($car_data)
{               
            if ($car_data['stock_number'] == "null" || $car_data['stock_number'] == "" )
            {
                slecho("Making vin as stock number");
