...
$scrapper_configs["madriverharleycom"] = array( 
	'entry_points' => array(
        'used' => 'https://madriverharley.com/pre-owned-inventory',
        'new'  => 'https://madriverharley.com/new-inventory',  
    ),
...
add_filter('filter_madriverharleycom_car_data', 'filter_madriverharleycom_car_data');

function filter_madriverharleycom_car_data($car_data) {
