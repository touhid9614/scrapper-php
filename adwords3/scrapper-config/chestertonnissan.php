<?php
    ...
    $scrapper_configs['chestertonnissan'] = array(
        'entry_points' => array(
            'new'   => 'https://www.chestertonnissan.com/new-inventory/index.htm',
            'used'  => 'https://www.chestertonnissan.com/used-inventory/index.htm',
          //  'certified' => 'https://www.chestertonnissan.com/certified-used-cars-chesterton-in'
        ),
    ...
    add_filter("filter_chestertonnissan_field_images", "filter_chestertonnissan_field_images");
    add_filter("filter_chestertonnissan_field_price", "filter_chestertonnissan_field_price", 10, 3);

    function filter_chestertonnissan_field_images($im_urls)
    {
    ...
    function filter_chestertonnissan_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
