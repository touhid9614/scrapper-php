<?php
    ...
    $scrapper_configs['mmford'] = array(
        'entry_points' => array(
            'new'  => 'http://www.mmford.com/new-inventory/index.htm',
            'used' => 'http://www.mmford.com/used-inventory/index.htm',   
        ),
    ...
    add_filter("filter_mmford_field_price", "filter_mmford_field_price", 10, 3);
    function filter_mmford_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
