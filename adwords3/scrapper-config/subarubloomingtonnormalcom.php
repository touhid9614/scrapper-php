...
$scrapper_configs["subarubloomingtonnormalcom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.subarubloomingtonnormal.com/new-inventory/index.htm',
            'used' => 'https://www.subarubloomingtonnormal.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_subarubloomingtonnormalcom_field_price", "filter_subarubloomingtonnormalcom_field_price", 10, 3);
    add_filter("filter_subarubloomingtonnormalcom_field_images", "filter_subarubloomingtonnormalcom_field_images");
    
    
    function filter_subarubloomingtonnormalcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_subarubloomingtonnormalcom_field_images($im_urls)
    {
