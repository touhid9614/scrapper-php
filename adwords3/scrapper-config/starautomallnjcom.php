...
$scrapper_configs["starautomallnjcom"] = array(
    "entry_points" => array(
        'used' => 'https://starautomallnj.com/newandusedcars?pagesize=1000&page=1',
    ),
...
add_filter('filter_starautomallnjcom_field_url', 'filter_starautomallnjcom_field_url');

function filter_starautomallnjcom_field_url($url) {
    return trim($url);
}
