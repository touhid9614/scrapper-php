<?php
    ...
    $scrapper_configs['vancampenmotors'] = array(
        'entry_points' => array(
            'new'   => 'https://www.vancampenmotors.net/new-inventory/index.htm',
            'used'  => 'https://www.vancampenmotors.net/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_vancampenmotors_field_price", "filter_vancampenmotors_field_price", 10, 3);
    function filter_vancampenmotors_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
