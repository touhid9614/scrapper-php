...
$scrapper_configs["jaguarchicagocom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.jaguarchicago.com/new-inventory/index.htm',
        'used' => 'https://www.jaguarchicago.com/used-inventory/index.htm'
    ),
