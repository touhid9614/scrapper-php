...
$scrapper_configs["johnsonsubarucom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.johnsonsubaru.com/used-inventory/index.htm',
        'new' => 'https://www.johnsonsubaru.com/new-inventory/index.htm',
    ...
    add_filter("filter_johnsonsubarucom_field_price", "filter_johnsonsubarucom_field_price", 10, 3);
    add_filter("filter_johnsonsubarucom_field_images", "filter_johnsonsubarucom_field_images");
    function filter_johnsonsubarucom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_johnsonsubarucom_field_images($im_urls)
    {
           $retval = [];
