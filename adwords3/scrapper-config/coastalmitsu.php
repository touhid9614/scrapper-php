<?php
    ...
    $scrapper_configs['coastalmitsu'] = array(
        'entry_points' => array(
            'new'  => 'https://www.coastalmitsu.com/new-inventory/index.htm',
            'used' => 'https://www.coastalmitsu.com/used-inventory/index.htm',
          //  'certified' => 'http://www.coastalmitsu.com/certified-inventory/index.htm'
        ),
    ...
    add_filter("filter_coastalmitsu_field_price", "filter_coastalmitsu_field_price", 10, 3);
    add_filter("filter_coastalmitsu_field_images", "filter_coastalmitsu_field_images");
    
    
    function filter_coastalmitsu_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_coastalmitsu_field_images($im_urls)
    {
