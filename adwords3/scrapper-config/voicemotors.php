...
$scrapper_configs['voicemotors'] = array(
    'entry_points'        => array(
        'new' => 'https://www.voicemotors.com/VehicleSearchResults?search=new'
    ),
    ...
    "custom_data_capture" => function ($url, $data) {
        $site                 = "https://www.voicemotors.com/sitemap-inventory-sincro.xml";
        $vdp_url_regex        = '/\/VehicleDetails\/(?:new|used|certified)-[0-9]{4}-\S+/i';
