...
$scrapper_configs['eastsidekia'] = array(
    'entry_points' => array(
        'new' => 'https://www.eastsidekia.ca/new-inventory/index.htm',
        'used' => 'https://www.eastsidekia.ca/used-inventory/index.htm'
    ),
...
add_filter("filter_eastsidekia_next_page", "filter_eastsidekia_next_page", 10, 2);

function filter_eastsidekia_next_page($next_page) {
