...
$scrapper_configs["liatoyotaofrocklandcom"] = array(
    "entry_points" => array(
        'new' => 'https://www.liatoyotaofrockland.com/searchnew.aspx?Dealership=Lia+Toyota+of+Rockland',
        'used' => 'https://www.liatoyotaofrockland.com/searchused.aspx?Dealership=Lia+Toyota+of+Rockland',
    ),
...
add_filter('filter_liatoyotaofrocklandcom_field_price', 'filter_liatoyotaofrocklandcom_field_price', 10, 3);

function filter_liatoyotaofrocklandcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
