...
$scrapper_configs["barkermitsubishi"] = array(
    'entry_points' => array(
        'new'  => 'https://www.barkermitsubishi.com/searchnew.aspx',
        'used' => 'https://www.barkermitsubishi.com/searchused.aspx'
    ),
...
add_filter('filter_barkermitsubishi_car_data', 'filter_barkermitsubishi_car_data');

function filter_barkermitsubishi_car_data($car_data) {
