...
$scrapper_configs["landroverhuntingtoncom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.landroverhuntington.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new'  => 'https://www.landroverhuntington.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
        ...
        'custom_data_capture' => function($url, $data) {
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                   ...
                   // 'url' => "https://www.landroverhuntingtoncom.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
                    'url' => "https://www.landroverhuntington.com{$obj->link}",        
 ...
 add_filter("filter_landroverhuntingtoncom_next_page", "filter_landroverhuntingtoncom_next_page", 10, 2);       
 function filter_landroverhuntingtoncom_next_page($next, $current_page) {
...
add_filter('filter_landroverhuntingtoncom_car_data', 'filter_landroverhuntingtoncom_car_data');

function filter_landroverhuntingtoncom_car_data($car_data) {
