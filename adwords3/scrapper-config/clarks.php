...
$scrapper_configs['clarks'] = array(
    'entry_points' => array(
        'new'  => 'http://www.clarks.ca/VehicleSearchResults?search=new',
        'used' => 'http://www.clarks.ca/VehicleSearchResults?search=preowned',
        'certified' => 'http://www.clarks.ca/VehicleSearchResults?search=certified',
    ),
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_clarks_next_page", "filter_clarks_next_page",10,2);
     
     
    function filter_clarks_next_page($next,$current_page) {
