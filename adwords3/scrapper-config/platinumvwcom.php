...
$scrapper_configs["platinumvwcom"] = array( 
	  'entry_points' => array(
...
add_filter('filter_platinumvwcom_post_data', 'filter_platinumvwcom_post_data', 10, 2);

//add_filter("filter_platinumvwcom_field_images", "filter_platinumvwcom_field_images");
//
//function filter_platinumvwcom_field_images($im_urls) {
//
//    if (count($im_urls) < 5) {
//        return [];
//    }
