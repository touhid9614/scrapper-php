...
$scrapper_configs["motozoo"] = array(
    'entry_points' => array(
        'new' => 'https://www.motozoo.com/imglib/Inventory/cache/4507/NVehInv.js?v=4580412',
        'used' => 'https://www.motozoo.com/imglib/Inventory/cache/4507/UVehInv.js?v=2257078',
    ),
    ...
    'custom_data_capture' => function($url, $resp) {
        ...
        foreach ($inventory as $obj) {
            if ($obj->type == 'U') {
                $url = "https://www.motozoo.com/default.asp?page=xPreOwnedInventoryDetail";
            } else {
                $url = "https://www.motozoo.com/default.asp?page=xNewInventoryDetail";
            }
            $car_data = array(
 ...
 add_filter("filter_motozoo_field_images", "filter_motozoo_field_images");

function filter_motozoo_field_images($im_urls) {

    $final_image = [];
    $check_exist = ["https://www.motozoo.com/your%20ZIP"];
