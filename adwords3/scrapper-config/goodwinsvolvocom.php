...
$scrapper_configs["goodwinsvolvocom"] = array( 
  'entry_points' => array(
            'new'  => 'https://www.goodwinsvolvo.com/new-inventory/index.htm',
            'used' => 'https://www.goodwinsvolvo.com/used-inventory/index.htm'
        ),
       'vdp_url_regex'     => '/\/(?:new|used|certified|wholesale-used|commercial-used)\/[^\/]+\/[0-9]{4}-/i',
    ...
    add_filter("filter_goodwinsvolvocom_field_price", "filter_goodwinsvolvocom_field_price", 10, 3);
    add_filter("filter_goodwinsvolvocom_field_images", "filter_goodwinsvolvocom_field_images");
    
    
    function filter_goodwinsvolvocom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $final_regex   =  '/Adjusted Price[^>]+>[^>]+>[^>]+>[^>]+>(?<price>[^<]+)/';
    ...
    function filter_goodwinsvolvocom_field_images($im_urls)
    {
