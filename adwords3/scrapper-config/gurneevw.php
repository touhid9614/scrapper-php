...
$scrapper_configs['gurneevw'] = array(
    'entry_points' => array(
        'new' => 'https://www.gurneevw.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1',
        'used' => 'https://www.gurneevw.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                   ...
                   // 'images'            => array_merge($obj->photos->user, $obj->photos->stock),    
                    'url' => "https://www.gurneevw.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_gurneevw_next_page", "filter_gurneevw_next_page", 10, 2);       
 function filter_gurneevw_next_page($next, $current_page) {
...
//add_filter("filter_gurneevw_field_images", "filter_gurneevw_field_images");
//    
//    function filter_gurneevw_field_images($im_urls)
//    {
//       if(count($im_urls)<2)
//            {
//            return [];
