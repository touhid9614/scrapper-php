<?php
    ...
    $scrapper_configs['jenkinshyundaiofocala'] = array(
        'entry_points' => array(
            'new'  => 'https://www.jenkinshyundaiofocala.com/new-inventory/index.htm',
            'used' => 'https://www.jenkinshyundaiofocala.com/used-inventory/index.htm',   
        ),
        ...
        'data_capture_regx_full' => array(        
            ...
            'price'         => '/"stackedConditionalFinal"*[^>]+.[^>]+>(?<price>[^<]+)<\/strong\>/',
            'trim'          => '/"trim": "(?<trim>[^"]+)/',
    ...
    add_filter("filter_jenkinshyundaiofocala_field_price", "filter_jenkinshyundaiofocala_field_price", 10, 3);
    function filter_jenkinshyundaiofocala_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
