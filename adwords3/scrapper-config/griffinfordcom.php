...
$scrapper_configs["griffinfordcom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.griffinford.com/searchnew.aspx',
            'used' => 'https://www.griffinford.com/searchused.aspx'
        ),
...
add_filter("filter_griffinfordcom_field_price", "filter_griffinfordcom_field_price", 10, 3);
        function filter_griffinfordcom_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
            ...
            if($price && numarifyPrice($price) > 0) {
                ...
                slecho("griffinfordcom Price: $price");
            }
