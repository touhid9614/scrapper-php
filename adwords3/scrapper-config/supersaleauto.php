...
global $scrapper_configs;
 $scrapper_configs["supersaleauto"] = array( 
	  'entry_points' => array(
            'used' => 'https://www.supersaleauto.com/inventory'
        ),
        ...
        'data_capture_regx' => array(
            ...
            'kilometres'    => '/class="col option col-12 col-md-12 col-lg-9">\s*[^\n]+\n[^\n]+\n[^\n]+\n[^\n]+\n[^\n]+\n[^\n]+\n\s*(?<kilometres>[^\s]+)/',
            'stock_number'  => '/STOCK ID :(?<stock_number>[^<]+)/',
        ...
        'images_regx'       => '/class="vehicle_slide">\s*<img src="(?<img_url>[^"]+)"/',
    );
