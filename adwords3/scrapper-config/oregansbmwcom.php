...
$scrapper_configs["oregansbmwcom"] = array(
    'entry_points' => array(
          'used'  => 'https://www.oregansbmw.com/used-cars/?search.location.id=28&search.start-index=0&do-search=1&advanced=&system.view-type.code=ajax',
          'new'   => 'https://oserv2.oreganscdn.com/api/vehicle-inventory-search/?search.vehicle-make-ids[]=5&search.vehicle-inventory-type-ids=1&do-search=1&search.results-offset=0&search.results-limit=50&app.referrer=https://www.oregansbmw.com',
            ...
            $objects = json_decode($data);
                ...
                foreach ($objects->oreg->wuvs->results->vehicles as $obj)
                {
                    ...
                    $car_data = array(
                        ...
                        'url' => "https://www.oregansbmw.com/used-cars/{$obj->year}-{$obj->vehicleMake->name}-{$obj->vehicleMakeModel->name}-"
...
add_filter('filter_oregansbmwcom_car_data', 'filter_oregansbmwcom_car_data');
add_filter("filter_oregansbmwcom_next_page", "filter_oregansbmwcom_next_page", 10, 2);


function filter_oregansbmwcom_car_data($car_data) {
    ...
    if ($car_data['stock_type'] == 'new') {
        ...
        $car_data['url'] = str_replace('https://', 'https://www.oregansbmw.com', $car_data['url']);
    ...
    if (isset($car_data['vin']) && $car_data['vin']) {
        ...
        $in_cookies     = '';
        $out_cookies    = '';
        $response_data = HttpPost($api_url, $post_data, $in_cookies, $out_cookies, false, true, 'application/x-www-form-urlencoded', ['origin' => 'https://www.oregansbmw.com']);
...
function filter_oregansbmwcom_next_page($next, $current_page) {
