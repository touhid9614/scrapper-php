...
$scrapper_configs['carlocknissanofjackson'] = array(
    'entry_points'        => array(
...
add_filter("filter_carlocknissanofjackson_field_images", "filter_carlocknissanofjackson_field_images");
function filter_carlocknissanofjackson_field_images($im_urls)
{
    if (count($im_urls) < 3) {
        return [];
