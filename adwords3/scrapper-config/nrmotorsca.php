...
$scrapper_configs["nrmotorsca"] = array( 
	"entry_points" => array(

        'new'   => 'https://www.nrmotors.ca/imglib/Inventory/cache/2262/NVehInv.js?v=5867048',
        'used'  => 'https://www.nrmotors.ca/imglib/Inventory/cache/2262/UVehInv.js?v=2676069',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory as $obj)
           {
               if($obj->type == 'U')   
               {
                   $url="https://www.nrmotors.ca/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.nrmotors.ca/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
