...
global $scrapper_configs;
 $scrapper_configs["mckinleyvillechevrolet"] = array( 
	  'entry_points' => array(
         'used' => 'https://www.mckinleyvillechevrolet.com/VehicleSearchResults?search=preowned',
        'new'  => 'https://www.mckinleyvillechevrolet.com/VehicleSearchResults?search=new',
    ...
    add_filter("filter_mckinleyvillechevrolet_next_page", "filter_mckinleyvillechevrolet_next_page",10,2);
    
    
    function filter_mckinleyvillechevrolet_next_page($next,$current_page) {
