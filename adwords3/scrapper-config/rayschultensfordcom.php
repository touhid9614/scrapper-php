...
$scrapper_configs["rayschultensfordcom"] = array( 
	  'entry_points' => array(
            'new'  => 'https://www.rayschultensford.com/new-inventory/index.htm',
            'used' => 'https://www.rayschultensford.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_rayschultensfordcom_field_price", "filter_rayschultensfordcom_field_price", 10, 3);
    add_filter("filter_rayschultensfordcom_field_images", "filter_rayschultensfordcom_field_images");
    
    
    function filter_rayschultensfordcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_rayschultensfordcom_field_images($im_urls)
    {
