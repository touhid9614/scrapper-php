...
$scrapper_configs["gpchryslercom"] = array( 
	'entry_points' => array(
    ...
    'srp_page_regex'      => '/\/(?:new|used|certified-used|certified)\-vehicles/',
    'use-proxy'         => true,
    'refine'            => false,
    'init_method'       => 'POST',
    'next_method'       => 'POST',
