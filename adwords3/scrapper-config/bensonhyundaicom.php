...
$scrapper_configs["bensonhyundaicom"] = array(
    'entry_points'        => array(
...
function filter_bensonhyundaicom_post_data($post_data, $stock_type)
{
 ...
 add_filter("filter_bensonhyundaicom_field_images", "filter_bensonhyundaicom_field_images", 10, 2);

// function filter_bensonhyundaicom_field_images($im_urls, $car_data)
// {
//     $ignore = $car_data['url'];
//     slecho("vvv:" . $ignore);
