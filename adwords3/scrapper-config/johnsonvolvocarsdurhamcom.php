...
$scrapper_configs["johnsonvolvocarsdurhamcom"] = array( 
	 'entry_points' => array(
         'new'  => 'https://www.johnsonvolvocarsdurham.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?pageSize=100&start=0',
        'used' => 'https://www.johnsonvolvocarsdurham.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?pageSize=100&start=0',
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                   ...
                   // 'images'            => array_merge($obj->photos->user, $obj->photos->stock),    
                    'url' => "https://www.johnsonvolvocarsdurham.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_johnsonvolvocarsdurhamcom_next_page", "filter_johnsonvolvocarsdurhamcom_next_page", 10, 2);       
 function filter_johnsonvolvocarsdurhamcom_next_page($next, $current_page) {
