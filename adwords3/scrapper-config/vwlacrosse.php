...
$scrapper_configs['vwlacrosse'] = array(
    'entry_points' => array(
        'certified' => 'https://sewjn80htn-dsn.algolia.net/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=179608f32563367799314290254e3e44&x-algolia-application-id=SEWJN80HTN',
        ...
        'new'  => 'https://sewjn80htn-1.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.6.0)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.2.2)&x-algolia-api-key=179608f32563367799314290254e3e44&x-algolia-application-id=SEWJN80HTN',
    ),
...
add_filter("filter_vwlacrosse_field_images", "filter_vwlacrosse_field_images");
    
    function filter_vwlacrosse_field_images($im_urls)
    {
       if(count($im_urls)<2)
            {
            return [];
