...
global $scrapper_configs;
 $scrapper_configs["robgreennissan"] = array( 
	'entry_points' => array(
        'new'  => 'https://www.robgreennissan.com/VehicleSearchResults?search=new',
        'used' => 'https://www.robgreennissan.com/VehicleSearchResults?search=preowned',
    ...
    'vdp_url_regex' => '/\/VehicleDetails\/(?:new|used|certified)-[0-9]{4}-\S+/',
     ...
     add_filter("filter_robgreennissan_next_page", "filter_robgreennissan_next_page",10,2);
     
     
    function filter_robgreennissan_next_page($next,$current_page) {
