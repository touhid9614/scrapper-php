...
$scrapper_configs['roncarterleaguecitycom'] = array(
    'entry_points' => array(
        'new' => 'https://www.roncarterleaguecity.com/new-inventory/index.htm',
        'used' => 'https://www.roncarterleaguecity.com/used-inventory/index.htm'
    ),
...
add_filter("filter_roncarterleaguecitycom_field_price", "filter_roncarterleaguecitycom_field_price", 10, 3);

function filter_roncarterleaguecitycom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $msrp_regex = '/MSRP<span[^>]+>:<\/span><\/span><span[^>]+>(?<price>[^<]+)/';
