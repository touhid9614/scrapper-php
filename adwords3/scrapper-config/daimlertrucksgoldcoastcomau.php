...
$scrapper_configs["daimlertrucksgoldcoastcomau"] = array( 
	'entry_points' => array(
            'used'  => 'https://www.daimlertrucksgoldcoast.com.au/stock/used-trucks/',
            'new'   => 'https://www.daimlertrucksgoldcoast.com.au/stock/new-trucks/',
...
add_filter('filter_daimlertrucksgoldcoastcomau_car_data', 'filter_daimlertrucksgoldcoastcomau_car_data');

function filter_daimlertrucksgoldcoastcomau_car_data($car_data) {
