...
$scrapper_configs["terracetoyotaca"] = array( 
	'entry_points'        => array(
...
add_filter('filter_for_fb_terracetoyotaca', 'filter_for_fb_terracetoyotaca', 10, 2);

function filter_for_fb_terracetoyotaca($car_data, $feed_type) {
