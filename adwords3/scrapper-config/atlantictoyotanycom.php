...
$scrapper_configs["atlantictoyotanycom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.atlantictoyotany.com/searchnew.aspx',
        'used' => 'https://www.atlantictoyotany.com/searchused.aspx'
    ),
...
add_filter("filter_atlantictoyotanycom_field_price", "filter_atlantictoyotanycom_field_price", 10, 3);

function filter_atlantictoyotanycom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
