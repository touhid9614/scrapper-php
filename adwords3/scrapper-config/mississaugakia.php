...
global $scrapper_configs;
 $scrapper_configs["mississaugakia"] = array( 
	 "entry_points" => array(
		'new'   => 'https://www.mississaugakia.com/new/',
		'used'  => 'https://www.mississaugakia.com/used/group/',
	),
	...
	add_filter("filter_mississaugakia_field_price", "filter_mississaugakia_field_price", 10, 3);
    add_filter("filter_mississaugakia_field_images", "filter_mississaugakia_field_images");
    function filter_mississaugakia_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("mississaugakia Price: $price");
        }
    ...
    function filter_mississaugakia_field_images($im_urls)
    {
