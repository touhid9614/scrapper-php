...
$scrapper_configs["holidaybuickgmccadillacnet"] = array( 
	 'entry_points' => array(
                'new' => 'https://www.holidaybuickgmccadillac.net/searchnew.aspx',
                'used'=> 'https://www.holidaybuickgmccadillac.net/searchused.aspx'
        ),
    ...
    'images_regx' => '/zoom feature element -->\s*<img src="(?<img_url>[^\?]+)/',
     ...
     add_filter("filter_holidaybuickgmccadillacnet_field_images", "filter_holidaybuickgmccadillacnet_field_images");
     add_filter('filter_holidaybuickgmccadillacnet_field_price', 'filter_holidaybuickgmccadillacnet_field_price',10,3);

        function filter_holidaybuickgmccadillacnet_field_images($im_urls)
        {
    ...
    function filter_holidaybuickgmccadillacnet_field_price($price,$car_data,$spltd_data)
    {
        $prices = [];
