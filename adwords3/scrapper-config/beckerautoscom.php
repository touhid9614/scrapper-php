...
$scrapper_configs["beckerautoscom"] = array( 
	 'entry_points'         => [
        'all' => 'https://www.beckerautos.com/imglib/Inventory/cache/10506/VehInv.js?v=9512311',
    ...
    'custom_data_capture'  => function ($url, $resp) {
        ...
        foreach ($inventory as $obj) {
            if ($obj->type == 'U') {
                $stk_url = "https://www.beckerautos.com/default.asp?page=xPreOwnedInventoryDetail";
            } else {
                $stk_url = "https://www.beckerautos.com/default.asp?page=xNewInventoryDetail";
            }
            ...
            $url = "https://www.beckerautos.com/default.asp?page=xInventoryDetail";
