...
$scrapper_configs['korfmotorsfordcom'] = array(
    'entry_points' => array(
      'used' => 'https://www.korfmotorsford.com/searchused.aspx',
        'new' => 'https://www.korfmotorsford.com/searchnew.aspx'
    ),
...
add_filter("filter_korfmotorsfordcom_field_price", "filter_korfmotorsfordcom_field_price", 10, 3);

function filter_korfmotorsfordcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
