...
global $scrapper_configs;
 $scrapper_configs["herbchamberslincolncom"] = array( 
	  'entry_points' => array(
        'new' => 'https://www.herbchamberslincoln.com/new-inventory/index.htm',
        'used' => 'https://www.herbchamberslincoln.com/used-inventory/index.htm',
    ),
...
add_filter("filter_herbchamberslincolncom_field_price", "filter_herbchamberslincolncom_field_price", 10, 3);

function filter_herbchamberslincolncom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
