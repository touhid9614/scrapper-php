...
$scrapper_configs["palmenalfaromeocom"] = array( 
	'entry_points' => array(
            'used' => 'https://www.palmenalfaromeo.com/used-vehicles-kenosha-wi?limit=300',
        'new' => 'https://www.palmenalfaromeo.com/new-alfa-romeo-kenosha-wi?limit=300',
  ...
  add_filter("filter_palmenalfaromeocom_field_price", "filter_palmenalfaromeocom_field_price", 10, 3);
     function filter_palmenalfaromeocom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $msrp_regex       =  '/Palmen Price[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*[^>]+>\s*(?<price>\$[0-9,]+)/';
