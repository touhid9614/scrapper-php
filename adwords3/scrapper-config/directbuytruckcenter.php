...
global $scrapper_configs;
 $scrapper_configs["directbuytruckcenter"] = array( 
	  'entry_points'          => array(
              // 'new'   => 'https://www.enstoyota.ca/vehicles/new/',
             //'used' => 'https://www.directbuytruckcenter.ca/vehicles/used/'
...
//                $stock_type_key     = array_search('saleclass', $inventory_key); //21
...
//                    'price'             => $obj[$price_key]>0?$obj[$price_key]:$obj[$asking_price_key],
//                    'engine'            => $obj[$engine_key],
//                    'transmission'      => $obj[$transmission_key],
//                    'kilometres'        => $obj[$kilometres_key],
//                    'url'               => "https://www.directbuytruckcenter.ca/vehicles/{$obj[$year_key]}/$_make/$_model/Kamloops/BC/{$obj[$vin_key]}",
