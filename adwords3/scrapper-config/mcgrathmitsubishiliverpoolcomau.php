...
$scrapper_configs["mcgrathmitsubishiliverpoolcomau"] = array( 
	"entry_points" => array(

         'all'  => 'https://www.mcgrathmitsubishiliverpool.com.au/all-stock/list/?q=perpage%3A30',

            'used'  => 'https://www.mcgrathmitsubishiliverpool.com.au/used-mitsubishi-liverpool/?q=perpage%3A30',
	       'new'   => 'https://www.mcgrathmitsubishiliverpool.com.au/new-mitsubishi-range-liverpool/mitsubishi/?q=perpage%3A30',
            'demo'  => 'https://www.mcgrathmitsubishiliverpool.com.au/mitsubishi-demos-liverpool/?q=perpage%3A30',
        
    ),
    'use-proxy' => true,
    'vdp_url_regex' => '/\/(?:new|used|certified-used|demo|all-stock|mitsubishi-demos-).*\/view\/[0-9]{4}-/i',
    'refine'=> false,
...
add_filter('filter_mcgrathmitsubishiliverpoolcomau_car_data', 'filter_mcgrathmitsubishiliverpoolcomau_car_data');

function filter_mcgrathmitsubishiliverpoolcomau_car_data($car_data) {
