...
global $scrapper_configs;
 $scrapper_configs["autoparkmississauga"] = array( 
	'entry_points' => array(
           // 'new'   => 'https://www.autoparkmississauga.com/new/',
            'used'  => 'https://www.autoparkmississauga.ca/used/group/',
        ),
    ...
    add_filter("filter_autoparkmississauga_field_price", "filter_autoparkmississauga_field_price", 10, 3);
    add_filter("filter_autoparkmississauga_field_images", "filter_autoparkmississauga_field_images");
    function filter_autoparkmississauga_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("autoparkmississauga Price: $price");
        }
    ...
    function filter_autoparkmississauga_field_images($im_urls)
    {
