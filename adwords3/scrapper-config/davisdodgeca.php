...
$scrapper_configs["davisdodgeca"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.davisdodge.ca/new/',
            'used'  => 'https://www.davisdodge.ca/used/'
        ),
    ...
    add_filter("filter_davisdodgeca_field_images", "filter_davisdodgeca_field_images");
   
    function filter_davisdodgeca_field_images($im_urls)
    {
        return array_filter($im_urls, function($im_url){
            return !endsWith($im_url, 'no_image-640x480.jpg');
        });
    }
   add_filter("filter_davisdodgeca_field_price", "filter_davisdodgeca_field_price", 10, 3);

    function filter_davisdodgeca_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("davisdodgeca Price: $price");
        }
