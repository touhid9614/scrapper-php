...
$scrapper_configs["motounitedlahabracom"] = array( 
			'entry_points' => array(
			'new'   => 'https://www.motounitedlahabra.com/imglib/Inventory/cache/4546/NVehInv.js?v=9530988',
			'used'  => 'https://www.motounitedlahabra.com/imglib/Inventory/cache/4546/UVehInv.js?v=5282163',
		),
		'vdp_url_regex'     => '/\/default\.asp/i',
		...
		'custom_data_capture' => function($url, $resp){
			   ...
			   foreach($inventory as $obj)
			   {
				   if($obj->type == 'U')   
				   {
					   $url="https://www.motounitedlahabra.com/default.asp?page=xPreOwnedInventoryDetail";
				   }
				   else 
				   {
					   $url="https://www.motounitedlahabra.com/default.asp?page=xNewInventoryDetail";
				   }
				   $car_data = array(
