...
$scrapper_configs["bigstcharlesmotorsports"] = array(
    'entry_points' => array(
        'used' => 'https://www.bigstcharlesmotorsports.com/imglib/Inventory/cache/3365/UVehInv.js?v=3387846',
        'new' => 'https://www.bigstcharlesmotorsports.com/imglib/Inventory/cache/3365/NVehInv.js?v=4573545', 
    ),
    ...
    'custom_data_capture' => function($url, $data) {
        ...
        foreach ($objects as $obj) {
            if ($obj->type == 'U') {
                $url = "https://www.bigstcharlesmotorsports.com/default.asp?page=xPreOwnedInventoryDetail";
            } else {
                $url = "https://www.bigstcharlesmotorsports.com/default.asp?page=xNewInventoryDetail";
            }
            $car_data = array(
                ...
                'price' => $obj->price != 0 ? $obj->price : $obj->MSRP,
                'engine' => $obj->engine,
