...
$scrapper_configs["victoriahyundaicom"] = array( 
	'entry_points' => array(
...
add_filter("filter_victoriahyundaicom_field_images", "filter_victoriahyundaicom_field_images",10,2);
function filter_victoriahyundaicom_field_images($im_urls, $car_data) {
    $retval = array();
