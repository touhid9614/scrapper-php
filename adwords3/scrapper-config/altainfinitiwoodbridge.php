...
$scrapper_configs['altainfinitiwoodbridge'] = array(
    'entry_points' => array(
        'new' => 'https://www.altainfinitiwoodbridge.com/new-inventory/index.htm',
        'used' => 'https://www.altainfinitiwoodbridge.com/used-inventory/index.htm'
    ),
...
add_filter("filter_altainfinitiwoodbridge_field_price", "filter_altainfinitiwoodbridge_field_price", 10, 3);

function filter_altainfinitiwoodbridge_field_price($price, $car_data, $spltd_data) {
    $prices = [];
