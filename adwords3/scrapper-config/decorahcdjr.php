<?php
    ...
    $scrapper_configs['decorahcdjr'] = array(
        'entry_points' => array(
            'new'  => 'https://www.decorahcdjr.com/new-inventory/index.htm',
            'used' => 'https://www.decorahcdjr.com/used-inventory/index.htm',
            'certified' => 'https://www.decorahcdjr.com/certified-inventory/index.htm',
        ),
    ...
    add_filter("filter_decorahcdjr_field_images", "filter_decorahcdjr_field_images");
    
    function filter_decorahcdjr_field_images($im_urls)
    {
        $retval=array();
