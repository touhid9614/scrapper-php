<?php
    ...
    $scrapper_configs['cartercdjr'] = array(
        'entry_points' => array(
        ...
        'data_capture_regx' => array(
            ...
            'price'               => '/>Cash Price:[\S\s]*?itemprop="price" content="(?<price>[0-9,]+)/',
    ...
    add_filter("filter_cartercdjr_field_images", "filter_cartercdjr_field_images");
    
    add_filter("filter_cartercdjr_field_price", "filter_cartercdjr_field_price", 10, 3);
    
    function filter_cartercdjr_field_images($im_urls)
    {
    ...
    function filter_cartercdjr_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
