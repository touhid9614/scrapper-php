<?php
    ...
    $scrapper_configs['rameymotors'] = array(
        'entry_points' => array(
            'new'   => 'http://www.rameymotors.net/new-inventory/index.htm',
            'used'  => 'https://www.rameymotors.net/used-inventory/index.htm',
    ...
    add_filter("filter_rameymotors_field_price", "filter_rameymotors_field_price", 10, 3);
    add_filter("filter_rameymotors_field_images", "filter_rameymotors_field_images");
    
    
    function filter_rameymotors_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_rameymotors_field_images($im_urls)
    {
       $retval = array();
