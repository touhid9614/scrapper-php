...
$scrapper_configs['mainlinemotors'] = array(
    'entry_points'           => array(
    ...
    'custom_data_capture' => function($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            if(preg_match_all($images_regex, $temp_data, $matches))
            {
                ...
                // }
                // else{
                    // if(strpos($matches['img_url'][0],"stock-images") || strpos($matches['img_url'][1],"stock-images") || strpos($matches['img_url'][1],"MediaGallery")){
...
function filter_for_fb_mainlinemotors($car_data, $feed_type) {
    ...
    $ignore_data=[
            ...
            {
                //lecho("Excluding car that has  ,{$car_data['stock_number']}");
                return null;
