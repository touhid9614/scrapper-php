...
$scrapper_configs["gilbertbaughfordcom"] = array( 
	 'entry_points' => array(
            'new'  => 'https://www.gilbertbaughford.com/searchnew.aspx',
            'used' => 'https://www.gilbertbaughford.com/searchused.aspx'
        ),
        ...
        'images_regx'       => '/class="carousel__item js-carousel__item[^>]+><img src="(?<img_url>[^\?]+)/',
    );
add_filter("filter_gilbertbaughfordcom_field_price", "filter_gilbertbaughfordcom_field_price", 10, 3);
        function filter_gilbertbaughfordcom_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
            ...
            if($price && numarifyPrice($price) > 0) {
                ...
                slecho("gilbertbaughfordcom Price: $price");
            }
