...
global $scrapper_configs;
 $scrapper_configs["green_nissan"] = array( 
	'entry_points' => array(
        'new'  => 'https://www.green-nissan.com/VehicleSearchResults?search=new',
        'used' => 'https://www.green-nissan.com/VehicleSearchResults?search=preowned',
    ...
    'vdp_url_regex' => '/\/VehicleDetails\/(?:new|used|certified)-[0-9]{4}-\S+/',
     ...
     add_filter("filter_green_nissan_next_page", "filter_green_nissan_next_page",10,2);
     
     
    function filter_green_nissan_next_page($next,$current_page) {
