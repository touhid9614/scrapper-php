...
$scrapper_configs["rvsuperstoresaskatooncom"] = array(

    'entry_points' => array(
        'used' => 'https://www.rvsuperstoresaskatoon.com/--inventory?condition=pre-owned&pg=1',
        'new' => 'https://www.rvsuperstoresaskatoon.com/--inventory?condition=new&pg=1',
...
add_filter("filter_rvsuperstoresaskatooncom_next_page", "filter_rvsuperstoresaskatooncom_next_page", 10, 2);
add_filter("filter_rvsuperstoresaskatooncom_field_images", "filter_rvsuperstoresaskatooncom_field_images");

function filter_rvsuperstoresaskatooncom_next_page($next, $current_page) {
...
add_filter("filter_rvsuperstoresaskatooncom_field_images", "filter_rvsuperstoresaskatooncom_field_images");
function filter_rvsuperstoresaskatooncom_field_images($im_urls)
{
    $retval = [];

    foreach($im_urls as $img)
    {
        $retval[] = str_replace(["&#x2F;","https://www.rvsuperstoresaskatoon.com/"], ["/",""], $img);
    }
