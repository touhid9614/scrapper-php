...
$scrapper_configs['rameychevroletprinceton'] = array(
    'entry_points' => array(
        'new'  => 'http://www.rameychevroletprinceton.com/VehicleSearchResults?search=new',
        'used' => 'http://www.rameychevroletprinceton.com/VehicleSearchResults?search=preowned',
    ...
    'details_start_tag'    => '<ul each="cards">',
     ...
     add_filter("filter_rameychevroletprinceton_next_page", "filter_rameychevroletprinceton_next_page",10,2);
     
     
    function filter_rameychevroletprinceton_next_page($next,$current_page) {
