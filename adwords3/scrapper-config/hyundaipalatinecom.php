...
$scrapper_configs["hyundaipalatinecom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.hyundaipalatine.com/new-inventory/index.htm',
            'used' => 'https://www.hyundaipalatine.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_hyundaipalatinecom_field_price", "filter_hyundaipalatinecom_field_price", 10, 3);
    add_filter("filter_hyundaipalatinecom_field_images", "filter_hyundaipalatinecom_field_images");
    
    
    function filter_hyundaipalatinecom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_hyundaipalatinecom_field_images($im_urls)
    {
