...
$scrapper_configs["breakawayhondacom"] = array( 
	"entry_points" => array(
	    'new' => 'https://www.breakawayhonda.com/searchnew.aspx',
        'used' => 'https://www.breakawayhonda.com/searchused.aspx',
    ),
...
add_filter('filter_breakawayhondacom_field_price', 'filter_breakawayhondacom_field_price', 10, 3);

function filter_breakawayhondacom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $msrp_regex = '/Price:\s*<\/span>\s*[^>]+>(?<price>\$[0-9,]+)/';
