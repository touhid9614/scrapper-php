...
$scrapper_configs['bmwmotorcyclesoftampabay'] = array(
    'entry_points' => array(
        'new'   => 'https://www.eurocyclesoftampabay.com/imglib/Inventory/cache/3506/NVehInv.js?v=4463682',
        'used'  => 'https://www.eurocyclesoftampabay.com/imglib/Inventory/cache/3506/UVehInv.js?v=1959074',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory as $obj)
           {
               if($obj->type == 'U')   
               {
                   $url="https://www.eurocyclesoftampabay.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.eurocyclesoftampabay.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
                  ...
                  // 'url'               => "http://www.bmwmotorcyclesoftampabay.com/default.asp?page=xNewInventoryDetail&id={$obj->id}",
                   'url'               => $url.'&id='.$obj->id,
    ...
    add_filter('filter_bmwmotorcyclesoftampabay_field_make', 'unicodify');
    add_filter('filter_bmwmotorcyclesoftampabay_field_model', 'unicodify');

    function bmwmotorcyclesoftampabay_images_proc($image_url)
    {
