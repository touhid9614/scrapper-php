<?php
    ...
    $scrapper_configs['fikeschevy'] = array(
        'entry_points' => array(
            'new'   => 'http://www.fikeschevy.com/VehicleSearchResults?search=new',
            'used'  => 'http://www.fikeschevy.com/VehicleSearchResults?search=used'
       ),
   ...
   add_filter("filter_fikeschevy_next_page", "filter_fikeschevy_next_page",10,2);
     
     
    function filter_fikeschevy_next_page($next,$current_page) {
