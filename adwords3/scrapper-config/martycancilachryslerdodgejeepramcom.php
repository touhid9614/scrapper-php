...
$scrapper_configs["martycancilachryslerdodgejeepramcom"] = array( 
	'entry_points' => array(
        'new' => 'https://www.martycancilachryslerdodgejeepram.com/searchnew.aspx',
        'used' => 'https://www.martycancilachryslerdodgejeepram.com/searchused.aspx'
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/(?:OUR PRICE:|Sales Price:)\s*<\/span>[^>]+>(?<price>[$0-9,]+)/',
...
add_filter("filter_martycancilachryslerdodgejeepramcom_field_price", "filter_martycancilachryslerdodgejeepramcom_field_price", 10, 3);

function filter_martycancilachryslerdodgejeepramcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
