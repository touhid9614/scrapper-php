...
$scrapper_configs["powerkiacom"] = array( 
     'entry_points' => array(
        'used' => 'https://10aprxotjr-3.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=003c8cddb5b15f2cfa774c02b7a3b59e&x-algolia-application-id=10APRXOTJR',
        'new' => 'https://10aprxotjr-3.algolianet.com/1/indexes/*/queries?x-algolia-agent=Algolia%20for%20JavaScript%20(4.9.1)%3B%20Browser%20(lite)%3B%20JS%20Helper%20(3.4.4)&x-algolia-api-key=003c8cddb5b15f2cfa774c02b7a3b59e&x-algolia-application-id=10APRXOTJR',
    ),
    ...
    'custom_data_capture' => function($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            ...
            $car_data = array(
                ...
                'model' => ucwords(strtolower(preg_replace('/[^A-Za-z0-9 -]/', '', $obj->model))),
                //'trim' => ucwords(strtolower(preg_replace('/[^A-Za-z0-9 -]/', '', $obj->trim))),
                'body_style' => $obj->body,
