...
$scrapper_configs["motounitedwhittiercom"] = array( 
	 'entry_points' => array(
        'new'   => 'https://www.motounitedwhittier.com/imglib/Inventory/cache/4545/NVehInv.js?v=3494962',
        'used'  => 'https://www.motounitedwhittier.com/imglib/Inventory/cache/4545/UVehInv.js?v=7929044',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           {    
               ...
               if($obj->type == 'U')   
               {
                   $url="https://www.motounitedwhittier.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.motounitedwhittier.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
