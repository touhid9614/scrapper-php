...
$scrapper_configs["orrhondanet"] = array( 
	'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/orrhondatexarkana.csv'
        ),
        'vdp_url_regex'     => '/\.net\/auto\/(?:used|new)-/i',
        ...
        'custom_data_capture' => function($url,$data) {
            ...
            $db_connect = DbConnect::get_instance('orrhondanet');
            
            #Update
            $query = "SELECT * FROM orrhondanet_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                $car_data = [
                    ...
                    'url'           => "https://www.orrhonda.net/auto/*/" . $vehicle['VIN'],
