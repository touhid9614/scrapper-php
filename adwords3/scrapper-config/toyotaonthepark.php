<?php
    ...
    $scrapper_configs['toyotaonthepark'] = array(
        'entry_points' => array(
            'new'  => 'https://www.toyotaonthepark.ca/new-inventory/index.htm',
            'used' => 'https://www.toyotaonthepark.ca/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_toyotaonthepark_field_price", "filter_toyotaonthepark_field_price", 10, 3);
    add_filter("filter_toyotaonthepark_field_images", "filter_toyotaonthepark_field_images");
    
    
    function filter_toyotaonthepark_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_toyotaonthepark_field_images($im_urls)
    {
       $retval = array();
