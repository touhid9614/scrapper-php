...
$scrapper_configs['greatnorthgm'] = array(
     "entry_points" => array(
      'used' => 'https://www.greatnorthgm.ca/used/',
        'new' => 'https://www.greatnorthgm.ca/new/',
    ),
...
add_filter("filter_greatnorthgm_field_price", "filter_greatnorthgm_field_price", 10, 3);
add_filter("filter_greatnorthgm_field_images", "filter_greatnorthgm_field_images");

function filter_greatnorthgm_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    if ($price && numarifyPrice($price) > 0) {
        ...
        slecho("greatnorthgm Price: $price");
    }
...
function filter_greatnorthgm_field_images($im_urls) {
