<?php
    ...
    $scrapper_configs['autoparkbrampton'] = array(
        'entry_points' => array(
            'used'  => 'https://www.autoparkbrampton.ca/used/'
        ),
    ...
    add_filter("filter_autoparkbrampton_field_images", "filter_autoparkbrampton_field_images");
    add_filter("filter_autoparkbrampton_field_stock_number", "filter_autoparkbrampton_field_stock_number");
    
    function filter_autoparkbrampton_field_images($im_urls)
    {
        return array_filter($im_urls, function($im_url){
            return !endsWith($im_url, 'no_image-640x480.jpg');
        });
    }
    function filter_autoparkbrampton_field_stock_number($stock_number)
    {
