...
global $scrapper_configs;
 $scrapper_configs["mjmcguirecom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.mjmcguire.com/new-inventory/index.htm',
            'used' => 'https://www.mjmcguire.com/used-inventory/index.htm',
      ...
      'images_regx' => '/id"[^"]+"src"[^"]+"(?<img_url>[^"]+)"/',
       ...
       add_filter("filter_mjmcguirecom_field_images", "filter_mjmcguirecom_field_images");
    function filter_mjmcguirecom_field_images($im_urls)
    {
      $retval = [];
 ...
 add_filter("filter_mjmcguirecom_field_price", "filter_mjmcguirecom_field_price", 10, 3);
        function filter_mjmcguirecom_field_price($price,$car_data, $spltd_data)
        {
            $prices = [];
    ...
    if ($price && numarifyPrice($price) > 0) {
        ...
        slecho("mjmcguirecom Price: $price");
    }
