...
$scrapper_configs['livermoretoyota'] = array(
    'entry_points' => array(
        'new' => 'https://www.livermoretoyota.com/new-inventory/index.htm',
        'used' => 'https://www.livermoretoyota.com/used-inventory/index.htm',
    ),
...
add_filter("filter_livermoretoyota_field_price", "filter_livermoretoyota_field_price", 10, 3);
add_filter("filter_livermoretoyota_field_images", "filter_livermoretoyota_field_images");

function filter_livermoretoyota_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
function filter_livermoretoyota_field_images($im_urls) {
