<?php
    ...
    $scrapper_configs['paradiseautos'] = array(
        'entry_points' => array(
            'new'   => 'http://www.paradiseautos.com/VehicleSearchResults?search=new',
            'used'  => 'http://www.paradiseautos.com/VehicleSearchResults?search=preowned',
            'certified'  => 'http://www.paradiseautos.com/VehicleSearchResults?search=certified',
       ),
    ...
    add_filter("filter_paradiseautos_next_page", "filter_paradiseautos_next_page",10,2);
    
    function filter_paradiseautos_next_page($next,$current_page) {
