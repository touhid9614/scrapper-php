...
global $scrapper_configs;
 $scrapper_configs["lounsburydalhousie"] = array( 
	   'entry_points' => array(
        'new'  => 'https://www.lounsburydalhousie.com/VehicleSearchResults?search=new',
        'used' => 'https://www.lounsburydalhousie.com/VehicleSearchResults?search=preowned',
       // 'certified' => 'http://www.lounsburydalhousie.com/VehicleSearchResults?search=certified',
    ),
    'vdp_url_regex' => '/\/VehicleDetails\/(?:new|used|certified)-[0-9]{4}-\S+/',
     ...
     add_filter("filter_lounsburydalhousie_next_page", "filter_lounsburydalhousie_next_page",10,2);
     
     
    function filter_lounsburydalhousie_next_page($next,$current_page) {
