<?php
    ...
    $scrapper_configs['brazosvalleyimports'] = array(
        'entry_points' => array(
            'new'  => 'https://www.brazosvalleyimports.com/new-inventory/index.htm',
            'used' => 'https://www.brazosvalleyimports.com/used-inventory/index.htm',
           // 'certified' => 'http://www.brazosvalleyimports.com/certified-inventory/index.htm'
        ),
    ...
    add_filter("filter_brazosvalleyimports_field_price", "filter_brazosvalleyimports_field_price", 10, 3);
    add_filter("filter_brazosvalleyimports_field_images", "filter_brazosvalleyimports_field_images");
    
    
    function filter_brazosvalleyimports_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_brazosvalleyimports_field_images($im_urls)
    {
        $retval = array();
