...
$scrapper_configs["fckerbeckcadillacscom"] = array( 
	 'entry_points' => array(
       // they don't have new inveontory 
        'used' => 'https://www.fckerbeckcadillacs.com/searchused.aspx',
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/Kerbeck Price: <\/span><span[^>]+>(?<price>\$[0-9,]+)/',
