<?php
	...
	$scrapper_configs['silverhillacura'] = array(
		'entry_points' => array(
        'used' => 'https://www.silverhillacura.com/used-inventory/index.htm',
        'new' => 'https://www.silverhillacura.com/new-inventory/index.htm',
...
add_filter("filter_silverhillacura_field_price", "filter_silverhillacura_field_price", 10, 3);

function filter_silverhillacura_field_price($price, $car_data, $spltd_data) {
    $prices = [];
