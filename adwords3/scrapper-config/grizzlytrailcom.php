...
$scrapper_configs["grizzlytrailcom"] = array( 
	"entry_points" => array(
	    'used' => 'https://www.grizzlytrail.com/used/',
         'new' => 'https://www.grizzlytrail.com/new/'
    ),
...
add_filter("filter_grizzlytrailcom_field_price", "filter_grizzlytrailcom_field_price", 10, 3);

function filter_grizzlytrailcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $msrp_regex = '/<span itemprop="price" content="[^"]+">(?<price>[^\<]+)/';
    $matches = [];
