<?php
    ...
    $scrapper_configs['knightweyburnchrysler'] = array(
        'entry_points' => array(
            'new'   => 'https://www.knightweyburnchrysler.com/new-inventory/index.htm',
            'used'  => 'https://www.knightweyburnchrysler.com/used-inventory/index.htm'
        ),
     ...
     add_filter("filter_knightweyburnchrysler_field_price", "filter_knightweyburnchrysler_field_price", 10, 3);
    function filter_knightweyburnchrysler_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
