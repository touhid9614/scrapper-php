<?php
    ...
    $scrapper_configs['nipawinmotorsports'] = array(
       'entry_points' => array(
        'new'   => 'https://www.nipawinmotorsports.com/imglib/Inventory/cache/5685/NVehInv.js?v=3820707',
        'used'  => 'https://www.nipawinmotorsports.com/imglib/Inventory/cache/5685/UVehInv.js?v=5946287',
    ),
    ...
    'picture_nexts'     => ['#invUnitCarousel .carousel-nav a.right.next'],
    'picture_prevs'     => ['#invUnitCarousel .carousel-nav a.left'],
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           {    
               ...
               if($obj->type == 'U')   
               {
                   $url="https://www.nipawinmotorsports.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.nipawinmotorsports.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
