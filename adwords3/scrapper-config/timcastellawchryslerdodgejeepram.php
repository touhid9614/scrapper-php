...
global $scrapper_configs;
 $scrapper_configs["timcastellawchryslerdodgejeepram"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.timcastellawchryslerdodgejeepram.com/search-all-inventory.html',
    ...
    function filter_tryuscars_field_price($price,$car_data, $spltd_data)
    {
        ...
        $internet_regex  =  '/Internet Price\s*<\/span>\s*<span[^>]+>(?<price>[$0-9,]+)/';
