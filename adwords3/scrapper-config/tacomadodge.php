...
global $scrapper_configs;
 $scrapper_configs["tacomadodge"] = array( 
	  'entry_points' => array(
        'used' => 'https://www.tacomadodge.com/used-inventory/index.htm',
        'new' => 'https://www.tacomadodge.com/new-inventory/index.htm',
...
add_filter("filter_tacomadodge_field_price", "filter_tacomadodge_field_price", 10, 3);

function filter_tacomadodge_field_price($price, $car_data, $spltd_data) {
    $prices = [];
