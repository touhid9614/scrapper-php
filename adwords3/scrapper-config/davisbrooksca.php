...
$scrapper_configs["davisbrooksca"] = array( 
	"entry_points" => array(
	    'used' => 'https://www.davisbrooks.ca/used/',
        'new' => 'https://www.davisbrooks.ca/new/'
    ),
...
add_filter("filter_davisbrooksca_field_price", "filter_davisbrooksca_field_price", 10, 3);

function filter_davisbrooksca_field_price($price, $car_data, $spltd_data) {
    $prices = [];
