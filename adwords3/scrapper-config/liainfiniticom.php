...
$scrapper_configs["liainfiniticom"] = array( 
	 'entry_points' => array(
            'new'   => 'https://www.liainfiniti.com/searchnew.aspx?Dealership=Lia%20INFINITI',
            'used'  => 'https://www.liainfiniti.com/searchused.aspx?Dealership=Lia%20INFINITI',
        ),
        'use-proxy' => true,
     ...
     add_filter("filter_liainfiniticom_field_price", "filter_liainfiniticom_field_price", 10, 3);
    
    function filter_liainfiniticom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $retail_regex    =  '/Our Price:\s*[^>]+>[^>]+>(?<price>[$0-9,]+)/';
