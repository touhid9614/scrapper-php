...
$scrapper_configs['400infiniti'] = array(
    'entry_points' => array(
        'new' => 'https://www.400infiniti.com/new-inventory/index.htm',
        'used' => 'https://www.400infiniti.com/used-inventory/index.htm'
    ),
...
add_filter("filter_400infiniti_field_price", "filter_400infiniti_field_price", 10, 3);

function filter_400infiniti_field_price($price, $car_data, $spltd_data) {
    $prices = [];
