...
global $scrapper_configs;
 $scrapper_configs["revolutionautogroup"] = array( 
	  'entry_points' => array(
            
            'used' => 'https://www.revolutionautogroup.ca/inventory/?condition=used'
        ),
    ...
    add_filter("filter_revolutionautogroup_field_price", "filter_revolutionautogroup_field_price", 10, 3);

    function filter_revolutionautogroup_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
...
add_filter('filter_revolutionautogroup_car_data', 'filter_revolutionautogroup_car_data');
function filter_revolutionautogroup_car_data($car_data) {
