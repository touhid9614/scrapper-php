...
$scrapper_configs["mcmautoscom"] = array( 
	"entry_points" => array(
...
add_filter('filter_mcmautoscom_post_data', 'filter_mcmautoscom_post_data', 10, 2);

function filter_mcmautoscom_post_data($post_data, $stock_type) {
    if ($stock_type == 'new') {
...
add_filter('filter_for_fb_mcmautoscom', 'filter_for_fb_mcmautoscom', 10, 2);

function filter_for_fb_mcmautoscom($car_data, $feed_type)
{
