...
$scrapper_configs["apollorvsalesconz"] = array( 
	'entry_points'        => array(
        'new'  => 'https://www.apollorvsales.co.nz/DesktopModules/NetEngine.Modules.Api/API/VehicleSearch/Search?limit=1000&listingType=new&offset=0&sort=featured%20desc',
        'used' => 'https://www.apollorvsales.co.nz/DesktopModules/NetEngine.Modules.Api/API/VehicleSearch/Search?limit=30&listingType=used&offset=0&sort=featured%20desc',
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects as $obj) {
            ...
            $car_data = array(
                ...
                'url' 		 => "https://www.apollorvsales.co.nz/vehicle-detail?id=" . $obj->Id,
