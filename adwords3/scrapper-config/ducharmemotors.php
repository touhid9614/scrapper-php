<?php
    ...
    $scrapper_configs['ducharmemotors'] = array(
        'entry_points' => array(
            'new'    => 'https://www.ducharmemotors.com/inventory/search?stock_type=New&page=1&page_length=1000',
            'used'   => 'https://www.ducharmemotors.com/inventory/search?page=1&page_length=1000&stock_type=Used'
        ),
        ...
        'custom_data_capture' => function($url, $resp){
            ...
            foreach($inventory as $obj)
            {
                $car_data = array(
                    ...
                    'url'               => "https://www.ducharmemotors.com/inventory/" . strtolower($obj->stock_type) .
    ...
    add_filter("filter_ducharmemotors_field_images", "filter_ducharmemotors_field_images");
    
    function filter_ducharmemotors_field_images($im_urls)
    {
