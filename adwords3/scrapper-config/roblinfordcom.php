...
$scrapper_configs["roblinfordcom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.roblinford.com/used/',
        'new' => 'https://www.roblinford.com/new/',
    ),
    ...
    'details_end_tag' => '<!-- Footer End -->',
    'details_spliter' => 'itemid="',
...
add_filter("filter_roblinfordcom_field_price", "filter_roblinfordcom_field_price", 10, 3);

function filter_roblinfordcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
add_filter('filter_roblinfordcom_car_data', 'filter_roblinfordcom_car_data');

function filter_roblinfordcom_car_data($car_data)
{               
            
    if(strpos($car_data['all_images'],"vehicles_images_coming")){
        $car_data['all_images']="";
    }
