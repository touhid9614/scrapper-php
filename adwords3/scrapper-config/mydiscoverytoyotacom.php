...
$scrapper_configs["mydiscoverytoyotacom"] = array( 
	 "entry_points" => array(
        'new' => 'https://www.mydiscoverytoyota.com/searchnew.aspx',
        'used' => 'https://www.mydiscoverytoyota.com/searchused.aspx'
    ),
...
add_filter('filter_mydiscoverytoyotacom_field_price', 'filter_mydiscoverytoyotacom_field_price', 10, 3);

function filter_mydiscoverytoyotacom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    $retail_regex = '/Internet Price\s*<\/span><[^>]+>(?<price>[^<]+)/';
