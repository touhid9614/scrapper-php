...
$scrapper_configs["hyundaigalleryca"] = array( 
	'entry_points' => array(
            'used'   => 'https://www.hyundaigallery.ca/en/used-inventory/api/listing?limit=500', 
            'new'   => 'https://www.hyundaigallery.ca/en/new-inventory/api/listing?limit=500',  
        ...
        'srp_page_regex'      => '/\/(?:new|used|certified)-inventory/i',
                   ...
                   $to_return = array();
                       ...
                       $car_data = array(
                           ...
                           'url'               => "https://www.hyundaigallery.ca/en/" . $stock_type . "-inventory/" . strtolower($obj->make->name) . '/' . strtolower($obj->model->name) . '/'  . $obj->year . '-' . strtolower($obj->make->name) . '-' . strtolower($obj->model->name) . '-id' . $obj->vehicleId,
