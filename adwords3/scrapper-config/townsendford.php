...
global $scrapper_configs;
 $scrapper_configs["townsendford"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.townsendford.net/new-inventory/index.htm',
            'used'  => 'https://www.townsendford.net/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_townsendford_field_price", "filter_townsendford_field_price", 10, 3);
    add_filter("filter_townsendford_field_images", "filter_townsendford_field_images");
    function filter_townsendford_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_townsendford_field_images($im_urls)
    {
        $retval = [];
