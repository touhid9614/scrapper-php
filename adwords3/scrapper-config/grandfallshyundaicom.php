...
$scrapper_configs["grandfallshyundaicom"] = array( 
	'entry_points' => array(
		'new'   => 'https://www.grandfallshyundai.com/new/',
		'used'  => 'https://www.grandfallshyundai.com/used/',
	),
	...
	'details_end_tag'   => 'data-loc="footer"',
...
add_filter("filter_grandfallshyundaicom_field_price", "filter_grandfallshyundaicom_field_price", 10, 3);
add_filter("filter_grandfallshyundaicom_field_images", "filter_grandfallshyundaicom_field_images");
function filter_grandfallshyundaicom_field_price($price,$car_data, $spltd_data)
{
	$prices = [];
	...
	if($price && numarifyPrice($price) > 0) {
		...
		slecho("grandfallshyundaicom Price: $price");
	}
...
function filter_grandfallshyundaicom_field_images($im_urls)
{
