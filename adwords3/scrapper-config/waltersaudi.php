<?php
    ...
    $scrapper_configs['waltersaudi'] = array(
        'entry_points' => array(
            'new'  => 'https://www.waltersaudi.com/new-inventory/index.htm',
            //'certified' => 'https://www.waltersaudi.com/certified-inventory/index.htm',
           // 'used' => 'https://www.waltersaudi.com/used-inventory/index.htm',
    ...
    add_filter("filter_waltersaudi_field_price", "filter_waltersaudi_field_price", 10, 3);
    add_filter('filter_waltersaudi_field_images','filter_waltersaudi_field_images');

    function filter_waltersaudi_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_waltersaudi_field_images($im_urls)
    {
