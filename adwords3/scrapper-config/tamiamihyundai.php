...
$scrapper_configs["tamiamihyundai"] = array(
     'entry_points' => array(
...
add_filter('filter_tamiamihyundai_post_data', 'filter_tamiamihyundai_post_data', 10, 2);
 add_filter("filter_tamiamihyundai_field_images", "filter_tamiamihyundai_field_images");
 function filter_tamiamihyundai_field_images($im_urls)
    {
