...
$scrapper_configs["liverpoolnissancomau"] = array( 
	"entry_points" => array(
            'all'  => 'https://www.liverpoolnissan.com.au/all-stock/list/?q=perpage%3A30',
            'new'   => 'https://www.liverpoolnissan.com.au/new-nissan-liverpool/?q=perpage%3A30',
            'used'  => 'https://www.liverpoolnissan.com.au/used-nissan-liverpool/?q=perpage%3A30',
	       
           

             'demo'  => 'https://www.liverpoolnissan.com.au/nissan-demos-liverpool/?q=perpage%3A30',
        
    ),
    'use-proxy' => true,
     'vdp_url_regex'          => '/\/(?:new|used|certified-used|demo|all-stock|nissan-demos-liverpool).*\/view\/[0-9]{4}-/i',
...
add_filter('filter_liverpoolnissancomau_car_data', 'filter_liverpoolnissancomau_car_data');

function filter_liverpoolnissancomau_car_data($car_data) {
