...
$scrapper_configs["woodgrovechryslercom"] = array(
    'entry_points' => array(
    ...
    'custom_data_capture'   => function($url, $data){
        ...
        foreach($objects->results[0]->hits as $obj)
        {
            ...
            $car_data = array(
                ...
                'make'              => $obj->make,
                'model'             => $obj->model,
                'trim'              => str_replace(array("'",'"', '/', "-") , '', $obj->trim),
                'body_style'        => $obj->body,
                'price'             => $obj->our_price,
