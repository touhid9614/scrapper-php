...
$scrapper_configs["huffineschevylewisvillecom"] = array( 
    
     'entry_points' => array(
        'used' => 'https://www.huffineschevylewisville.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new' => 'https://www.huffineschevylewisville.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1'
    ),
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                   ...
                   // 'images'            => array_merge($obj->photos->user, $obj->photos->stock),    
                    'url' => "https://www.huffineschevylewisville.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_huffineschevylewisvillecom_next_page", "filter_huffineschevylewisvillecom_next_page", 10, 2);       
 function filter_huffineschevylewisvillecom_next_page($next, $current_page) {
...
//    'entry_points' => array(
//        'used'  => 'https://www.huffineschevylewisville.com/used-inventory/index.htm',
//       ),
...
//  
//      "custom_data_capture" => function ($url, $data) {
//          $site                 = "https://www.huffineschevylewisville.com/sitemap.xml";
//          $vdp_url_regex        = '/\/(?:new|used)\/[^\/]+\/[0-9]{4}-/i';
