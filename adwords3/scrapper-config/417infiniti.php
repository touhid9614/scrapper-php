...
$scrapper_configs['417infiniti'] = array(
    'entry_points' => array(
        'new' => 'https://www.417infiniti.com/new-inventory/index.htm',
        'used' => 'https://www.417infiniti.com/used-inventory/index.htm'
    ),
...
add_filter("filter_417infiniti_field_price", "filter_417infiniti_field_price", 10, 3);

function filter_417infiniti_field_price($price, $car_data, $spltd_data) {
    $prices = [];
