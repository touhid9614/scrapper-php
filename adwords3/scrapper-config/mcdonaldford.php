...
$scrapper_configs["mcdonaldford"] = array(
    "entry_points" => array(
        'new' => 'https://www.mcdonaldford.com/searchnew.aspx',
        'used' => 'https://www.mcdonaldford.com/searchused.aspx'
    ),
...
add_filter("filter_mcdonaldford_field_price", "filter_mcdonaldford_field_price", 10, 3);

function filter_mcdonaldford_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
add_filter("filter_mcdonaldford_field_images", "filter_mcdonaldford_field_images");
    
    function filter_mcdonaldford_field_images($im_urls)
    {
       if(count($im_urls)<2)
            {
            return [];
