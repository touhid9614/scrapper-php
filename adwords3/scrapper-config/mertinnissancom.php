...
$scrapper_configs["mertinnissancom"] = array( 
	"entry_points" => array(
         'new' => 'https://www.mertinnissan.com/new/',
	    'used' => 'https://www.mertinnissan.com/used/',
...
add_filter("filter_mertinnissancom_field_price", "filter_mertinnissancom_field_price", 10, 3);

function filter_mertinnissancom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
