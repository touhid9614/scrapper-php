...
$scrapper_configs['maseratiofoakville'] = array(
    'entry_points' => array(
        'used' => 'https://www.maseratiofoakville.net/used/',
    ),
...
//add_filter("filter_maseratiofoakville_field_price", "filter_maseratiofoakville_field_price", 10, 3);
//add_filter("filter_maseratiofoakville_field_images", "filter_maseratiofoakville_field_images");
//
//function filter_maseratiofoakville_field_price($price, $car_data, $spltd_data) {
//    $prices = [];
//
//    slecho('');
//
...
//        slecho("maseratiofoakville Price: $price");
//    }
//
...
//}
//
//function filter_maseratiofoakville_field_images($im_urls) {
//    if (count($im_urls) <= 2) {
//        return $im_urls;
//    } else {
...
//}
//
//add_filter("filter_maseratiofoakville_next_page", "filter_maseratiofoakville_next_page", 10, 2);
//
//function filter_maseratiofoakville_next_page($next, $current_page) {
