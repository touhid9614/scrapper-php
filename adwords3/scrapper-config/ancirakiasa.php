<?php
    ...
    $scrapper_configs['ancirakiasa'] = array(

        'entry_points' => array(
                'new' => 'https://www.ancirakiasa.com/searchnew.aspx',
                'used'=> 'https://www.ancirakiasa.com/used-cars.html'
        ),
     ...
     add_filter("filter_ancirakiasa_field_images", "filter_ancirakiasa_field_images");
     add_filter('filter_ancirakiasa_field_price', 'filter_ancirakiasa_field_price',10,3);

        function filter_ancirakiasa_field_images($im_urls)
        {
    ...
    function filter_ancirakiasa_field_price($price,$car_data,$spltd_data)
    {
        $prices = [];
