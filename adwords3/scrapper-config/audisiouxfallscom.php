...
$scrapper_configs["audisiouxfallscom"] = array( 
	"entry_points" => array(

	    'new' => 'https://www.audisiouxfalls.com/new-inventory/index.htm',
        'used' => 'https://www.audisiouxfalls.com/used-inventory/index.htm'
    ),
