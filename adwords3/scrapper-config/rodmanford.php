...
$scrapper_configs["rodmanford"] = array(
    'entry_points' => array(
        'new' => 'https://www.rodmanford.com/searchnew.aspx',
        'used' => 'https://www.rodmanford.com/searchused.aspx',
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/Rodman Price.*\s*<\/span><span[^>]+>\$(?<price>[^<]+)/',
...
add_filter('filter_rodmanford_field_price', 'filter_rodmanford_field_price', 10, 3);

function filter_rodmanford_field_price($price, $car_data, $spltd_data) {
    $prices = [];
