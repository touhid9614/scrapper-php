...
$scrapper_configs["toyotaofirving"] = array(
    'entry_points'        => array(
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->results[0]->hits as $obj) {
            $car_data = array(
                ...
                'trim'           => $obj->trim,
                'body_style'     => $obj->body,
                'stock_type'     => ($obj->type == 'Pre-Owned') ? "used" : (($obj->type == 'Certified Pre-Owned') ? "used" : "new"),
