...
global $scrapper_configs;
 $scrapper_configs["lonestaryamahacom"] = array( 
	  'entry_points' => array(
        'new' => 'https://www.lonestaryamaha.com/imglib/Inventory/cache/2176/NVehInv.js?v=2665495',
        'used' => 'https://www.lonestaryamaha.com/imglib/Inventory/cache/2176/UVehInv.js?v=5641416',
    ),
    ...
    'custom_data_capture' => function($url, $data) {
        ...
        foreach ($objects as $obj) {
            if ($obj->type == 'U') {
                $url = "https://www.lonestaryamaha.com/default.asp?page=xPreOwnedInventoryDetail";
            } else {
                $url = "https://www.lonestaryamaha.com/default.asp?page=xNewInventoryDetail";
            }
            $car_data = array(
