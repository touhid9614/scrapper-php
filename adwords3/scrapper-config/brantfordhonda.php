...
global $scrapper_configs;
 $scrapper_configs["brantfordhonda"] = array( 
	  'entry_points' => array(
            'new'   => 'https://www.brantfordhonda.com/wp-json/strathcom/vehicles/search?language=en&stock_type=New&make=Honda&page=1&page_length=1000',
            'used'   => 'https://www.brantfordhonda.com/wp-json/strathcom/vehicles/search?language=en&stock_type=Used&page=1&page_length=1000',
        ...
        'custom_data_capture' => function($url, $resp){
            ...
            foreach($inventory as $obj)
            {
                $car_data = array(
                    ...
                    'url'               => "https://www.brantfordhonda.com/inventory/" . strtolower($obj->stock_type) .
...
add_filter("filter_brantfordhonda_field_images", "filter_brantfordhonda_field_images");       
function filter_brantfordhonda_field_images($im_urls) {
