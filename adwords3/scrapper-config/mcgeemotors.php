...
$scrapper_configs['mcgeemotors'] = array(
    'entry_points' => array(
        'new'  => 'http://www.mcgeemotors.ca/VehicleSearchResults?search=new',
        'used' => 'http://www.mcgeemotors.ca/VehicleSearchResults?search=preowned',
    ),
...
//        'stock_type'     => '/<a itemprop="url" .*\/VehicleDetails\/(?<stock_type>[^\-]+)/',
    ...
    'data_capture_regx_full' => array(
     ...
     add_filter("filter_mcgeemotors_next_page", "filter_mcgeemotors_next_page",10,2);
     
     
    function filter_mcgeemotors_next_page($next,$current_page) {
