...
global $scrapper_configs;
 $scrapper_configs["maddigandodge"] = array( 
	 'entry_points' => array(
        'new' => 'https://www.maddigandodge.com/new-inventory/index.htm',
        'used' => 'https://www.maddigandodge.com/used-inventory/index.htm'
    ),
...
add_filter("filter_maddigandodge_field_price", "filter_maddigandodge_field_price", 10, 3);
add_filter("filter_maddigandodge_field_images", "filter_maddigandodge_field_images");

function filter_maddigandodge_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
function filter_maddigandodge_field_images($im_urls) {
    if (count($im_urls) < 2)
        return [];
    return $im_urls;
}
