...
$scrapper_configs["bmwmarkhamcom"] = array( 
	 'entry_points' => array(
             'used'  => 'https://www.bmwmarkham.com/used/',
            'new'   => 'https://www.bmwmarkham.com/new/',
    ...
    add_filter("filter_bmwmarkhamcom_field_price", "filter_bmwmarkhamcom_field_price", 10, 3);
    add_filter("filter_bmwmarkhamcom_field_images", "filter_bmwmarkhamcom_field_images");
    function filter_bmwmarkhamcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_bmwmarkhamcom_field_images($im_urls)
    {
