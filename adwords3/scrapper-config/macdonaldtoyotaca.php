...
$scrapper_configs["macdonaldtoyotaca"] = array(
    'entry_points' => array(
        'new' => 'https://www.macdonaldtoyota.ca/en/for-sale/car/new',
        'used' => 'https://www.macdonaldtoyota.ca/en/for-sale/all/used'
    ),
    'use-proxy' => true,
...
add_filter("filter_macdonaldtoyotaca_field_images", "filter_macdonaldtoyotaca_field_images", 10, 2);

function filter_macdonaldtoyotaca_field_images($im_urls, $car_data) {
    $retval = array();
