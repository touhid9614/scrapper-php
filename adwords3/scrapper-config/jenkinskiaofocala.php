...
$scrapper_configs['jenkinskiaofocala'] = array(
    'entry_points' => array(
          'new' => 'https://www.jenkinskiaofocala.com/new-inventory/index.htm',
         'used'  => 'https://www.jenkinskiaofocala.com/used-inventory/index.htm',
    ...
    add_filter("filter_jenkinskiaofocala_field_price", "filter_jenkinskiaofocala_field_price", 10, 3);
    add_filter("filter_jenkinskiaofocala_field_images", "filter_jenkinskiaofocala_field_images");
    
    function filter_jenkinskiaofocala_field_images($im_urls)
    {
       $retval = array();
    ...
    function filter_jenkinskiaofocala_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
