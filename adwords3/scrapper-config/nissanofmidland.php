...
global $scrapper_configs;
 $scrapper_configs["nissanofmidland"] = array( 
	 'entry_points' => array(
            
        'used' => 'https://www.nissanofmidland.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
        'new' => 'https://www.nissanofmidland.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1',
    ),
        ...
        'custom_data_capture' => function($url, $data) {
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                    ...
                    'url' => "https://www.nissanofmidland.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
 ...
 add_filter("filter_nissanofmidland_next_page", "filter_nissanofmidland_next_page", 10, 2);       
 function filter_nissanofmidland_next_page($next, $current_page) {
