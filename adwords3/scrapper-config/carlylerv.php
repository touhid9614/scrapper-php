...
global $scrapper_configs;
 $scrapper_configs["carlylerv"] = array( 
	'entry_points' => array(
        'new'   => 'https://www.carlylerv.com/imglib/Inventory/cache/1835/NVehInv.js?v=7703001',
        'used'  => 'https://www.carlylerv.com/imglib/Inventory/cache/1835/UVehInv.js?v=1973493',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           {    
               ...
               if($obj->type == 'U')   
               {
                   $url="https://www.carlylerv.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.carlylerv.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
                  ...
                  // 'url'               => "http://www.carlylerv.com/default.asp?page=xNewInventoryDetail&id={$obj->id}",
                   'url'               => $url.'&id='.$obj->id,
    ...
    add_filter('filter_carlylerv_field_make', 'unicodify');
    add_filter('filter_carlylerv_field_model', 'unicodify');

    function carlylerv_images_proc($image_url)
    {
