...
$scrapper_configs["jaguarrichfieldcom"] = array( 
	'entry_points' => array(
        ...
        'vdp_url_regex'         => '/\/inventory\/(?:new|certified|used|certified-used)-[0-9]{4}-/',
        'use-proxy'         => true,
        'refine'            => false,
        'init_method'       => 'POST',
        'next_method'       => 'POST',
...
add_filter('filter_jaguarrichfieldcom_post_data', 'filter_jaguarrichfieldcom_post_data', 10, 2);
 add_filter("filter_jaguarrichfieldcom_field_images", "filter_jaguarrichfieldcom_field_images");
 function filter_jaguarrichfieldcom_field_images($im_urls)
    {
