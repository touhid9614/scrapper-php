...
$scrapper_configs["shearervt"] = array(
    "entry_points" => array(
        'new' => 'https://www.shearervt.com/VehicleSearchResults?search=new',
        'used' => 'https://www.shearervt.com/VehicleSearchResults?search=preowned'
    ),
...
add_filter("filter_shearervt_next_page", "filter_shearervt_next_page",10,2);

function filter_shearervt_next_page($next,$current_page) {
