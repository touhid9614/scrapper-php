...
$scrapper_configs["fortwaynesubaru"] = array(
    "entry_points" => array(
        'new' => 'https://www.fortwaynesubaru.com/new-inventory/index.htm',
        'used' => 'https://www.fortwaynesubaru.com/used-inventory/index.htm',
        'certified' => 'https://www.fortwaynesubaru.com/certified-inventory/index.htm'
    ),
...
add_filter("filter_fortwaynesubaru_field_price", "filter_fortwaynesubaru_field_price", 10, 3);
add_filter("filter_fortwaynesubaru_field_images", "filter_fortwaynesubaru_field_images");

function filter_fortwaynesubaru_field_images($im_urls) {
    $retval = array();
...
function filter_fortwaynesubaru_field_price($price, $car_data, $spltd_data) {
    $prices = [];
