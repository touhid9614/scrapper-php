...
global $scrapper_configs;
 $scrapper_configs["cutterdodgechryslerjeepofpearlcity"] = array( 
	  'entry_points' => array(
...
add_filter('filter_cutterdodgechryslerjeepofpearlcity_post_data', 'filter_cutterdodgechryslerjeepofpearlcity_post_data', 10, 2);

function filter_cutterdodgechryslerjeepofpearlcity_post_data($post_data, $stock_type)
{
    if($stock_type == 'new')
    {
