...
$scrapper_configs["liachryslerjeepdodgeramnorthamptoncom"] = array(
    "entry_points" => array(
        'new' => 'https://www.liachryslerjeepdodgeramnorthampton.com/searchnew.aspx?Dealership=Lia%20Chrysler%20Jeep%20Dodge%20Ram%20Northampton',
        'used' => 'https://www.liachryslerjeepdodgeramnorthampton.com/searchused.aspx?Dealership=Lia%20Chrysler%20Jeep%20Dodge%20Ram%20Northampton',
    ),
    ...
    'data_capture_regx' => array(
        ...
        'price' => '/Price:\s*<\/span><[^>]+>(?<price>[^<]+)/',
        'vin' => '/<strong>VIN\s*#:\s*<\/strong>[^>]+>(?<vin>[^<]+)/',
    ),
    'data_capture_regx_full' => array(
    ),
    'next_page_regx' => '/<a\s*href="(?<next>[^"]+)"\s*class="stat-arrow-next"\s*data-loc="available inventory">[^<]+<i\s*class="fa\s*fa-angle-right"/',
    'images_regx' => '/zoom feature element -->\s*<img src="(?<img_url>[^\?]+)/',
);


add_filter('filter_liachryslerjeepdodgeramnorthamptoncom_field_price', 'filter_liachryslerjeepdodgeramnorthamptoncom_field_price', 10, 3);

function filter_liachryslerjeepdodgeramnorthamptoncom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
