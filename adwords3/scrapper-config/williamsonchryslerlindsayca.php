...
$scrapper_configs["williamsonchryslerlindsayca"] = array( 
	"entry_points" => array(
	    'used' => 'https://www.williamsonchryslerlindsay.ca/used/',
        'new' => 'https://www.williamsonchryslerlindsay.ca/new/',
    ),
...
add_filter("filter_williamsonchryslerlindsayca_field_price", "filter_williamsonchryslerlindsayca_field_price", 10, 3);

function filter_williamsonchryslerlindsayca_field_price($price, $car_data, $spltd_data) {
    $prices = [];
