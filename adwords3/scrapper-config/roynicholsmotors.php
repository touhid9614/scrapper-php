...
$scrapper_configs['roynicholsmotors'] = array(
    'entry_points' => array(
             'new'   => 'https://www.roynicholsmotors.com/new/',
             'used'  => 'https://www.roynicholsmotors.com/used/',
        ),
    ...
    add_filter("filter_roynicholsmotors_field_price", "filter_roynicholsmotors_field_price", 10, 3);
   
    function filter_roynicholsmotors_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
...
add_filter('filter_for_fb_roynicholsmotors', 'filter_for_fb_roynicholsmotors', 10, 2);

function filter_for_fb_roynicholsmotors($car_data, $feed_type)
{
     if(strpos($car_data['all_images'],"Defualt-Image") ){
                   return null;
                }
