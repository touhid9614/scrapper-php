...
global $scrapper_configs;
    ...
    $scrapper_configs['mungenastmitsubishi'] = array(
        'entry_points' => array(
            'new'  => 'https://www.mungenastmitsubishi.com/new-inventory/index.htm',
            'used' => 'https://www.mungenastmitsubishi.com/used-inventory/index.htm',
        ),
    ...
    add_filter("filter_mungenastmitsubishi_field_price", "filter_mungenastmitsubishi_field_price", 10, 3);
    function filter_mungenastmitsubishi_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
