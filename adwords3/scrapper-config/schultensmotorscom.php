...
$scrapper_configs["schultensmotorscom"] = array( 
	  'entry_points' => array(
            'new'  => 'http://www.schultensmotors.com/new-inventory/index.htm',
            'used' => 'http://www.schultensmotors.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_schultensmotorscom_field_price", "filter_schultensmotorscom_field_price", 10, 3);
    add_filter("filter_schultensmotorscom_field_images", "filter_schultensmotorscom_field_images");
    
    
    function filter_schultensmotorscom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_schultensmotorscom_field_images($im_urls)
    {
