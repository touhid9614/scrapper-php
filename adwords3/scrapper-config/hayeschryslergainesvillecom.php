...
global $scrapper_configs;
 $scrapper_configs["hayeschryslergainesvillecom"] = array( 
	 'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/MP6547.csv'
        ),
        ...
        'custom_data_capture' => function($url,$data) {
            ...
            $db_connect = DbConnect::get_instance('hayeschryslergainesvillecom');
            
            #Update
            $query = "SELECT * FROM hayeschryslergainesvillecom_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
            ...
            foreach($vehicles as $vehicle) {
                $car_data = [
                    ...
                    'url'           => "https://www.hayeschryslergainesville.com/auto/*/" . $vehicle['VIN'],
