...
$scrapper_configs['kootenaychrysler'] = array(
    'entry_points' => array(
        'new' => 'https://www.kootenaychryslerdealer.com/new-inventory/index.htm',
        'used' => 'https://www.kootenaychryslerdealer.com/used-inventory/index.htm'
    ),
...
add_filter("filter_kootenaychrysler_field_price", "filter_kootenaychrysler_field_price", 10, 3);

function filter_kootenaychrysler_field_price($price, $car_data, $spltd_data) {
    $prices = [];
