<?php
    ...
    $scrapper_configs['mattford'] = array(
        'entry_points' => array(
            'new'   => 'http://www.mattford.com/new-ford-kansas-city-mo',
            'used'  => 'http://www.mattford.com/used-cars-kansas-city-mo'
        ),
        ...
        'data_capture_regx_full' => array(
            'trim'          => '/Trim<\/div>\s*<div[^>]+>(?<trim>[^<]+)/',
            'model'         => '/Model<\/div>\s*<div[^>]+>(?<model>[^<]+)/',
            'body_style'    => '/Body<\/div>\s*<div[^>]+>(?<body_style>[^<]+)/',
            'interior_color'=> '/Interior Color<\/div>\s*<div[^>]+>(?<interior_color>[^<]+)/',
            'kilometres'    => '/Mileage<\/div>\s*<div[^>]+>(?<kilometres>[^<]+)/',
        ),
