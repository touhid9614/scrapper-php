...
$scrapper_configs["briantoliverford"] = array(
    'entry_points' => array(
        'used'  => 'https://www.briantoliverford.net/used-inventory/index.htm',
       ),
      ...
      "custom_data_capture" => function ($url, $data) {
          $site                 = "https://www.briantoliverford.net/sitemap.xml";
          $vdp_url_regex        = '/\/(?:new|used)\/[^\/]+\/[0-9]{4}-/i';
          ...
          foreach ($cars as $car) {
              ...
              if(strpos($car['all_images'],"unavailable_stockphoto") ){
                    $car['all_images']="";
                }
   ...
   add_filter("filter_briantoliverford_field_images", "filter_briantoliverford_field_images");
    
    function filter_briantoliverford_field_images($im_urls)
    {
...
// 'entry_points' => array(
//            'new'  => 'https://www.briantoliverford.net/new-inventory/index.htm',
