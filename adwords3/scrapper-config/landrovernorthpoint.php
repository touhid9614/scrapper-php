<?php
    ...
    $scrapper_configs['landrovernorthpoint'] = array(
        'entry_points' => array(
           //  'new' => 'https://www.landrovernorthatlanta.com/new-inventory/index.htm',
          //   'used'=> 'https://www.landrovernorthatlanta.com/used-inventory/index.htm',
            'certified'   => 'http://www.landrovernorthatlanta.com/certified-inventory/index.htm',
 ...
 add_filter("filter_landrovernorthpoint_field_price", "filter_landrovernorthpoint_field_price", 10, 3);
    function filter_landrovernorthpoint_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
