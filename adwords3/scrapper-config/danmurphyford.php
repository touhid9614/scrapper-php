<?php
    ...
    $scrapper_configs['danmurphyford'] = array(
        'entry_points' => array(
            'all'   => 'https://danmurphyford.com/data/inventory.json?ts=' . time(),
         ),
        ...
        'custom_data_capture'   => function($url, $data){
            ...
            foreach($objects->vehicles as $obj)
            {
                $car_data = array(
                    ...
                    'url'               => "https://www.danmurphyford.com/view/" . strtolower($obj->condition) .
              ...
              $details_url = "https://danmurphyford.com/data/{$obj->id}.json?{$obj->timestamp}";
