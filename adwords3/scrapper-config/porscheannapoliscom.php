...
$scrapper_configs["porscheannapoliscom"] = array( 
	'entry_points' => array(
        'used' => 'https://www.porscheannapolis.com/used-inventory/index.htm',
        'new' => 'https://www.porscheannapolis.com/new-inventory/index.htm',
    ...
    add_filter("filter_porscheannapoliscom_field_price", "filter_porscheannapoliscom_field_price", 10, 3);
    add_filter("filter_porscheannapoliscom_field_images", "filter_porscheannapoliscom_field_images");
    function filter_porscheannapoliscom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
       ...
       $conditional_regex       =  '/Internet Price[^>]+>:<\/span><\/span>[^>]+>(?<price>\$[0-9,]+)/';
    ...
    function filter_porscheannapoliscom_field_images($im_urls)
    {
           $retval = [];
