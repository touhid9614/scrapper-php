...
global $scrapper_configs;
 $scrapper_configs["kamloopsdodge"] = array( 
	 'entry_points' => array(
            'new'   => 'https://www.kamloopsdodge.com/new-inventory/index.htm',
            'used'  => 'https://www.kamloopsdodge.com/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_kamloopsdodge_field_images", "filter_kamloopsdodge_field_images");
    add_filter("filter_kamloopsdodge_field_price", "filter_kamloopsdodge_field_price", 10, 3);

    function filter_kamloopsdodge_field_images($im_urls)
    {
       $retval = array();
    ...
    function filter_kamloopsdodge_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
