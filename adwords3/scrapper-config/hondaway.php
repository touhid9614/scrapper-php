...
$scrapper_configs["hondaway"] = array(
    'entry_points' => array(
        'new' => 'https://www.hondaway.com/en/new-catalog',
    ...
    'used' => array(
        ...
        'custom_data_capture' => function($url, $data) {
            ...
            if ($objects->data->searchVehicles->__typename == 'UsedVehicleConnection') {
                foreach ($objects->data->searchVehicles->nodes as $obj) {
                    ...
                    $car_data = array(
                        ...
                        'url' => "https://www.hondaway.com/en/used-inventory/" . $obj->make->name . '/' . $obj->model->name . '/' . $obj->year . '/' . $obj->year . '-' . $obj->make->name . '-' . $obj->model->name . '-id' . $obj->id,
            ...
            /*  else 
              ...
              'vin'               => $obj->vin,
              'drivetrain'        => $obj->characteristics->transmission->driveTrain->label,
              'url'               => "https://www.hondaway.com/en/new-inventory/" . $obj->make->name . '/' . $obj->model->name . '/' . $obj->year . '/' . $obj->year . '-' . $obj->make->name . '-' . $obj->model->name . '-id' . $obj->id,
              'all_images'         => "https://img.sm360.ca/ir/w360h197c/images/" . $obj->matchedCatalogVehicle->multimedia->exteriorPictures->side->url,
              );
              $images = [];
              foreach ($obj->multimedia->pictures as $picture) {
              $images[] = 'https://img.sm360.ca/images/inventory' . $picture->url;
    ...
    'new' => array(
        ...
        'custom_data_capture' => function($url, $resp) {
            ...
            $inventory = hondaway_get_newInventory($url, $resp);
            ...
            foreach ($inventory as $url) {
                ...
                $data_capture_regx_full = array(
                    ...
                    'price' => '/starting at:\s*<\/span>\s*<span[^>]+>\s*(?<price>\$[0-9,]+)/',
...
add_filter('filter_hondaway_post_data', 'filter_hondaway_post_data', 10, 2);

function filter_hondaway_post_data($post_data, $stock_type) {

    if ($stock_type == 'used') {
        $post_data = '{"operationName":"fetchUsedVehicles","variables":{"first":200,"organizationUnitId":1608,"vehicleCriteria":{"category":"CAR","colanderSlug":"used-without-as-traded","vehicleStatuses":["FOR_SALE","SOLD","VIRTUAL"],"onlyBuiltVehicles":false,"drivetrains":[],"fuelTypes":[],"exteriorColorIds":[],"frameStyleTypes":[],"makeIds":[],"modelIds":[],"odometerRange":{},"salePriceRange":{},"textQuery":"","transmissionTypes":[],"yearRange":{}},"vehicleOrders":[{"orderDirection":"ASC","vehicleOrderField":"PRICE"}],"after":"b2Zmc2V0LS0tMTE="},"query":"query fetchUsedVehicles($after: String, $first: Int!, $organizationUnitId: Int!, $paymentCriteria: PaymentCriteria, $vehicleCriteria: VehicleCriteria, $vehicleOrders: [VehicleOrder]) {\n  searchVehicles(after: $after, first: $first, organizationUnitId: $organizationUnitId, paymentCriteria: $paymentCriteria, vehicleCriteria: $vehicleCriteria, vehicleOrders: $vehicleOrders) {\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      __typename\n    }\n    totalCount\n    nodes {\n      id\n      odometer\n      onHold\n      stockNo\n      tagline\n      vin\n      year\n      characteristics {\n        transmission {\n          label\n          type\n          driveTrain {\n            label\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      financePaymentInfo {\n        cashdown\n        interestRatePercent\n        payment\n        paymentFrequency\n        paymentTaxes\n        termInMonths\n        __typename\n      }\n      flags {\n        label\n        type\n        __typename\n      }\n      make {\n        id\n        name\n        __typename\n      }\n      model {\n        id\n        name\n        __typename\n      }\n      trim {\n        id\n        name\n        __typename\n      }\n      multimedia {\n        mainPicture {\n          url\n          __typename\n        }\n     pictures {\n        url\n        __typename\n      }\n     __typename\n      }\n      prices {\n        regular\n        sale\n        __typename\n      }\n      inventory {\n        organizationUnit {\n          name\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n"}';
    } else {
        $post_data = '{"operationName":"fetchNewVehicles","variables":{"first":200,"organizationUnitId":1608,"vehicleCriteria":{"category":"CAR","colanderSlug":"new","vehicleStatuses":["FOR_SALE","SOLD","VIRTUAL"],"onlyBuiltVehicles":true,"drivetrains":[],"fuelTypes":[],"exteriorColorIds":[],"frameStyleTypes":[],"makeIds":[],"modelIds":[],"odometerRange":{},"salePriceRange":{},"textQuery":"","transmissionTypes":[],"yearRange":{}},"vehicleOrders":[{"orderDirection":"ASC","vehicleOrderField":"PRICE"}]},"query":"query fetchNewVehicles($after: String, $first: Int!, $vehicleCriteria: NewVehicleCriteria, $organizationUnitId: Int!, $vehicleOrders: [VehicleOrder]) {\n  searchNewVehicles(after: $after, first: $first, newVehicleCriteria: $vehicleCriteria, organizationUnitId: $organizationUnitId, vehicleOrders: $vehicleOrders) {\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      __typename\n    }\n    totalCount\n    nodes {\n      id\n      odometer\n      onHold\n      showroomVehicleId\n      stockNo\n      tagline\n      vin\n      year\n      characteristics {\n        transmission {\n          label\n          type\n          driveTrain {\n            label\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      flags {\n        label\n        type\n        __typename\n      }\n      make {\n        id\n        name\n        __typename\n      }\n      model {\n        id\n        name\n        __typename\n      }\n      multimedia {\n        mainPicture {\n          url\n          __typename\n        }\n      pictures {\n        url\n        __typename\n      }\n       __typename\n      }\n      matchedCatalogVehicle {\n        multimedia {\n          exteriorPictures {\n            side {\n              url\n              __typename\n            }\n            exactMatch\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      prices {\n        sale\n        regular\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n"}';
    }
...
function hondaway_get_newInventory($url,$temp){
    global $proxy_list;
    $details_start_tag = '<div class="loader">';
    $details_end_tag = '<p class="catalog-listing-alpha__disclaimer smallprint';
    $details_spliter = '<div class="">';
    ...
    foreach ($spltd as $data) {
        ...
        $url_regex = '/<a href="(?<url>[^"]+)" title="[0-9]{4}/';
        if (preg_match($url_regex, $data, $matches)) {
            $vdp_url = 'https://www.hondaway.com'. $matches['url'];
        }
        $vdp_data = HttpGet($vdp_url, $proxy_list);
        $car_url_regx = '/catalog-trim-chooser__item">\s*<a href="(?<car_url>[^"]+)/';
    ...
    $ttl_inventory = array_map(function($url)
                    {return 'https://www.hondaway.com'. $url;}
                    ,$ttl_inventory);   
