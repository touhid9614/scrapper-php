...
global $scrapper_configs;
 $scrapper_configs["allamericanharley"] = array( 
	 'entry_points' => array(
             'all'  => 'https://allamericanharley.com/Vehicle/GetVehicleListViewModels',
             //'new'   => 'https://allamericanharley.com/Vehicle/Inventory?SelectedVehicleType=2&RemoveAllFilters=true',
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           foreach($inventory->Data as $obj)
           {
            ...
            $description_regex    = '/seller-description"[^>]+>[^\/]+\/strong><\/span>[^>]+>\s*(?<description>[^<]+)/';
