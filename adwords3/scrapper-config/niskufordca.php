...
$scrapper_configs["niskufordca"] = array( 
	'entry_points' => array(
            'used'  => 'https://www.niskuford.ca/used/',
            'new'  => 'https://www.niskuford.ca/new/',
    ...
    add_filter("filter_niskufordca_field_images", "filter_niskufordca_field_images");
   
    function filter_niskufordca_field_images($im_urls)
    {
        return array_filter($im_urls, function($im_url){
            return !endsWith($im_url, 'no_image-640x480.jpg');
        });
    }
   add_filter("filter_niskufordca_field_price", "filter_niskufordca_field_price", 10, 3);

    function filter_niskufordca_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("niskufordca Price: $price");
        }
