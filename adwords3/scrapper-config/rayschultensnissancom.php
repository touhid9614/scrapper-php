...
$scrapper_configs["rayschultensnissancom"] = array( 
	  'entry_points' => array(
            'new'  => 'https://www.rayschultensnissan.com/new-inventory/index.htm',
            'used' => 'https://www.rayschultensnissan.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_rayschultensnissancom_field_price", "filter_rayschultensnissancom_field_price", 10, 3);
    add_filter("filter_rayschultensnissancom_field_images", "filter_rayschultensnissancom_field_images");
    
    
    function filter_rayschultensnissancom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        $final_regex   =  '/Final Price[^>]+>[^>]+>[^>]+>[^>]+>(?<price>\$[0-9,]+)/';
    ...
    function filter_rayschultensnissancom_field_images($im_urls)
    {
