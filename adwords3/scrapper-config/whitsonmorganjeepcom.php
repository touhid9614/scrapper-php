...
$scrapper_configs["whitsonmorganjeepcom"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.whitsonmorganjeep.com/new-inventory/index.htm',
            'used' => 'https://www.whitsonmorganjeep.com/used-inventory/index.htm',
         ),
    ...
    add_filter("filter_whitsonmorganjeepcom_field_price", "filter_whitsonmorganjeepcom_field_price", 10, 3);
    add_filter("filter_whitsonmorganjeepcom_field_images", "filter_whitsonmorganjeepcom_field_images");
    
    
    function filter_whitsonmorganjeepcom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_whitsonmorganjeepcom_field_images($im_urls)
    {
