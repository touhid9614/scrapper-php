<?php
    ...
    $scrapper_configs['maseratiofarlington'] = array(

        'entry_points' => array(
                'new' => 'https://www.maseratiofarlington.com/searchnew.aspx',
                'used'=> 'https://www.maseratiofarlington.com/searchused.aspx'
        ),
        'vdp_url_regex'       => '/\/(?:new|used)-Arlington-[0-9]{4}-/i',
        ...
        'data_capture_regx' => array(
            ...
            'price'            => '/<li class="priceBlockItem priceBlockItemPrice"\s*><span[^>]+>Internet Price\:\s*<\/span><span[^>]+>(?<price>\$[0-9,]+)/',
     ...
     add_filter("filter_maseratiofarlington_field_images", "filter_maseratiofarlington_field_images");

        function filter_maseratiofarlington_field_images($im_urls)
        {
