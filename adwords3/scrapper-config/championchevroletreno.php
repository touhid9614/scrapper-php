...
$scrapper_configs["championchevroletreno"] = array(
    'entry_points' => array(
        'new' => 'https://www.championchevroletreno.com/VehicleSearchResults?search=new',
        'used' => 'https://www.championchevroletreno.com/VehicleSearchResults?search=preowned',
    ),
...
add_filter("filter_championchevroletreno_next_page", "filter_championchevroletreno_next_page", 10, 2);

function filter_championchevroletreno_next_page($next, $current_page) {
