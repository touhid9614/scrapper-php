...
$scrapper_configs['taylorautomall'] = array(
//     'entry_points' => array(
...
//         'picture_nexts'     => ['.swiper-button-prev'],
//         'picture_prevs'     => ['.swiper-button-next'],
...
// );
// add_filter('filter_taylorautomall_post_data', 'filter_taylorautomall_post_data', 10, 2);
// add_filter("filter_taylorautomall_field_images", "filter_taylorautomall_field_images");
//  function filter_taylorautomall_field_images($im_urls)
//     {
