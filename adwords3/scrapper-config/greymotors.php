<?php
    ...
    $scrapper_configs['greymotors'] = array(
      'entry_points' => array(
            'new'   => 'https://www.greymotors.com/new/',
            'used'  => 'https://www.greymotors.com/used/',
        ),
    ...
    add_filter("filter_greymotors_field_price", "filter_greymotors_field_price", 10, 3);
    add_filter("filter_greymotors_field_images", "filter_greymotors_field_images");
    function filter_greymotors_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_greymotors_field_images($im_urls)
    {
