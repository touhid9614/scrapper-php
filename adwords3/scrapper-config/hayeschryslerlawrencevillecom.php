...
global $scrapper_configs;
 $scrapper_configs["hayeschryslerlawrencevillecom"] = array( 
	 'entry_points' => array(
            'all'   => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/MP4664.csv'
        ),
        ...
        'custom_data_capture' => function($url,$data) {
            ...
            $db_connect = DbConnect::get_instance('hayeschryslerlawrencevillecom');
            
            #Update
            $query = "SELECT * FROM hayeschryslerlawrencevillecom_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
