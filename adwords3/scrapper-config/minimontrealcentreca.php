...
$scrapper_configs["minimontrealcentreca"] = array( 
	 'entry_points' => array(
        'used'  => 'https://minimontrealcentre.ca/en/shopping/mini-next/list', 
        'new'   => 'https://minimontrealcentre.ca/en/shopping/inventory',
        
    ),
    'vdp_url_regex'     => '/\/en\/shopping\//i',
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           {    
               ...
               if($obj->km != 90)   
               {
                   $url="https://minimontrealcentre.ca/en/shopping/mini-next/detail/";
               }
               else 
               {
                   $url="https://minimontrealcentre.ca/en/shopping/inventory/detail/5101/";
               }
               $car_data = array(
