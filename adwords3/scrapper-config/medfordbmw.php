...
global $scrapper_configs;
 $scrapper_configs["medfordbmw"] = array( 
	 'entry_points' => array(
            'new'  => 'https://www.medfordbmw.com/new-inventory/index.htm',
            'used' => 'https://www.medfordbmw.com/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_medfordbmw_field_price", "filter_medfordbmw_field_price", 10, 3);
    add_filter("filter_medfordbmw_field_images", "filter_medfordbmw_field_images");
    function filter_medfordbmw_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_medfordbmw_field_images($im_urls)
    {
