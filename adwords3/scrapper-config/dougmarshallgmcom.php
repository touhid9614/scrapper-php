...
$scrapper_configs["dougmarshallgmcom"] = array(
    'entry_points' => array(
 ...
 foreach($objects->results[0]->hits as $obj)
        {
            ...
            $car_data = array(
             ...
             $regex = '/Wheaton Sale Price[^>]+>\s*[^>]+>(?<price>[^<]+)/';
             $matches = [];
...
add_filter('filter_dougmarshallgmcom_post_data', 'filter_dougmarshallgmcom_post_data', 10, 2);
//  add_filter("filter_dougmarshallgmcom_field_images", "filter_dougmarshallgmcom_field_images");
//  function filter_dougmarshallgmcom_field_images($im_urls)
// {
//     if (count($im_urls) < 3) {
//         return [];
