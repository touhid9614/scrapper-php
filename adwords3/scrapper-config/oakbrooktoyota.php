...
$scrapper_configs['oakbrooktoyota'] = array(
   'entry_points' => array(
       'new' => 'https://smartpath.oakbrooktoyota.com/inventory/search?dealerCd=12134&source=t3&zipcode=60559&type=used',
       // 'new' => 'https://www.oakbrooktoyota.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-data-bus1/getInventory?start=0&page=1',
       // 'used' => 'https://www.oakbrooktoyota.com/apis/widget/INVENTORY_LISTING_DEFAULT_AUTO_USED:inventory-data-bus1/getInventory?start=0&page=1',
    ),
       'srp_page_regex'         => '/\/(?:new|used)-inventory\/index/i',
        ...
        'custom_data_capture' => function($url, $data) {
            ...
            foreach ($objects->pageInfo->trackingData as $obj) {
                ...
                $car_data = array(
                    ...
                    // 'url' => "https://www.oakbrooktoyota.com/{$obj->newOrUsed}/{$obj->make}/{$obj->modelYear}-{$obj->make}-{$obj->model}-{$obj->uuid}".".htm",
                    'url' 		 => "https://www.oakbrooktoyota.com{$obj->link}",      
                );
 ...
 add_filter("filter_oakbrooktoyota_next_page", "filter_oakbrooktoyota_next_page", 10, 2);       
 function filter_oakbrooktoyota_next_page($next, $current_page) {
