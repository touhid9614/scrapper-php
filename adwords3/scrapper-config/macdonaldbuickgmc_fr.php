...
$scrapper_configs['macdonaldbuickgmc_fr'] = array(
    'entry_points' => array(
 ...
 foreach($objects->results[0]->hits as $obj)
        ...
        return $to_return;
             ...
             'images_regx' => '/<img data-src="(?<img_url>[^"]+)" alt=""/'
);
add_filter('filter_macdonaldbuickgmc_fr_post_data', 'filter_macdonaldbuickgmc_fr_post_data', 10, 2);

function filter_macdonaldbuickgmc_fr_post_data($post_data, $stock_type)
{
    if($stock_type == 'new')
    {
