...
$scrapper_configs['dolanrenokia'] = array(
    'entry_points' => array(
        'new' => 'https://www.dolanrenokia.com/new-inventory/index.htm',
        'used' => 'https://www.dolanrenokia.com/used-inventory/index.htm',
    ),
...
add_filter("filter_dolanrenokia_field_price", "filter_dolanrenokia_field_price", 10, 3);
add_filter("filter_dolanrenokia_field_images", "filter_dolanrenokia_field_images");

function filter_dolanrenokia_field_price($price, $car_data, $spltd_data) {
    $prices = [];
...
function filter_dolanrenokia_field_images($im_urls) {
