...
global $scrapper_configs;
 $scrapper_configs["listowelfordcom"] = array( 
	'entry_points' => array(
...
add_filter("filter_listowelfordcom_field_images", "filter_listowelfordcom_field_images");       
function filter_listowelfordcom_field_images($im_urls) {
