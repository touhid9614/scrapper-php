...
$scrapper_configs["greeleysubaru"] = array(
    'entry_points' => array(
        'new' => 'https://www.greeleysubaru.com/new-inventory/index.htm',
        'used' => 'https://www.greeleysubaru.com/used-inventory/index.htm'
    ),
...
// add_filter("filter_greeleysubaru_field_images", "filter_greeleysubaru_field_images");
add_filter("filter_greeleysubaru_field_price", "filter_greeleysubaru_field_price", 10, 3);

//  function filter_greeleysubaru_field_images($im_urls)
//    {
//      
//         if(count($im_urls)<2)
//            {
...
//          
//    }
function filter_greeleysubaru_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    slecho('');
