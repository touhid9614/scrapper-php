...
$scrapper_configs["allensamuelsvwcom"] = array( 
	'entry_points' => array(
...
add_filter("filter_allensamuelsvwcom_field_images", "filter_allensamuelsvwcom_field_images",10,2);
function filter_allensamuelsvwcom_field_images($im_urls, $car_data) {
    $retval = array();
