...
$scrapper_configs["marigoldfordca"] = array( 
	'entry_points' => array(
            'used'   => 'https://www.marigoldford.ca/inventory/search?stock_type=Used&page=1&page_length=1000',
            'new'    => 'https://www.marigoldford.ca/inventory/search?stock_type=New&page=1&page_length=1000',
        ),
            ...
            foreach($inventory as $obj)
            {
                $car_data = array(
                   ...
                   // 'body_style'        => $obj->source->feed->bodyStyle,
                    ...
                    'url'               => "https://www.marigoldford.ca/inventory/" . strtolower($obj->stock_type) .
