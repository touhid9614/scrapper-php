...
$scrapper_configs["erickseninfiniti"] = array(
    'entry_points' => array(
        'new' => 'https://www.erickseninfiniti.com/wp-json/strathcom/vehicles/search?language=en&stock_type=New&make=Infiniti&page=1&page_length=1000',
        'used' => 'https://www.erickseninfiniti.com/wp-json/strathcom/vehicles/search?language=en&stock_type=Used&page=1&page_length=1000',
    ),
    ...
    'custom_data_capture' => function($url, $resp) {
        ...
        foreach ($inventory as $obj) {
            $car_data = array(
                ...
                'url' => "https://www.erickseninfiniti.com/inventory/" . strtolower($obj->stock_type) .
