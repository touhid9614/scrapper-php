...
$scrapper_configs["springvalleyfordcom"] = array(
    'entry_points' => array(
        'used'  => 'https://www.springvalleyford.com/used-inventory/index.htm',
       ),
      ...
      "custom_data_capture" => function ($url, $data) {
          $site                 = "https://www.springvalleyford.com/sitemap.xml";
          $vdp_url_regex        = '/\/(?:new|used)\/[^\/]+\/[0-9]{4}-/i';
...
//  add_filter('filter_springvalleyfordcom_car_data', 'filter_springvalleyfordcom_car_data');

//  function filter_springvalleyfordcom_car_data($car_data) {
