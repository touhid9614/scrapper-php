<?php
    ...
    $scrapper_configs['blackhawkfordprairieduchien'] = array(
       'entry_points' => array(
            'used'  => 'https://www.fillback.com/searchused.aspx',
            'new'   => 'https://www.fillback.com/searchnew.aspx',
    ...
    add_filter('filter_blackhawkfordprairieduchien_field_price', 'filter_blackhawkfordprairieduchien_field_price',10,3);
    
    function filter_blackhawkfordprairieduchien_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
