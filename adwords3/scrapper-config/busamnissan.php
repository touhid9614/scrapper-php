...
global $scrapper_configs;
 $scrapper_configs["busamnissan"] = array( 
 'entry_points' => array(
            'new'   => 'https://www.busamnissan.com/new-inventory/index.htm',
            'used'  => 'https://www.busamnissan.com/used-inventory/index.htm'
        ),
        'vdp_url_regex'     => '/\/(?:new|used|certified)\/[^\/]+\/[0-9]{4}-/i',
        'ty_url_regex'      => '/\/form\/confirm.htm/i',
        'use-proxy' => true,
        'picture_selectors' => ['.jcarousel-item'],
        'picture_nexts'     => ['.imageScrollNext.next.alwayson'],
        'picture_prevs'     => ['.imageScrollPrev.previous.alwayson'],
    ...
    add_filter("filter_busamnissan_field_price", "filter_busamnissan_field_price", 10, 3);
    add_filter("filter_busamnissan_field_images", "filter_busamnissan_field_images");
    
    
    function filter_busamnissan_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
    ...
    function filter_busamnissan_field_images($im_urls)
    {
        $retval = array();
