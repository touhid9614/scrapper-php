...
$scrapper_configs["hjpfaffaudicom"] = array( 
	 'entry_points' => array(
             'used'  => 'https://www.hjpfaffaudi.com/used/',
            'new'   => 'https://www.hjpfaffaudi.com/new/',
    ...
    add_filter("filter_hjpfaffaudicom_field_price", "filter_hjpfaffaudicom_field_price", 10, 3);
    add_filter("filter_hjpfaffaudicom_field_images", "filter_hjpfaffaudicom_field_images");
    function filter_hjpfaffaudicom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];
        ...
        if($price && numarifyPrice($price) > 0) {
            ...
            slecho("pfaffaudicom Price: $price");
        }
    ...
    function filter_hjpfaffaudicom_field_images($im_urls)
    {
