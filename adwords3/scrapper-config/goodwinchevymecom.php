...
$scrapper_configs["goodwinchevymecom"] = array( 
	 'entry_points' => array(
              'used' => 'https://www.goodwinchevybrunswick.com/used-inventory/index.htm',
            'new'  => 'https://www.goodwinchevybrunswick.com/new-inventory/index.htm',
    ...
    add_filter("filter_goodwinchevymecom_field_images", "filter_goodwinchevymecom_field_images");
    add_filter("filter_goodwinchevymecom_field_price", "filter_goodwinchevymecom_field_price", 10, 3);

  function filter_goodwinchevymecom_field_images($im_urls)
    {
    ...
    function filter_goodwinchevymecom_field_price($price,$car_data, $spltd_data)
    {
        $prices = [];     
        slecho('');
