...
$scrapper_configs['goderichtoyota'] = array(
    'entry_points' => array(
        'new' => 'https://www.goderichtoyota.com/new/',
        'used' => 'https://www.goderichtoyota.com/used/group/'
    ),
...
add_filter("filter_goderichtoyota_field_price", "filter_goderichtoyota_field_price", 10, 3);
add_filter("filter_goderichtoyota_field_images", "filter_goderichtoyota_field_images");

function filter_goderichtoyota_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    if ($price && numarifyPrice($price) > 0) {
        ...
        slecho("goderichtoyota Price: $price");
    }
...
function filter_goderichtoyota_field_images($im_urls) {
