...
$scrapper_configs["bannisterchevcom"] = array(
    'entry_points' => array(
...
add_filter("filter_bannisterchevcom_field_price", "filter_bannisterchevcom_field_price", 10, 3);

function filter_bannisterchevcom_field_price($price, $car_data, $spltd_data) {
    $prices = [];
