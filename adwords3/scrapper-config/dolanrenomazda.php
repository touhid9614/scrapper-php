...
global $scrapper_configs;
 $scrapper_configs["dolanrenomazda"] = array( 
	'entry_points' => array(
            'new'  => 'https://www.dolanrenomazda.com/new-inventory/index.htm',
            'used' => 'https://www.dolanrenomazda.com/used-inventory/index.htm'
        ),
    ...
    add_filter("filter_dolanrenomazda_field_price", "filter_dolanrenomazda_field_price", 10, 3);
  
    function filter_dolanrenomazda_field_price($price,$car_data, $spltd_data)
     {
        $prices = [];
