...
$scrapper_configs['fullenmotors'] = array(
    'entry_points' => array(
        'new'  => 'http://www.fullenmotors.com/VehicleSearchResults?search=new',
        'used' => 'http://www.fullenmotors.com/VehicleSearchResults?search=preowned'
    ),
    ...
    add_filter("filter_fullenmotors_next_page", "filter_fullenmotors_next_page",10,2);
    
    function filter_fullenmotors_next_page($next,$current_page) {
