...
$scrapper_configs["volkswagenofnorthnashvillecom"] = array( 
	'entry_points' => array(
...
add_filter("filter_volkswagenofnorthnashvillecom_field_images", "filter_volkswagenofnorthnashvillecom_field_images",10,2);
function filter_volkswagenofnorthnashvillecom_field_images($im_urls, $car_data) {
    $retval = array();
