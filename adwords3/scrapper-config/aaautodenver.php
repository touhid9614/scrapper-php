...
$scrapper_configs["aaautodenver"] = array(
    'entry_points'        => array(
        'used' => 'http://www.aaautodenver.com/Inventory/Search?BodyType=&Year=&Make=&Model=&PriceRange=&Condition=pre-owned-cars&Color=&InteriorColor=&CityMpg=&HighwayMpg=&Transmission=&DriveTrain=&Fuel=&SearchExpression=&SortCriteria=&SortDirection=&LocationId=&IsCertified=-1&IsSold=False&startIndex=10&Results=1000',
    ),
    ...
    'custom_data_capture' => function ($url, $data) {
        ...
        foreach ($objects->vehicles as $obj) {
            ...
            $car_data = array(
                ...
                'url'            => "http://www.aaautodenver.com/pre-owned-cars/detail/{$obj->Year}-{$obj->Make}-{$obj->Model}/{$obj->VehicleId}",
