...
$scrapper_configs["larrymacdonaldchevca"] = array( 
	'entry_points' => array(
            'new'   => 'https://www.larrymacdonaldchev.ca/new/',
            'used'  => 'https://www.larrymacdonaldchev.ca/used/'
        ),
        ...
        'images_regx'       => '/data-src="(?<img_url>[^"]+)" alt="/'
    );
    
    add_filter("filter_larrymacdonaldchevca_field_images", "filter_larrymacdonaldchevca_field_images");
    
    function filter_larrymacdonaldchevca_field_images($im_urls)
    {
