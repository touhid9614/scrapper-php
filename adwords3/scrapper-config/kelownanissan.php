...
global $scrapper_configs;
 $scrapper_configs["kelownanissan"] = array( 
    'entry_points' => array(
 ...
 return $post_data;
  ...
  add_filter('filter_kelownanissan_field_model', 'filter_kelownanissan_field_model');
  function filter_kelownanissan_field_model($model)
    {
