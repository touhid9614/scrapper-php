...
$scrapper_configs["motounitedbellflowercom"] = array( 
  'entry_points' => array(
        'new'   => 'https://www.motounitedbellflower.com/imglib/Inventory/cache/4547/NVehInv.js?v=4424406',
        'used'  => 'https://www.motounitedbellflower.com/imglib/Inventory/cache/4547/UVehInv.js?v=1371992',
    ),
    ...
    'custom_data_capture' => function($url, $resp){
           ...
           {    
               ...
               if($obj->type == 'U')   
               {
                   $url="https://www.motounitedbellflower.com/default.asp?page=xPreOwnedInventoryDetail";
               }
               else 
               {
                   $url="https://www.motounitedbellflower.com/default.asp?page=xNewInventoryDetail";
               }
               $car_data = array(
