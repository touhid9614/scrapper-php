...
$scrapper_configs["tritruckcentre"] = array(
    "entry_points" => array(
        'new' => 'https://www.tritruckcentre.com/new/',
        'used' => 'https://www.tritruckcentre.com/used/',
    ),
...
add_filter("filter_tritruckcentre_field_price", "filter_tritruckcentre_field_price", 10, 3);
add_filter("filter_tritruckcentre_field_images", "filter_tritruckcentre_field_images");

function filter_tritruckcentre_field_price($price, $car_data, $spltd_data) {
    $prices = [];
    ...
    if ($price && numarifyPrice($price) > 0) {
        ...
        slecho("tritruckcentre Price: $price");
    }
...
function filter_tritruckcentre_field_images($im_urls) {
