...
$scrapper_configs['alfaromeoofsouthwesternontario'] = array(
    'entry_points'        => array(
        'all' => 'https://tm.smedia.ca/adwords3/client-data/dealereprocess/ALFRWIND.csv',
    ),
    'use-proxy'           => true,
    'refine'              => false,
    'vdp_url_regex'       => '/\/auto\/.*[0-9]{4}-/i',
    ...
    'custom_data_capture' => function ($url, $resp) {
        ...
        $db_connect   = DbConnect::get_instance('alfaromeoofsouthwesternontario');
        $query        = "SELECT * FROM alfaromeoofsouthwesternontario_scrapped_data WHERE url NOT LIKE '%/*/%' AND deleted = 0";
