...
$scrapper_configs['driverainbow'] = array(
    'entry_points' => array(
        'new' => 'https://www.driverainbow.com/searchnew.aspx',
        'used' => 'https://www.driverainbow.com/searchused.aspx'
    ),
    ...
    'data_capture_regx' => array(
        'stock_number' => '/Stock #: <\/strong>(?<stock_number>[^<]+)<\/li>.*\s*<a class/',
        ...
        'price' => '/FINAL PRICE: <\/span><span[^>]+>(?<price>[$0-9,]+)/',
    ...
    'images_regx' => '/<div [^>]+><img src="(?<img_url>[^"]+)" alt/',
);
