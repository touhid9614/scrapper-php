<?php
global $CronConfigs;
 $CronConfigs["indyhyundaiwest"] = array( 
	"name"  =>" indyhyundaiwest",
	"email" => "regan@smedia.ca",
	"password" =>" indyhyundaiwest",
	"log" => true ,
	"banner" => array(
        "template" => "indyhyundaiwest",
	...
	"lead"  => array(
		...
		'button_color_hover'    => array("#c3002f", "#c3002f"),
		'button_color_active'   => array("#c3002f", "#c3002f"),
		'button_text_color'     => "#ffffff",
		'response_email_subject'=> "$250 off coupon from Ray Skillman Westside Hyundai",
		...
		'special_to'            => array('leads@skillmanautomall.motosnap.com'),
