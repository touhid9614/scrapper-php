...
global $CronConfigs;
$CronConfigs["rayskillmanautomall"] = array(
    "name" => " rayskillmanautomall",
    "email" => "regan@smedia.ca",
    "password" => " rayskillmanautomall",
    "log" => true,
    "fb_title" => "[year] [make] [model] [price]",
    'fb_brand' => '[year] [make] [model] - [body_style]',
    "banner" => array(
        "template" => "rayskillmanautomall",
    ...
    "lead" => array(
        ...
        'response_email' => 'Hello [name],<p> Thank you for signing up for our offer. Please print this off, or show your sales professional this email on your phone to claim.</p><br><img src="[image]"/><p><br><br>Ray Skillman Westside Auto Mall Team',
        'forward_to' => array(
            'marshal@smedia.ca',
),
        'special_to' => array(
		...
		<adf>
			<prospect>
				<id sequence="[total_count]" source="Ray Skillman Westside Auto Mall"></id>
				...
				<vendor>
					<contact>
						<name part="full">Ray Skillman Westside Auto Mall</name>
