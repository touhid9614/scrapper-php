...
$CronConfigs["crickshighwayvolkswagencomau"] = array( 
	...
	"banner" => array(
		...
		//"fb_description_used" => "The Cricks Highway Volkswagen Used Car Clearance is on!  For all of July you can score an unbeatable deal across a huge range of our Used Cars, just like this [year] [make] [model] [trim] for only [price] Drive Away*.  Tap below to explore this offer and many more!",
        "flash_style" => "default",
        "border_color" => "#282828",
        "font_color" => "#ffffff"
    ),
