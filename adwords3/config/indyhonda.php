...
global $CronConfigs;
$CronConfigs["indyhonda"] = array(
    'name'              => 'indyhonda',
    'password'          => 'indyhonda',
    'email'             => 'regan@smedia.ca',
    'fb_brand'          => '[year] [make] [model] - [body_style]',
    'log'               => true,
    'customer_id'       => '528-073-3476',
    'bing_account_id'   => 156003771,
    'max_cost'          => 2000,
    ...
    'lead'              => array(
        ...
        'response_email_subject'    => 'Claim $250 off on a new vehicle purchase from Indy Honda',
        'response_email'            => 'Hello [name],<p> Thank you for signing up for our offer. Please print this off, or show your sales professional this email on your phone to claim.</p><br><img src="[image]"/><p><br><br>Indy Honda Team',
        'forward_to'                => array(
            'r.piercy@rohrman.com',
            'marshal@smedia.ca',
        ),
        'special_to'                => array(
            'leads@indyhonda.com',
        ...
        'special_email'             => '<?xml version="1.0" encoding="UTF-8"?>
            ...
            <adf>
                <prospect>
                    <id sequence="[total_count]" source="Indy Honda"></id>
                   ...
                   <customer>
                    ...
                    <vendor>
                        <contact>
                            <name part="full">Indy Honda </name>
