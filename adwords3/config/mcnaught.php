...
$CronConfigs["mcnaught"] = array(
    ...
    "lead" => array(
        ...
        'response_email_subject' => 'Get $200 OFF vehicle purchase from McNaught GM!',
        'response_email' => 'Hello [name],<p> Please print this off or show your sales professional this email on your phone to claim.</p><br><img src="[image]"/><p><br><br>McNaught GM Team',
        'forward_to' => array(
            'marshal@smedia.ca',
),
        'special_to' => array(
            'leads@Mcnaughtbuick.motosnap.com',
            'adf_to@smedia.ca',
),
        'special_email' => '<?xml version="1.0"?>
			...
			<adf>
				<prospect>
					...
					<vendor>
						<contact>
							<name part="full">McNaught GM</name>
