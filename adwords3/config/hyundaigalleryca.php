...
global $CronConfigs;
$CronConfigs["hyundaigalleryca"] = array(
    "name" => " hyundaigalleryca",
    "email" => "regan@smedia.ca",
    "password" => " hyundaigalleryca",
    "log" => true,
    "banner" => array(
        "template" => "hyundaigalleryca",
    ...
    'buttons' => [
        ...
        'request-a-quote' => [
            ...
            'action-target' => '.link__alpha.link__alpha-primary.inventory-vehicle-infos__actions-item',
            'css-class' => '.link__alpha.link__alpha-primary.inventory-vehicle-infos__actions-item',
            'css-hover' => '.link__alpha.link__alpha-primary.inventory-vehicle-infos__actions-item:hover',
            'button_action' => [
                'form',
                'e-price',
],
            ...
            'texts' => [
                'request-a-quote' => [
                    'target' => '.link__alpha.link__alpha-primary.inventory-vehicle-infos__actions-item',
                    'values' => array(
                        'Watch This Price',
                        'Special Pricing!',
