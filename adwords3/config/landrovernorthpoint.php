...
$CronConfigs["landrovernorthpoint"] = array(
  'password'  => 'landrovernorthpoint',
    "email"         => "regan@smedia.ca",
    'log'           => true,

    "banner"        => array(
        "template"          => "landrovernorthpoint",
		'fb_description_certified_jaguar'	=> 'Test drive the Approved Certified Pre-Owned [year] [make] [model] [trim] today at Jaguar North Atlanta.
		...
		'fb_description_certified_land rover'	=> 'Test drive the Approved Certified Pre-Owned [year] [make] [model] [trim] today at Land Rover North Atlanta.
