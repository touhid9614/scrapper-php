...
$CronConfigs["chvwca"] = array(
    ...
    'buttons' => [
        ...
        'request-a-quote' => [
            ...
            'action-target' => '.link__beta.link__beta-primary.inventory-vehicle-infos__actions-item',
            'css-class' => '.link__beta.link__beta-primary.inventory-vehicle-infos__actions-item',
            'css-hover' => '.link__beta.link__beta-primary.inventory-vehicle-infos__actions-item:hover',
            'button_action' => [
                'form',
                'e-price',
],
            ...
            'texts' => [
                'request-a-quote' => [
                    'target' => '.link__beta.link__beta-primary.inventory-vehicle-infos__actions-item',
                    'values' => array(
                        'Watch This Price',
                        'Special Pricing!',
