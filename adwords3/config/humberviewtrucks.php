...
global $CronConfigs;
$CronConfigs["humberviewtrucks"] = array(
    "name" => "humberviewtrucks",
    "email" => "regan@smedia.ca",
    "password" => "humberviewtrucks",
    "log" => true,
    //    'adf_to' => '',
    'form_live' => false,
    'buttons_live' => true,
    'buttons' => [
            ...
            'texts' => [
                'request-information' => [
                    ...
                    'values' => array(
                        ...
                        '<span style="font-family: roboto;display: inline-block;margin-bottom: 10px;vertical-align: bottom;">Learn More</span><span style="font-family: roboto;display: inline-block;margin-bottom: 10px;vertical-align: bottom;">',
                        'More Info</span>',
        ...
        'test-drive' => [
            ...
            'action-target' => 'div.col-md-veh-details.col-sm-5 span:nth-of-type(2) a.btn-incentives-new',
            'css-class' => 'div.col-md-veh-details.col-sm-5 span:nth-of-type(2) a.btn-incentives-new',
            'css-hover' => 'div.col-md-veh-details.col-sm-5 span:nth-of-type(2) a.btn-incentives-new:hover',
            'button_action' => [
                'form',
                'test-drive',
            ],
            ...
            'texts' => [
                'test-drive' => [
                    'target' => 'div.col-md-veh-details.col-sm-5 span:nth-of-type(2) a.btn-incentives-new',
                    'values' => array(
        ...
        'trade-in' => [
            ...
            'action-target' => 'div.col-md-veh-details.col-sm-5 span:nth-of-type(1) a.btn-incentives-new',
            'css-class' => 'div.col-md-veh-details.col-sm-5 span:nth-of-type(1) a.btn-incentives-new',
            'css-hover' => 'div.col-md-veh-details.col-sm-5 span:nth-of-type(1) a.btn-incentives-new:hover',
            'button_action' => [
                'form',
                'trade-in',
            ],
            ...
            'texts' => [
                'trade-in' => [
                    'target' => 'div.col-md-veh-details.col-sm-5 span:nth-of-type(1) a.btn-incentives-new',
                    'values' => array(
