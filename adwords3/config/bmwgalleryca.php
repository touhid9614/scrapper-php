...
$CronConfigs["bmwgalleryca"] = array (
  'name' => 'bmwgalleryca',
  'email' => 'regan@smedia.ca',
  'password' => 'bmwgalleryca',
  'log' => true,
  'banner' => 
  array (
    'template' => 'bmwgalleryca',
      'fb_aia_description'       => 'Check out this [year] [make] [model] today! Click the \'Dealership Website\' link below for more information.',
    'fb_description' => 'Are you still interested in the [year] [make] [model]? Shop now at BMW Gallery.',
    'fb_lookalike_description' => 'Check out this [year] [make] [model]. Shop now at BMW Gallery.',
    'fb_hotsummer_description' => 'Are you still interested in the [year] [make] [model]? Shop now at BMW Gallery.',
    'fb_hotsummerlal_description' => 'Check out this [year] [make] [model]. Shop now at BMW Gallery.',
  ...
  'fillup_redirect_url' => 'https://www.bmwgallery.ca/en/thank-you?formId=19',
  'buttons_live' => false,
  'buttons' => 
  array (
    'request-a-quote' => 
