...
$CronConfigs["folsombuickgmc"] = array(
    ...
    'lead' => array(
        ...
        'response_email_subject' => '$250 off coupon from Folsom Buick GMC',
        'response_email' => 'Hello [name],<p> Thank you for signing up for our offer. Please print this off, or show your sales professional this email on your phone to claim.</p><br><img src="[image]"/><p><br><br>Folsom Buick GMC Team',
        'forward_to' => array(
            'ckarsting@yahoo.com',
            'marshal@smedia.ca',
),
        'special_to' => array(
            'leads@folsombuickgmc.net',
),
		...
		<adf>
			<prospect>
				...
				<vendor>
					<vendorname>Folsom Buick GMC</vendorname>
					<contact>
						<name part="full">Folsom Buick GMC</name>
