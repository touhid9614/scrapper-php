<?php
global $CronConfigs;
$CronConfigs["mcgrathmitsubishiliverpoolcomau"] = array( 
	"name"  => "mcgrathmitsubishiliverpoolcomau",
	"email" => "regan@smedia.ca",
	"password" => "mcgrathmitsubishiliverpoolcomau",
	"log" => true,
	'combined_feed_mode' => true,
        'fb_title' => "[year] [make] [model] [trim]",
	"banner" => array(
        "template" => "mcgrathmitsubishiliverpoolcomau",
