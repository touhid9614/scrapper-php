...
$site_scrappers['autotradervr'] = array(
    'use-proxy' => true,
    ...
    'data_capture_regx' => array(
        ...
        'title'         => '/<h2><a href="(?<url>\/(?:new|used|certified)\/[^"]+)"><span>(?<title>(?<year>[^ ]+) *(?<make>[^ ]+) *(?<model>[^ <]+)[^<]*)/',
        'year'          => '/<h2><a href="(?<url>\/(?:new|used|certified)\/[^"]+)"><span>(?<title>(?<year>[^ ]+) *(?<make>[^ ]+) *(?<model>[^ <]+)[^<]*)/',
        'make'          => '/<h2><a href="(?<url>\/(?:new|used|certified)\/[^"]+)"><span>(?<title>(?<year>[^ ]+) *(?<make>[^ ]+) *(?<model>[^ <]+)[^<]*)/',
        'model'         => '/<h2><a href="(?<url>\/(?:new|used|certified)\/[^"]+)"><span>(?<title>(?<year>[^ ]+) *(?<make>[^ ]+) *(?<model>[^ <]+)[^<]*)/',
        ...
        'url'           => '/<h2><a href="(?<url>\/(?:new|used|certified)\/[^"]+)"><span>(?<title>(?<year>[^ ]+) *(?<make>[^ ]+) *(?<model>[^ <]+)[^<]*)/'
    ),
...
function autotradervr_images_proc($image_url)
{
