<?php
     ...
     * @param      boolean                  $use_include_path  The use include path
     * @param      <type>                   $context           The context
     * @param      <type>                   $offset            The offset
     * @param      <type>                   $maxLen            The maximum length
     * @param      boolean                  $lowercase         The lowercase
     * @param      boolean                  $forceTagsClosed   The force tags closed
     * @param      <type>                   $target_charset    The target charset
     * @param      boolean                  $stripRN           The strip rn
     * @param      <type>                   $defaultBRText     The default br text
     * @param      <type>                   $defaultSpanText   The default span text
     *
     * @return     boolean|simple_html_dom  ( description_of_the_return_value )
     */
     ...
     * @param      boolean  $show_attr  The show attribute
     * @param      integer  $deep       The deep
     */
