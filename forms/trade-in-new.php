            ...
            <section class="form-container size-eight-hundread-by-six-hundread">
                <form id="salesForm">
                    ...
                    <div class="columns_section group">
                        <div class="col span_1_of_2 cs-left-div-image">
                            <div class="cs-security-image-div-trade-in">
                        ...
                        <div class="col span_1_of_2 cs-right-div">
                            <div class="cs-trade-in-right-side">
                                <div class="cs-trade-in-rightside-header-flex">
                                    <h4 style="padding-left: 20px"><strong> Your trade-in is just one step
                                            away </strong></h4>
                                    <p style="padding-left: 20px"><strong> Just fill in the brief form below </strong>
                                    </p>
                                </div>
                                ...
                                <div class="year-make-model">
                                    <p style="color: black; font-size: 13px; padding-left: 10px; padding-bottom: 20px; padding-top: 10px">
                                        What is your vehicle like? </p>
                                    ...
                                    <!--                                    <p class="text-danger year_make_model_error_msg"-->
                                    <!--                                       style="font-size: 11px; margin-top: -30px; padding-left: 8px; visibility: hidden">Let's get to know-->
                                    <!--                                        your car</p>-->
                                </div>
                                ...
                                <button class="button action-btn smedia-trade-in-button"> TRADE IN YOUR CAR</button>
                            </div>
                        </div>
                    </div>
                </form>
