...
<!-- CSS -->
<link rel="stylesheet" href="assets-new/js/jquery-ui/jquery-ui.min.css">
<link rel="stylesheet" href="assets-new/css/style_refresh.css">
<link rel="stylesheet" href="assets-new/css/codesurfer.css">
...
<script>
	<?php
	    ...
	    { 
	    	echo "//No script found for " . $script_file; 
	    }
	?>
</script>