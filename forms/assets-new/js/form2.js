...
$(function ()
{
    ...
    $('[name="first_name"]').blur(function(e)
    {
        if (isFieldEmpty(document.getElementsByName('first_name')[0]))
        {
            ...
            // showPopover('first_name', 'Please enter your first name');
            // console.log(document.getElementsByClassName("first_name_error_msg")[0]);

            document.getElementsByClassName("first_name_error_msg")[0].style.visibility = 'visible';
        }
        else
        {
                // removeElement('cs_first_name_error_popover');
            document.getElementsByName('first_name')[0].style.borderColor = 'green';
            document.getElementsByClassName("first_name_error_msg")[0].style.visibility = 'hidden';
        }
    });
    ...
    $('[name="last_name"]').blur(function(e)
    {
        if (isFieldEmpty(document.getElementsByName('last_name')[0]))
        {
            ...
            // showPopover('last_name', 'Please enter your last name');
            document.getElementsByClassName("last_name_error_msg")[0].style.visibility = 'visible';
        }
        else
        {
            ...
            document.getElementsByClassName("last_name_error_msg")[0].style.visibility = 'hidden';
        }
    });
    ...
    $('[name="email_address"]').blur(function(e)
    {
        if (!validateEmail(document.getElementsByName('email_address')[0]))
        {
            ...
            // showPopover('email_address', 'Please enter your valid email address');
            document.getElementsByClassName("email_address_error_msg")[0].style.visibility = 'visible';
        }
        else
        {
            ...
            document.getElementsByClassName("email_address_error_msg")[0].style.visibility = 'hidden';
        }
    });

    $('[name="phone_number"]').blur(function(e)
    {
        if (!validatePhone(document.getElementsByName('phone_number')[0]))
        {
            ...
            // showPopover('phone_number', 'Please enter your valid phone number');
            document.getElementsByClassName("phone_number_error_msg")[0].style.visibility = 'visible';
        }
        else
        {
            ...
            document.getElementsByClassName("phone_number_error_msg")[0].style.visibility = 'hidden';
        }
    });
    ...
    $('[name="car_year"]').blur(function(e)
    {
        if (isFieldEmpty(document.getElementsByName('car_year')[0]))
        {
            ...
            document.getElementsByClassName("year_make_model_error_msg")[0].style.visibility = 'visible';
        }
        else
        {
            document.getElementsByName('car_year')[0].style.borderColor = "green";
            document.getElementsByClassName("year_make_model_error_msg")[0].style.visibility = 'hidden';
        }
    });
        ...
        .done(function(data, textStatus, jqXHR)
        {
            ...
            if(data.success)
            {
                ...
                window.parent.postMessage(
					{ action: "fillup", redirect_url: data.redirect_url },
					"*"
				);
...
function showPopover(elementName, message)
{
    ...
    popover.classList.add('cs-popover');
    popover.classList.add('cs-popover-bottom');
